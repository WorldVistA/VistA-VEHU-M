VPSRPC4 ;DALOI/KML,DJS - VPS Check In RPC ;Jun 17, 2022
 ;;1.0;VA POINT OF SERVICE (KIOSKS);**2,21**;Oct 21, 2011;Build 2
...
CHECKIN(CLIN,DTM,CIEN) ;update appropriate fields for check-in (HOSPITAL LOCATION file (#44), SDEC APPOINTMENT file (#409.84)
 ...
 L -^SC(CLIN_",""S"","_DTM)
 I VERR'="" S VPSRET="99-Appt could not be checked in" K VPSFDA,VERR Q VPSRET
 S VPSRET=1
 D UPDAPPT
 Q VPSRET
 ;
UPDAPPT ;Find correct appointment IEN (appt. not cancelled or NOSHOWed), update SDEC APPOINTMENT file #409.84 
 N SDAPPTIEN,NETADTM,SDECY,NOUPDT,SDCANCEL,SDNOSHOW
 S SDAPPTIEN=""
 S NOUPDT=0
 ...
 . S NETADTM=$$FMTONET^SDECDATE(DTM)
 . D CHECKIN^SDEC25(.SDECY,SDAPPTIEN,NETADTM)
