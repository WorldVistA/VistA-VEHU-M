TIUUTL ;ISP/RFR - UTILITIES ;Dec 21, 2020@14:31
 ;;1.0;TEXT INTEGRATION UTILITIES;**290,341**;Jun 20, 1997;Build 23
 Q
NOTIFY(TIUACT,ODFN,NDFN,TIU,TIUDA,TIUHOLD,OVISIT) ;NOTIFY SUBSCRIBING PACKAGES OF DOCUMENT ACTION
 ...
 Q:TIUHOLD
 N TIUDFN,TIUVSIT,TIUAPMDA,TIUCOUNT
 ...
 S TIUCOUNT=0
 F  S TIUNODE=$$NOW^XLFDT_";"_$J_" "_TIUCOUNT Q:'$D(^XTMP("TIUDOCACT",TIUNODE))  S TIUCOUNT=1+TIUCOUNT
