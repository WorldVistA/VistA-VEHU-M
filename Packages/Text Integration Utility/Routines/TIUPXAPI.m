TIUPXAPI ; SLC/JER - Interface w/PCE/Visit Tracking ;11/02/23  11:00
 ;;1.0;TEXT INTEGRATION UTILITIES;**15,24,29,82,107,126,161,267,263,357**;Jun 20, 1997;Build 5
 ;
...
ICD(TIUAICD,TIUICDAR,TIUVDT,CSYSINFO) ; Select Dx's
 ...
 . . . S TIUICD=+$$ICDDX^ICDEX($P(TIUICDAR("INDEX",+ITEM),U),$G(TIUVDT),+CSYSINFO,"E") ; *357
...
ICDOUT(TIUAICD,TIUI,TIUVDT,CSYSINFO) ; Go off-list for Dx
 ...
 . . S TIUICD=+$$ICDDX^ICDEX(CODE,$G(TIUVDT),CSYSIEN,"E") ; *357
