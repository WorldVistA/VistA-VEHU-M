TIUEDS ; GENERATED FROM 'TIU ENTER/EDIT DS' INPUT TEMPLATE(#1977), FILE 8925;04/13/16
 D DE G BEGIN
...
BEGIN S DNM="TIUEDS",DQ=1
 ...
 M DIEZAR=^DIE(1977,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1977,U="^"
