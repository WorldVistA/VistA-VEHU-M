...
RESTORE ; restores data from ^XTMP to #8927
 ...
 W !!,"Restoring the TIU TEMPLATE file..." K ^TIU(8927) M ^TIU(8927)=^XTMP("TIUFWRAP",8927) W "done.",!
 D FMR^TIUFWRAP2("EA","Press <Enter> to continue.")
 Q
 ;
