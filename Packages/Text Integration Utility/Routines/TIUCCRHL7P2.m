TIUCCRHL7P2 ; CCRA/PB - TIUHL7 Msg Processing; March 23, 2005
 ;;1.0;TEXT INTEGRATION UTILITIES;**337**;Jun 20, 1997;Build 5
 Q
CONTINUE ; data verification
 ...
 S (TIUIF,STOP)=0
 D
 . I $G(TIUZ("TEXT",1,0))="" S MSGTEXT="Missing DOCUMENT TEXT.",STOP=1 D MESSAGE^TIUCCRHL7P3(MSGID,VNUM,MSGTEXT),ANAK^TIUCCHL7UT(MSGID,MSGTEXT,VNUM)
 . Q:$G(STOP)=1
...
ES(DA,TIUES,TIUI,TIUESIG) ; ^DIE call for /es/
 ...
 N GMRCA,GMRCAD,GMRCDUZ,GMRCMT,GMRCO,GMRCSTS
 ...
 S GMRCMT="HSRM added a note and reset the status.",GMRCDUZ=$G(TIU("AUDA")),GMRCAD=""
