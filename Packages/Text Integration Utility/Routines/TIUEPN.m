TIUEPN ; GENERATED FROM 'TIU ENTER/EDIT PROGRESS NOTE' INPUT TEMPLATE(#1979), FILE 8925;04/13/16
 D DE G BEGIN
...
BEGIN S DNM="TIUEPN",DQ=1
 ...
 M DIEZAR=^DIE(1979,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1979,U="^"
...
C1F1 S DIEZRXR(8925,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=414 S DIEZRXR(8925,DIXR)=""
 Q
X1 Q
...
C11F1 S DIEZRXR(8925,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=355,414 S DIEZRXR(8925,DIXR)=""
 Q
X11 Q
12 S DQ=13 ;@14
