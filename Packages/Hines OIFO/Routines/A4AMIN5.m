A4AMIN5 ;HINES-CIOFO/JJM - AUDIT REPORT PROGRAM 5 8/16/98 11:00
V ;;1.0;**** CLASS III ****;;JUN 30, 1998
 N PBAL,TBAL,BBAL
 S (A4ATOA1,A4APSB2,A4ATNA3,A4ATL4,A4ATOA,A4APSB6,A4ATNA,A4ATL8,A4AFRB)=0
 S:'$G(DEB) DEB=$G(DEBTOR)
 S:'$G(DEB) DEB=$G(A4ADEB)
 Q:'$G(DEB)
 D FBD
 D PCLDFCS
ERO5 ;
...
FBD ; Find Balance Discrepancy
 ...
 I DAT S DAT=9999999.999999-DAT D PBAL^PRCAGU(DEB,.DAT,.PBAL) S A4APSB2=PBAL
 D EN^PRCAGT(DEB,DAT)
 ...
 QUIT
EN(DEB) ;Called to find balance discrepancy
 N PBAL,TBAL,BBAL
 D FBD
 K ^TMP("PRCAGT",$J)
 Q Y
...
PCLDFCS ; PRINT CHECKLIST DATA FROM CHECK STATEMENT 
 QUIT
 W !,"  1.  TOTAL OPEN & ACTIVE BILLS:",?50,$J(A4ATL1,10,2)
