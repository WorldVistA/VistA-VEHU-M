DVBCTXM2 ;ALB/BG - CAPRI XML RPCS; FEB 6, 2023@16:20 ; 3/4/24 8:50am
 ;;2.7;AMIE;**250,252,256**;Apr 10, 1995;Build 19
...
GITDATE(DVBRTN) ;
 ...
 I DVBRTN="" S DVBRTN="-1"
 Q
SPIEPD(DVBRTN) ;RPC: DVBA CAPRI IEPD DATA
 N DVBIEPD
 D NEWSFEED(.DVBRTN)
 ;CAPRI-23866:NGC:Feb26 - Start
 I $$GET^XPAR("PKG","DVBAB CAPRI SP IEPD ISPROD")=0 D
 . S DVBIEPD=$$GET^XPAR("PKG","DVBAB CAPRI SP IEPD TEST")
 E  D 
 . S DVBIEPD=$$GET^XPAR("PKG","DVBAB CAPRI SP IEPD INFO")
 ;CAPRI-23866:NGC:Feb26 - End
...
GETSSNVAR(DVBRTN) ;
 ...
 I DVBRTN="" S DVBRTN="-1"
 Q
GETXMLSTATUS(DVBRTN,DVBWIEN,DVBXIEN) ;
 ;CAPRI-7882 CP 6/5/2026
 ;RPC: DVBA CAPRI GET XML TRANSTAT
 N DVBINN,DVBSTAT
 I DVBWIEN="" S DVBRTN="-1^Blank Worksheet IEN" Q
 I DVBXIEN="" S DVBRTN="-1^Blank XML IEN" Q
 I $D(^DVB(396.17,DVBWIEN,14,DVBXIEN))<10 S DVBRTN="-1^That record has no transmission History" Q
 ;
 S DVBINN=""_DVBXIEN_","_DVBWIEN_","_""
 S DVBSTAT=$$GET1^DIQ(396.1726,DVBINN,".02","I")
 I DVBSTAT="" S DVBRTN="-1^No current Transmission Status" Q
 S DVBRTN=DVBSTAT
 Q
