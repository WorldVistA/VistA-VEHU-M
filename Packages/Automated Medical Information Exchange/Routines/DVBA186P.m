DVBA186P ;ALB/DJS - DVBA*2.7*186 POST-INIT ROUTINE ; 8/27/13
 ;;2.7;AMIE;**186**;Apr 10, 1995;Build 22
 ;
 Q  ;NO DIRECT ENTRY
 ;
POST ; Main entry point for post-int item
 ...
 ;
 N DVBERR
 S DVBERR=$$ENXPAR("PKG","DVBAB CAPRI VLER DAS CH3 URL","https://CAPRIAuthSvrTest.va.gov:7003/CapriProxyServlet")
 D UPDMSG("DVBAB CAPRI VLER DAS CH3 URL",DVBERR)
 S DVBERR=$$ENXPAR("PKG","DVBAB CAPRI VLER DAS PROD URL","https://CAPRIAuthSvrProd.va.gov:7003/CapriProxyServlet")
