DVBAXA ; GENERATED FROM 'DVBA C ADD 2507 PAT' INPUT TEMPLATE(#1169), FILE 2;11/22/24
 D DE G BEGIN
...
BEGIN S DNM="DVBAXA",DQ=1
 ...
 M DIEZAR=^DIE(1169,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1169,U="^"
...
C4F1 N X,X1,X2 S DIXR=153 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 D
...
C4X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C4F2 S DIXR=592 D C4X2(U) K X2 M X2=X D C4X2("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C4X2(DION) K X
 ...
 S X=$G(X(1))
 Q
C4F3 S DIXR=593 D C4X3(U) K X2 M X2=X D C4X3("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C5F1 N X,X1,X2 S DIXR=848 D C5X1(U) K X2 M X2=X D C5X1("O") K X1 M X1=X
 D
...
C6F1 N X,X1,X2 S DIXR=155 D C6X1(U) K X2 M X2=X D C6X1("O") K X1 M X1=X
 D
...
C11F1 N X,X1,X2 S DIXR=636 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DPT("APTYPE",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DPT("APTYPE",X,DA)=""
