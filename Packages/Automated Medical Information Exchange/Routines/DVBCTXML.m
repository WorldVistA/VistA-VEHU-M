DVBCTXML ;ALB/BG/CP/JD - CAPRI XML RPCS; FEB 6, 2023@16:20 ; 9/19/25 10:31am
 ;;2.7;AMIE;**250,252,254,255,256**;Apr 10, 1995;Build 19
...
FAILCHK(DVBRTN) ;
 ...
 N DVBDATE,DVBIEN,DVBEXIEN,DVBCT,DVBINN,DVBSTA
 ...
 ...;Following lines updated for Del Bug CGP 3/13/26 CAPRI-25882
 ...S DVBEXIEN=0 F  S DVBEXIEN=$O(^DVB(396.17,DVBIEN,14,"B",DVBEXIEN)) Q:(DVBEXIEN="")!(DVBRTN=1)  D
 ....S DVBCT="" S DVBCT=$O(^DVB(396.17,DVBIEN,14,"B",DVBEXIEN,DVBCT)) Q:DVBCT=""
 ....S DVBINN=""_DVBCT_","_DVBIEN_","_""
 ....S DVBSTA=$$GET1^DIQ(396.1726,DVBINN,".02","I")
 ....I DVBSTA'="C",DVBSTA'="" S DVBRTN=1
 Q
GITHUB(DVBRTN) ; 
 ;PLE 3/18/2026 CAPRI-25715 RPC DVBA CAPRI GITHUB LOCATION
 ;will not return '-1^err msg' due to Delphi original set up
 N DVBGLINK,DVBARTN,DVBAERROR,DVBI,DVBII
 K ^TMP("DVBAGITHUBLINK",$J)
 S DVBRTN=$NA(^TMP("DVBAGITHUBLINK",$J))
 S DVBGLINK=$$GET^XPAR("PKG","DVBAB CAPRI GITHUB LINK")
 S ^TMP("DVBAGITHUBLINK",$J,1)=DVBGLINK
 D GETLST^XPAR(.DVBARTN,"PKG","DVBAB CAPRI GITHUB REPO","Q",.DVBAERROR,)
 S DVBII=2 F DVBI=1:1:DVBARTN  D
 . S ^TMP("DVBAGITHUBLINK",$J,DVBII)=$P(DVBARTN(DVBI),U,2)
 . S DVBII=DVBII+1
 Q
GITTOK(DVBRTN) ; 
 ;RPC: DVBA CAPRI GET GITHUB DATA
