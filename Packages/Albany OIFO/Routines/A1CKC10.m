...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 S X=DG(DQ),DIC=DIE
 D EVENT^IVMPLOG($G(DA(1)))
C1F1 N X,X1,X2 S DIXR=402 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
C2S S X="" G:DG(DQ)=X C2F1 K DB
 S X=DG(DQ),DIC=DIE
 D EVENT^IVMPLOG($G(DA(1)))
C2F1 N X,X1,X2 S DIXR=402 D C2X1(U) K X2 M X2=X D C2X1("O") K X1 M X1=X
 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . I (X1(1)'=X2(1))!(X1(2)'=X2(2))!(X1(3)'=X2(3))
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
...
C3S S X="" G:DG(DQ)=X C3F1 K DB
 S X=DG(DQ),DIC=DIE
 D EVENT^IVMPLOG($G(DA(1)))
C3F1 N X,X1,X2 S DIXR=402 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . I (X1(1)'=X2(1))!(X1(2)'=X2(2))!(X1(3)'=X2(3))
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
