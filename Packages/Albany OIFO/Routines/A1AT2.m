A1AT2 ; TRAVEL PACKAGE ; JCK/ALB ; 20 MAY 87
 ;VERSION 1.0
 ;THIS RTN CALCULATES & PRINTS ALL ACTUAL TRAVEL TOTALS FOR THE YEAR
 ;
...
PRINT ;Print heading & Travel results
 ...
 ;
 D LINE S DATA1=^UTILITY("A1ATPKG","FQTOT") W !!!,"ACTUAL TOTALS:",?32,$P(DATA1,U,1),?52,$P(DATA1,U,2),?72,$P(DATA1,U,3),?92,$P(DATA1,U,4),?112,^UTILITY("A1ATPKG","GDTOT")
 ;
...
A1ATHDR ;Print Travel Header for all yearly totals
 ;
 W @$S('$D(IOF):"#",IOF]"":IOF,1:"#"),!
 W ?45,"ACTUAL TRAVEL SUMMARY COSTS FOR FISCAL ",($E(DT,1,3)+1700)
 W !,?45,"-------------------------------------------"
