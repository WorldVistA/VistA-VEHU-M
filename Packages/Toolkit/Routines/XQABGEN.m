...
ADRESS W !!,"Enter as an adressee for installation messages a mailgroup in NETWORK MAIL",!,"format, e.g., G.GROUPNAME@DOMAIN.VA.GOV" W:XQABTEST "  This same address will",!,"be used for reports on Alpha/Beta Option Usage"
