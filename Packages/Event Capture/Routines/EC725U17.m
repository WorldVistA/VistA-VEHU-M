EC725U17 ;ALB/GTS/JAP/JAM - EC National Procedure Update; 8/23/02 8:22am
...
NEW ;national procedures to add;;descript^nation #^CPT code^beg seq^end seq
 ;;CN RUGS IV^CN351
 ;;HH REF ASSIST LIVING THRD PTY^HH110
 ;;HH REF ASSIST LIVING PRIV PAY^HH111
 ;;HH REF ADHC THRD PTY^HH112
 ;;HH REF ADHC PRIV PAY^HH113
 ;;HH REF NURSING HOME THRD PTY^HH114
 ;;HH REF NURSING HOME PRIV PAY^HH115
 ;;HH REF HOME HEALTH SVCS THRD PTY^HH116
 ;;HH REF HOME HEALTH SVCS PRIV PAY^HH117
 ;;HH SW SPVSN CNTRCT ADLT DAY CARE^HH118
 ;;QUIT
