EC725U11 ;ALB/GTS/JAP/JAM/TMD - EC National Procedure Update; 5/1/01 1:35pm ; 5/8/01 9:24am
...
NEW ;national procedures to add;;descript^nation #^CPT code^beg seq^end seq
 ;;CNH HOSPICE&PALLIATIVE CARE VISIT PURPOSE^VP001
 ;;CNH RESPITE CARE VISIT PURPOSE^VP002
 ;;CNH RSRV FUTURE LTC^VP003
 ;;HOME HLTH HOSPICE&PALLIATIVE CARE VISIT PURPOSE^VP101
 ;;HOME HLTH RESPITE CARE VISIT PURPOSE^VP102
 ;;HOME HLTH RSRV FUTURE LTC^VP103
 ;;ADHC RESPITE CARE VISIT PURPOSE^VP201
 ;;BEDDAY ASST LIV HM ^AL^^1^500
 ;;AL CARE LEVEL ADD-ON 1^AL501
 ;;AL CARE LEVEL ADD-ON 2^AL502
 ;;AL CARE LEVEL ADD-ON 3^AL503
 ;;AL CARE LEVEL ADD-ON 4^AL504
 ;;AL CARE LEVEL ADD-ON 5^AL505
 ;;AL CARE LEVEL ADD-ON 6^AL506
 ;;AL CARE LEVEL ADD-ON 7^AL507
 ;;AL CARE LEVEL ADD-ON 8^AL508
 ;;AL CARE LEVEL ADD-ON 9^AL509
 ;;AL CARE LEVEL ADD-ON 10^AL510
 ;;AL BEDHOLD^AL511
 ;;AL LEVEL OF CARE STATISTIC^AL512
 ;;QUIT
