EC2P168B ;MNT/JB - EC National Procedure Update; April 19, 2024@15:50
 ;;2.0;EVENT CAPTURE;**168**;May 8, 1996;Build 8
 ;
 ; This routine is used as a post-init in a KIDS build
 ; to add new procedure codes and change procedure names  
 ; in the EC National Procedure file (#725) for FY25.
 ;
...
CHNG ;name changes -national code #^new procedure name
 ;;NU017^TF/TPN/ONS
 ;;NU177^95250 CGM PROF INDIVIDUAL TRAIN
 ;;NU221^95249 CGM PERSONAL IND TRAIN
 ;;QUIT
