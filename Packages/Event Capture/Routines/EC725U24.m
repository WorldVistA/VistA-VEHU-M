EC725U24 ;ALB/GTS/JAP/GT - EC National Procedure Update; 2/03/2004
...
NEW ;national procedures to add;;descript^nation #^CPT code^beg seq^end seq
 ;;SPEECH GEN DEVICE, DIGITIZED 8-20 M^SP497
 ;;SPEECH GEN DEVICE, DIGITIZED 20-40 M^SP498
 ;;SPEECH GEN DEVICE, DIGITIZED >40 M^SP499
 ;;THERAPEUTIC ACTIVITY^SP500^97530
 ;;QUIT
...
CHNG ;name changes -national code #^new procedure name
 ;;SP112^VOICE PROSTH EVAL/FITTING, LVL1
 ;;SP327^VOICE PROSTH EVAL/FITTING, LVL2
 ;;SP328^VOICE PROSTH EVAL/FITTING, LVL3
 ;;QUIT
