ECMXP ; GENERATED FROM 'EC CREATE PATIENT ENTRY' INPUT TEMPLATE(#1995), FILE 721;08/18/09
 D DE G BEGIN
...
BEGIN S DNM="ECMXP",DQ=1
 ...
 M DIEZAR=^DIE(1995,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1995,U="^"
