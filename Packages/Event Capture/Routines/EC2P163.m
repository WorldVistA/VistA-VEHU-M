EC2P163 ;ALB/DTA - Inactive Stop Code DSS Unit Review; JUN 13, 2023@01:19
 ;;2.0;EVENT CAPTURE;**163**;May 8, 1996;Build 3
 ;
...
POST ;entry point
 ...
 D ^%ZTLOAD
 ;
 D BMES^XPDUTL("Done. You will receive a MailMan message with the results on 10/01/23.")
 Q
