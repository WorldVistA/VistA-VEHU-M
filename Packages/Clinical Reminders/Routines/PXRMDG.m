PXRMDG ;SLC/AGP - Clincial Reminders Updates to DG ;02/10/2022
...
BLDSEXOR(RESULTS,INPUTS,DFN,NOTE) ;
 ...
 .I CNT=0,$D(ARRAY(VALUE)) K ARRAY(VALUE) S CNT=+ID
...
BLDEXSEX(DFN,RESULTS) ;
 ...
 ;
NOTEACT(PXRMDOCINFO) ;
 N DFN,IDX,NOTEIEN,NOTENAME,PXRMARR,PXRMINPUTS,TMPARR,VALUE
