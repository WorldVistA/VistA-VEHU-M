LAIMX ;INDY/PLS;SLC/RAF- IMX ROUTINE FOR MEIA QUAN. DATA; 06/18/93  11:01 ;;;PLS 55693,31670 [ 09/16/94  3:43 PM ]
 ;;5.1;LAB;**118**;04/11/91 11:06
 ;This routine was written by Phillip Salmon at the Indianapolis VAMC
 ;and generously given to the lab package. This routine will handle
...
QUIT LOCK ^LA(TSK) H 1 K ^LA(TSK),^LA("LOCK",TSK) D
 ...
 .K TOUT,TRAY,TSK,TV,V,X I $D(ZTSK) D KILL^%ZTLOAD K ZTSK
 Q
