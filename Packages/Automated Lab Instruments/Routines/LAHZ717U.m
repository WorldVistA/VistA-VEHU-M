LAHZ717U ;SLC/DLG/MJB- HITACHI 717 ROUTINE FOR AUTOMATED DATA ;7/20/90  09:10 ; [ 10/28/94  11:55 AM ]
...
LA1 S LANM=$T(+0),TSK=$O(^LAB(62.4,"C",LANM,0)) Q:TSK<1
 ...
 ; Building the fix array for param 1 use
F S I=0 F  S I=$O(TC(I)) Q:I=""  S FIX(I,2)=TC(I,2)
LA2 K TV,Y S TOUT=0,A=2 D IN G QUIT:TOUT,LA2:CTRL'="C",LA2:"NEC"'[$E(IN,3),LA2:IN="" D QC
 ;S TOUT=0,BAD=0 D IN,QC G QUIT:TOUT
 F I=25:9:255 S V1=$E(Y(2),I,(I+8)),V=$E(V1,1,2) D NUM I V S TEST=+V,V=$E(V1,3,8) D NUM,FIX I V]"" S:$D(TC(TEST,1))#2 @TC(TEST,1)=V ;V COULD BE MODIFIED ON THIS LINE
...
TRAP D ^LABERR S T=TSK D SET^LAB G @("LA2^"_LANM) ;ERROR TRAP
 ;
FIX ; USE FOR PARAM 1 $SELECTS POS:NEG 
