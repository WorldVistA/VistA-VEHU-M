ONC2PS14 ;HINES OIFO/RTK - Post-Install Routine for Patch ONC*2.2*14 ;01/04/22
 ...
 ;S RC=$$UPDCSURL^ONCSAPIU("http://99.99.999.99:83/cgi_bin/oncsrv.exe")
 ;DC PRODUCTION SERVER V21
 S RC=$$UPDCSURL^ONCSAPIU("http://99.99.999.99:86/cgi_bin/oncsrv.exe")
 ;test server uRL V21
 ;S RC=$$UPDCSURL^ONCSAPIU("http://99.99.999.99:81/cgi_bin/oncsrv.exe")
 Q
 ;
