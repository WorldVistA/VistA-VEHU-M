ONC2PS13 ;HINES OIFO/RTK - Post-Install Routine for Patch ONC*2.2*13 ;01/21/21
 ...
 ;S RC=$$UPDCSURL^ONCSAPIU("http://XX.XX.XXX.XX:83/cgi_bin/oncsrv.exe")
 ;DC PRODUCTION SERVER V21
 S RC=$$UPDCSURL^ONCSAPIU("http://XX.XX.XXX.XX:86/cgi_bin/oncsrv.exe")
 ;test server uRL V21
 ;S RC=$$UPDCSURL^ONCSAPIU("http://XX.XX.XXX.XX:81/cgi_bin/oncsrv.exe")
 ;
