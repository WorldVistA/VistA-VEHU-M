ONCCPOS ;WISC/MLH-ROUTINES FOR PATCH ONC*2.1*7-REMOVE PACKAGE ENTRY ;3/9/94  15:37
 ...
 QUIT
 ;
REMVPKG W !!,"Now removing the ONCC entry from the PACKAGE File..."
 S DIC=9.4,DIC(0)="",D="C",X="ONCC" D IX^DIC K DIC,D,X ;    find the entry
