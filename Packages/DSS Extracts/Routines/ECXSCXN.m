ECXSCXN ;ALB/JAP  Clinic Extract ;Mar 18, 2021@15:55:41
 ;;3.0;DSS EXTRACTS;**24,27,29,30,31,32,33,39,46,49,52,71,84,92,107,105,120,124,127,132,136,144,149,156,154,161,166,170,174,178,181**;Dec 22, 1997;Build 71
 ;
...
FILE ;record setup for file #727.827
 ...
 ;ADMISSION DATE (ECXADMDT) $$ECXDATE^ECXUTL(ECXADMDT,ECXYM)^ADMISSION TIME (ECXADMDT) $$ECXTIME^ECXUTL(ECXADMDT)
 ;
 N STR
 N ECXSTANO  ;161 tjl
 ...
 I ECXLOGIC>2021 S STR(6)=STR(6)_U_$$ECXDATE^ECXUTL(ECXADMDT,ECXYM)_U_$$ECXTIME^ECXUTL(ECXADMDT) ;181 Add Admission Date and Time
