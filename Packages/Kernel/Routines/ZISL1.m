ZISL1 ;WILM/RJ - MAIN DRIVER Enter Edit; 9-22-87
...
OPT ;;Micom Package;Micom Enter/Edit Option;ZISL1;
 ;;Enter/Edit Auto Load File;^ZISLEDIT
 ;;Enter/Edit Contention Devices;^ZISLDEV
 ;;Enter/Edit Micom Site Parameters;^ZISLMSP
 ;;Enter/Edit Micom Line Assignments;^ZISLEMLA
 ;;Enter/Edit Micom Port Assignments;^ZISLEMPA
