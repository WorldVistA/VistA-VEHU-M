XU8PS655 ;ISD/HGW - Post-Install for 655 ;03/30/15  11:55
 ;;8.0;KERNEL;**655**;Jul 10, 1995;Build 17
...
MAIN ; Control subroutine
 ...
 S XU8DATA(5)="H"_"^"_"80"_"^"_"WWW.VA.GOV"_"^"_"/IAM/Web/Validate.aspx"
...
BULL(TYPE) ;Send local e-mail
 ...
 S XUTEXT(17)="https://vaww.dwh.cdw.portal.va.gov/sites/Non-VA%20Care%20PC3%20and%20Choice/SitePages/Home.aspx"
 S XUTEXT(18)=" "
 S I=0,J=21
 I TYPE="THEGOOD" D
