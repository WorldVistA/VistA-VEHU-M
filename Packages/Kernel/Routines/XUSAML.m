...
FINDUSER() ;Function. Identify user
 ...
 ;<saml:Issuer Format="urn:oasis:names:tc:SAML:2.0:nameid-format:entity">https://ssoi.sts.va.gov/Issuer/SAML2</saml:Issuer>
...
VALASSRT(XASSRT,DOC) ;Intrinsic Subroutine. Validate SAML assertion
 ...
 ;     VistA shall accept an endpoint of "va.gov"
 ...
 ;     <saml:AudienceRestriction><saml:Audience>https://*.va.gov/*</saml:Audience></saml:AudienceRestriction>
