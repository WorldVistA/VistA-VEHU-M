XQALDATA ;ISC/JLI ISD/HGW - PROVIDE DATA ON ALERTS ; Jun 13, 2024@8:00
 ;;8.0;KERNEL;**207,285,443,513,602,653,734,662,772,784,801**;Jul 10, 1995;Build 5
...
GETUSER1(ROOT,XQAUSER,FRSTDATE,LASTDATE,FLAG) ;Add FLAG to check for deferred alert. P653
 ...
 D ACTVSURO^XQALSURO(XQAUSER),RETURN^XQALSUR1(XQAUSER) ; P513,P801
 ; p734
