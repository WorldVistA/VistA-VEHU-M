MAGQBUT4 ;WOIFO/RMP,DAC,JSJ - BP Utilities ; Mar 3, 2022@11:40:48
 ;;3.0;IMAGING;**7,8,48,20,81,39,121,135,196,198,214,222,235,238,243,248,325,293**;Mar 19, 2002;Build 6
...
VOKR(RESULT,VER) ; RPC for VOK [MAGQ VOK]
 ...
 S SVRPATCH=",248,325,293" ; P325,P293 continue last 3
 ; if client patch is allowed Result = 1^...
 I SVRPATCH[CLPATCH S RESULT="1^3.0P293"
 E  S RESULT="0^3.0P293"
 Q
OLD ;
