GMRAXENV ;HIRMFO/RM-ENVIRONMENT CHECK ROUTINE ;1/14/97  09:58
 ;;4.0;Adverse Reaction Tracking;**6**;Mar 29, 1996
 ...
 . W $C(7)
 . Q
 I +$$VERSION^XPDUTL("TIU")>0,$T(NEW^TIUPNAPI)']"" D
 . W !?5,"You have the Text Integrated Utilities package installed, but"
 . W !?5,"you  are missing the TIUPNAPI routine."
 . Q
