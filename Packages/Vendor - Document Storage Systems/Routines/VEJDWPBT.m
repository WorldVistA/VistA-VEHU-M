VEJDWPBT ;WPB/CAM routine modified for dental GUI;8/1/98
 ;;3.5;VEJD DSS CORE RPCS;;Jan 03, 2006
 ;Copyright 1995-2006, Document Storage Systems, Inc., All Rights Reserved
 ;; slc/dcm - Get patient orders in context ;4/10/97  07:09
 ;ORQ12;3.0;ORDER ENTRY/RESULTS REPORTING;**12**;Dec 17, 1997
...
T1 S ORI=0 F  S ORI=$O(^OR(100,ORIFN,1,ORI)) Q:ORI'>0  S X=$G(^(ORI,0)) S:(FIRST=ORI)&($E(X,1,3)=">> ") X=$E(X,4,999) D:$L(X) ADD
 S DLG=$P(OR0,U,5) K Y I DLG,$P(DLG,";",2)["101.41",$D(^VEJ(101.41,+DLG,9)) X ^(9) I $L($G(Y)) S X=Y D ADD ; additional text
