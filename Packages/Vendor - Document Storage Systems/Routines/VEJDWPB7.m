VEJDWPB7 ;WPB/CAM routine modified for dental GUI;8/1/98;7/10/98
 ;;3.5;VEJD DSS CORE RPCS;;Jan 03, 2006
 ;Copyright 1995-2006, Document Storage Systems, Inc., All Rights Reserved
 ;; SLC/MKB -- Problem List VALM Utilities cont ;5/10/94  16:42
 ;GMPLMGR1;2.0;Problem List;**10**;Aug 25, 1994
...
OEPAT() ; Calls OE/RR to return new patient, or -1
 N DFN,VADM,Y
 ; blj/dss 14/6/2000
 ; IN^OR is no longer present.  So, we'll always Q -1.  I suspect that this is dead code anyway,
 ; but trying to make sure would take a while.
 Q -1
...
NEW ; prompt, from NEWSRV or NEWCLIN
 ...
 . Q:X=""  I X="?" W !!?3,"Enter the "_VIEW_", one at time, from which you wish to view",!?3,"problems; press <return> when you have finished.",! Q
 . I X["??" D @HELPMSG Q
