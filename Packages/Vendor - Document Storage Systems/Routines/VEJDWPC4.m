VEJDWPC4 ;wpb/gbh - routine modified for dental GUI;8/2/98
 ;;3.5;VEJD DSS CORE RPCS;;Jan 03, 2006
 ;Copyright 1995-2006, Document Storage Systems, Inc., All Rights Reserved
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;;Dec 17, 1997
 ;ORQ1   ;slc/dcm - Get orders for a patient. ;6/26/96  12:52
...
EN1 Q:'$G(PAT)  S:'$G(FLG) FLG=2 S:'$G(DETAIL) DETAIL=0 S:'$G(MULT) MULT=0
 ...
 D GRP(GROUP),LIST
 D @($S(FLG=2:"CUR",FLG=5:"EXG",FLG=6:"ACT",FLG=11:"SIG",FLG=15:"ADM",FLG=16:"DIS",FLG=17:"XFR",FLG=19:"NEW","^1^3^4^7^8^9^10^12^13^14^18^"[(U_FLG_U):"LOOP",1:"QUIT")_"^VEJDWPC5")
 Q
 ;
