VEJDWPBW ;WPB/CAM routine modified for dental GUI;8/1/98
 ;;3.5;VEJD DSS CORE RPCS;;Jan 03, 2006
 ;Copyright 1995-2006, Document Storage Systems, Inc., All Rights Reserved
 ;; slc/STAFF - Functions which return patient lab results ;12/15/97 [ 04/02/97  3:46 PM ]
 ;ORQQLR;3.0;ORDER ENTRY/RESULTS REPORTING;**9**;Dec 17, 1997
...
ZDETAIL(Y,PATIENT,ORDER) ; return detailed, narrative results for an order:
 ...
 ; blj/dss 14/6/2000  Routine VEORQQLR1 is no longer present.
 ; S LRORD=$$OETOLAB^VEORQQLR1(+ORDER)
