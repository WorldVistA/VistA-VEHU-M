VEJDWPCB ;wpb/gbh - routine modified for dental GUI;8/2/98
...
PPIMM(ORY,ORPT) ;return pt's patient postings and immunizations
 ...
 I $L($T(IMMUN^VEJDWPCF))<1 S ORY(ORJ)=";I^Immunizations not available." Q
 D IMMUN^VEJDWPCF(ORPT)
 S IMM="",IVDT="",IEN=0
