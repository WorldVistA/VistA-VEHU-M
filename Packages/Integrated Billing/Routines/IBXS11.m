...
C17F1 N X,X1,X2 S DIXR=251 D C17X1(U) K X2 M X2=X D C17X1("O") K X1 M X1=X
 D
...
C19F1 N X,X1,X2 S DIXR=253 D C19X1(U) K X2 M X2=X D C19X1("O") K X1 M X1=X
 D
...
C21F1 N X,X1,X2 S DIXR=254 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
...
C22S S X="" G:DG(DQ)=X C22F1 K DB
 D ^IBXS13
C22F1 N X,X1,X2 S DIXR=255 D C22X1(U) K X2 M X2=X D C22X1("O") K X1 M X1=X
 D
...
C23S S X="" G:DG(DQ)=X C23F1 K DB
 D ^IBXS15
C23F1 N X,X1,X2 S DIXR=256 D C23X1(U) K X2 M X2=X D C23X1("O") K X1 M X1=X
 D
...
C24S S X="" G:DG(DQ)=X C24F1 K DB
 D ^IBXS17
C24F1 N X,X1,X2 S DIXR=157 D C24X1(U) K X2 M X2=X D C24X1("O") K X1 M X1=X
 D
...
C24X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C24F2 S DIXR=252 D C24X2(U) K X2 M X2=X D C24X2("O") K X1 M X1=X
 D
