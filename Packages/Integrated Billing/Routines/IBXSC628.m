...
DE S DIE="^DGCR(399,D0,""RC"",",DIC=DIE,DP=399.042,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGCR(399,D0,"RC",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,10) S:%]"" DE(1)=% S %=$P(%Z,U,12) S:%]"" DE(2)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBXSC628",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;10",DV="S",DU="",DLB="TYPE",DIFLD=.1
 S DU="1:INPT BS;2:OPT VST DT;3:RX;4:CPT;5:PROS;6:DRG;9:UNASSOCIATED;"
 G RE
X1 Q
2 S DW="0;12",DV="S",DU="",DLB="COMPONENT",DIFLD=.12
