IBXSC82 ; GENERATED FROM 'IB SCREEN82' INPUT TEMPLATE(#1581), FILE 399;06/23/08
 D DE G BEGIN
...
BEGIN S DNM="IBXSC82",DQ=1
 ...
 M DIEZAR=^DIE(1581,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1581,U="^"
