...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBXSC727",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;6",DV="P81'",DU="",DLB="PROCEDURE",DIFLD=.06
 S DE(DW)="C1^IBXSC727"
 S DU="ICPT("
 G RE
...
X2 I '$P(^DGCR(399,DA(1),"RC",DA,0),U,6) S Y="@758"
 Q
3 D:$D(DG)>9 F^DIE17 G ^IBXSC728
