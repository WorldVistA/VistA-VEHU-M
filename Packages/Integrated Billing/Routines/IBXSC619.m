...
DE S DIE="^DGCR(399,",DIC=DIE,DP=399,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGCR(399,DA,""))=""
 I $D(^("U2")) S %Z=^("U2") S %=$P(%Z,U,4) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBXSC619",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="U2;4",DV="NJ11,2",DU="",DLB="PRIMARY PRIOR PAYMENT",DIFLD=218
 S DE(DW)="C1^IBXSC619"
 G RE
...
X3 S:'$D(^DGCR(399,DA,"I2")) Y="@673"
 Q
4 D:$D(DG)>9 F^DIE17 G ^IBXSC620
