IBJONIT1 ; ; 04-JAN-1996
 ...
 K DIF,DIK,D,DDF,DDT,DTO,D0,DLAYGO,DIC,DIR,DA,DFR,DTN,DIX,DZ D DT^IBJONIT2 S %=1,U="^",DSEC=1
 ...
 D DT^IBJONIT2 K ^UTILITY(U,$J),^UTILITY("DIK",$J) W !,"...OK, this may take a while, hold on please..." F R=1001:1:1012 D @("^IBJON"_$E(R,2,4)) W "."
