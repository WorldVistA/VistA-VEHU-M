IBYP783 ;MNTVBB/DMR - IB*2.0*783 POST INIT: REASONABLE CHARGES V5.24 ; Dec 6, 2022@11:09
 ;;2.0;INTEGRATED BILLING;**783**;21-MAR-94;Build 2
...
POST ;
 N IBA,U S U="^"
 D BMSG("    Reasonable Charges v5.24 Post-Install .....")
 D CHGINA("") ; inactivate all RC charges in #363.2
 D BMSG("    Reasonable Charges v5.24 Post-Install Complete")
 Q
 ;
BMSG(IBA) ;
 D BMES^XPDUTL(IBA)
