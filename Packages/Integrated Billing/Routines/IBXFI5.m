IBXFI5 ; GENERATED FROM 'IBDF EDIT DATA FIELD' INPUT TEMPLATE(#1537), FILE 357.5;05/23/94
 D DE G BEGIN
DE S DIE="^IBE(357.5,",DIC=DIE,DP=357.5,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^IBE(357.5,DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,1) S:%]"" DE(1)=% S %=$P(%Z,U,2) S:%]"" DE(3)=% S %=$P(%Z,U,3) S:%]"" DE(4)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="IBXFI5",DQ=1
 S:$D(DTIME)[0 DTIME=999 S D0=DA,DIEZ=1537,U="^"
