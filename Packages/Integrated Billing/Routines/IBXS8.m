IBXS8 ; GENERATED FROM 'IB SCREEN8' INPUT TEMPLATE(#1255), FILE 399;09/25/15
 D DE G BEGIN
...
BEGIN S DNM="IBXS8",DQ=1
 ...
 M DIEZAR=^DIE(1255,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1255,U="^"
1 S DQ=2 ;@81
