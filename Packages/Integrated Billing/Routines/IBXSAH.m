IBXSAH ; GENERATED FROM 'IB SCREEN10H' INPUT TEMPLATE(#2270), FILE 399;09/15/16
 D DE G BEGIN
...
BEGIN S DNM="IBXSAH",DQ=1
 ...
 M DIEZAR=^DIE(2270,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2270,U="^"
...
X61 S DIPA("OLDALTT1")=$P($G(^DGCR(399,DA,"M2")),U)
 Q
62 S DW="M2;1",DV="*P355.98'",DU="",DLB="Primary Payer - Alt Prof Prim Payer ID Type",DIFLD=140
 S DE(DW)="C62^IBXSAH"
 S DU="IBA(355.98,"
 G RE
