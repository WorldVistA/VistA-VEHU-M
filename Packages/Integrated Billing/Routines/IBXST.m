IBXST ; GENERATED FROM 'IB STATUS' INPUT TEMPLATE(#736), FILE 399;12/13/04
 D DE G BEGIN
...
BEGIN S DNM="IBXST",DQ=1
 ...
 M DIEZAR=^DIE(736,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=736,U="^"
