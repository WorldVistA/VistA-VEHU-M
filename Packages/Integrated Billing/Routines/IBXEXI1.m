IBXEXI1 ; ;06/03/93
 D DE G BEGIN
DE S DIE="^IBA(354.1,",DIC=DIE,DP=354.1,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^IBA(354.1,DA,-1))<0
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="IBXEXI1",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;15",DV="D",DU="",DLB="PRIOR YEAR THRESHOLDS",DIFLD=.15
 S DE(DW)="C1^IBXEXI1"
 S Y="@"
