...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBXSC411",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;2",DV="RD",DU="",DLB="DATE",DIFLD=.02
 G RE
X1 S %DT="E" D ^%DT S X=Y K:DT<X!(2000101>X) X
 Q
 ;
2 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=2 D X2 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X2 I $P(^DGCR(399,DA(1),0),U,19)'=2 S Y="@454"
 Q
3 D:$D(DG)>9 F^DIE17 G ^IBXSC412
