IB20P768 ;MNTVBB/DMR - IB FY 2024 STOP CODES UPDATE ; August 25, 2022 @13:20
 ;;2.0;INTEGRATED BILLING;**768**;21-MAR-94;Build 2
...
EN ;
 ...
 Q
 ;
START D BMES^XPDUTL("DSS Clinic Stop Codes for FY 2024, Post-Install Starting")
 Q
 Q
 ;
FINISH D BMES^XPDUTL("DSS Clinic Stop Codes for FY 2024, Post-Install Starting")
 Q
 Q
 ;
 ;
...
NCODE ;;code^billable type^description^override flag^effective date
 ;;129^0^VA EMERGENCY AMBULANCE SRVS^1^3231001
 ;
 ;codes updated
OCODE ;;code^billable type^description^override flag
 ;;131^1^URGENT CARE^^3231001
 ;;191^0^COMMUNITY ADHC FOLLOWUP^1^3231001
 ;;322^1^COMP WMS HLTH GNDR DIVERSE PC^1^3231001
 ;;569^0^COMMTY BASED EMPLOY SRVS CBES^1^3231001
 ;;679^0^REAL TIME CVT TO HOME PRO SITE^1^3231001
 ;;704^0^WMS GNDR DIVERSE PREVENT CARE^1^3231001
 ;;901^0^TELECRITCAL CARE PATIENT SITE^1^3231001
 ;
