...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=2,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 I $D(^(.25)) S %Z=^(.25) S %=$P(%Z,U,2) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBXSC210",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW=".25;2",DV="FX",DU="",DLB="SPOUSE'S EMP STREET [LINE 1]",DIFLD=.252
 S DE(DW)="C1^IBXSC210"
 G RE
