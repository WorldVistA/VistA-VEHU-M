IBXS7 ; GENERATED FROM 'IB SCREEN7' INPUT TEMPLATE(#1254), FILE 399;09/15/16
 D DE G BEGIN
...
BEGIN S DNM="IBXS7",DQ=1
 ...
 M DIEZAR=^DIE(1254,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1254,U="^"
...
C22F1 N X,X1,X2 S DIXR=924 D C22X1(U) K X2 M X2=X D C22X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . D CMAEDALL^IBCU9(DA)
...
C27S S X="" G:DG(DQ)=X C27F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 ;
C27F1 N X,X1,X2 S DIXR=918 D C27X1(U) K X2 M X2=X D C27X1("O") K X1 M X1=X
 K X M X=X2 D
...
C27X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C27F2 S DIXR=919 D C27X2(U) K X2 M X2=X D C27X2("O") K X1 M X1=X
 K X M X=X2 D
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 ;
C31F1 N X,X1,X2 S DIXR=918 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 K X M X=X2 D
 . N IBLNPRV I $$LNPRVFT^IBCEU7(X,.IBLNPRV) D FILE^DIE("E","IBLNPRV") Q
 G C31F2
C31X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C31F2 S DIXR=919 D C31X2(U) K X2 M X2=X D C31X2("O") K X1 M X1=X
 K X M X=X2 D
 . N DIEXARR M DIEXARR=X S DIEZCOND=1
 . S X=X(1)=3
 . S DIEZCOND=$G(X) K X M X=DIEXARR Q:'DIEZCOND
