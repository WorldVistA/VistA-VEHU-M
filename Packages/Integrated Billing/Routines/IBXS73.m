...
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,D=0 K DE(1) ;42
 S DIFLD=42,DGO="^IBXS74",DC="16^399.042IPA^RC^",DV="399.042MR*P399.2'",DW="0;1",DOW="REVENUE CODE",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DGCR(399.2,"
...
R14 D DE
 ...
 ;
15 S DW="U1;2",DV="NJ8,2",DU="",DLB="OFFSET AMOUNT",DIFLD=202
 S DE(DW)="C15^IBXS73"
 G RE
...
X16 S:'X Y="@757"
 Q
17 D:$D(DG)>9 F^DIE17,DE S DQ=17,DW="U1;3",DV="FX",DU="",DLB="OFFSET DESCRIPTION",DIFLD=203
 G RE
...
X19 I $P(^DGCR(399,DA,"U1"),"^",11)']"" S Y="@76"
 Q
20 S DW="U1;10",DV="RNJ10,2",DU="",DLB="*FY 1 CHARGES",DIFLD=210
 G RE
...
X24 S:'$D(^DGCR(399,DA,"I1")) Y="@772"
 Q
25 S DW="U2;4",DV="NJ11,2",DU="",DLB="PRIMARY PRIOR PAYMENT",DIFLD=218
 S DE(DW)="C25^IBXS73"
 G RE
...
X27 S:'$D(^DGCR(399,DA,"I2")) Y="@773"
 Q
28 D:$D(DG)>9 F^DIE17,DE S DQ=28,DW="U2;5",DV="NJ11,2",DU="",DLB="SECONDARY PRIOR PAYMENT",DIFLD=219
 S DE(DW)="C28^IBXS73"
 G RE
...
X30 S:'$D(^DGCR(399,DA,"I3")) Y="@78"
 Q
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW="U2;6",DV="NJ11,2",DU="",DLB="TERTIARY PRIOR PAYMENT",DIFLD=220
 S DE(DW)="C31^IBXS73"
 G RE
