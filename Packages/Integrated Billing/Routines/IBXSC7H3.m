...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="IBXSC7H3",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="U;2",DV="RDX",DU="",DLB="STATEMENT COVERS TO",DIFLD=152
 S DE(DW)="C1^IBXSC7H3"
 G RE
...
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 S DGRVRCAL=1
 Q
X1 S %DT="ETP" D ^%DT S X=Y K:Y<1 X I $D(X) D DDAT1^DGCRU4 K DGCR00
 Q
 ;
2 S DQ=3 ;@75
