...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="M;12",DV="FXO",DU="",DLB="PRIMARY INSURANCE POLICY",DIFLD=112
 S DQ(1,2)="S Y(0)=Y S Y=$$TRANS^IBCNS2(DA,Y)"
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="M;13",DV="FOX",DU="",DLB="SECONDARY INSURANCE POLICY",DIFLD=113
 S DQ(4,2)="S Y(0)=Y S Y=$$TRANS^IBCNS2(DA,Y)"
...
C4F1 S DIEZRXR(399,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=190 S DIEZRXR(399,DIXR)=""
 Q
X4 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>4!($L(X)<1) X D:$D(X) DD^IBCNS2(X,DA,1)
 I $D(X),X'?.ANP K X
 Q
 ;
...
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW="M;14",DV="FOX",DU="",DLB="TERTIARY INSURANCE POLICY",DIFLD=114
 S DQ(6,2)="S Y(0)=Y S Y=$$TRANS^IBCNS2(DA,Y)"
...
C6F1 S DIEZRXR(399,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=190 S DIEZRXR(399,DIXR)=""
 Q
X6 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>4!($L(X)<1) X D:$D(X) DD^IBCNS2(X,DA,1)
 I $D(X),X'?.ANP K X
 Q
 ;
7 S DQ=8 ;@998
