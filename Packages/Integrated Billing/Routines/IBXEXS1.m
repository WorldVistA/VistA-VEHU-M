IBXEXS1 ; ;06/03/93
 D DE G BEGIN
DE S DIE="^IBA(354,",DIC=DIE,DP=354,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^IBA(354,DA,-1))<0
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="IBXEXS1",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;3",DV="RDX",DU="",DLB="COPAY EXEMPTION STATUS DATE",DIFLD=.03
 S DE(DW)="C1^IBXEXS1"
 S X=IBDT
 S Y=X
