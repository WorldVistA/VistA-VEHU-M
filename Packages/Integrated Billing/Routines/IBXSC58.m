...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBXSC58",DQ=1
1 S DW="0;9",DV="S",DU="",DLB="PROCEDURE CODING METHOD",DIFLD=.09
