IBXPAR ; GENERATED FROM 'IB EDIT MCCR PARM' INPUT TEMPLATE(#1247), FILE 350.9;05/04/04
 D DE G BEGIN
...
BEGIN S DNM="IBXPAR",DQ=1
 ...
 M DIEZAR=^DIE(1247,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1247,U="^"
