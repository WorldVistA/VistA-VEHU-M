IBXSC4 ; GENERATED FROM 'IB SCREEN4' INPUT TEMPLATE(#1251), FILE 399;09/01/09
 D DE G BEGIN
...
BEGIN S DNM="IBXSC4",DQ=1
 ...
 M DIEZAR=^DIE(1251,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1251,U="^"
