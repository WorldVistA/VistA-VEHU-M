IBXS9 ; GENERATED FROM 'IB SCREEN9' INPUT TEMPLATE(#2271), FILE 399;03/19/19
 D DE G BEGIN
...
BEGIN S DNM="IBXS9",DQ=1
 ...
 M DIEZAR=^DIE(2271,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2271,U="^"
