...
X1 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
2 D:$D(DG)>9 F^DIE17,DE S DQ=2,DW="M1;11",DV="*P355.97'",DU="",DLB="SECONDARY ID QUALIFIER",DIFLD=129
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X11 S IBPSDAT=$$GETID^IBCEP7B(DA,2),IBPSID=$P(IBPSDAT,U),IBPSQUAL=$P(IBPSDAT,U,2) I IBPSID="" S Y="@322"
 Q
12 S DW="M1;3",DV="FX",DU="",DLB="SECONDARY PROVIDER #",DIFLD=123
 S DE(DW)="C12^IBXS36"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X12 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,DW="M1;11",DV="*P355.97'",DU="",DLB="SECONDARY ID QUALIFIER",DIFLD=129
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
18 S DW="M1;3",DV="FX",DU="",DLB="SECONDARY PROVIDER #",DIFLD=123
 S DE(DW)="C18^IBXS36"
...
22 D:$D(DG)>9 F^DIE17,DE S DQ=22,DW="M1;11",DV="*P355.97'",DU="",DLB="SECONDARY ID QUALIFIER",DIFLD=129
 S DU="IBE(355.97,"
...
X23 S Y="@3225"
 Q
24 S DQ=25 ;@3224
25 S DW="M1;11",DV="*P355.97'",DU="",DLB="Secondary ID Qualifier",DIFLD=129
 S DU="IBE(355.97,"
 G RE
...
X30 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW="M1;12",DV="*P355.97'",DU="",DLB="TERTIARY ID QUALIFIER",DIFLD=130
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X40 S IBPSDAT=$$GETID^IBCEP7B(DA,3),IBPSID=$P(IBPSDAT,U),IBPSQUAL=$P(IBPSDAT,U,2) I IBPSID="" S Y="@323"
 Q
41 S DW="M1;4",DV="FX",DU="",DLB="TERTIARY PROVIDER #",DIFLD=124
 S DE(DW)="C41^IBXS36"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X41 K:$L(X)>13!($L(X)<3)!($TR(X," ")="") X
 ...
 Q
 ;
42 D:$D(DG)>9 F^DIE17,DE S DQ=42,DW="M1;12",DV="*P355.97'",DU="",DLB="TERTIARY ID QUALIFIER",DIFLD=130
 S DU="IBE(355.97,"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
47 S DW="M1;4",DV="FX",DU="",DLB="TERTIARY PROVIDER #",DIFLD=124
 S DE(DW)="C47^IBXS36"
 S X="IBPSID" Q:X  Q:$NA(@X)[U  S X=$G(@X)
 S Y=X
 G Y
...
51 D:$D(DG)>9 F^DIE17,DE S DQ=51,DW="M1;12",DV="*P355.97'",DU="",DLB="TERTIARY ID QUALIFIER",DIFLD=130
 S DU="IBE(355.97,"
 S X="IBPSQUAL" Q:X  Q:$NA(@X)[U  S X=$G(@X)
 S Y=X
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
...
X52 S Y="@3235"
 Q
53 S DQ=54 ;@3234
54 S DW="M1;12",DV="*P355.97'",DU="",DLB="Tertiary ID Qualifier",DIFLD=130
 S DU="IBE(355.97,"
 G RE
