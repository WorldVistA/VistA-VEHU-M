IBXSC5 ; GENERATED FROM 'IB SCREEN5' INPUT TEMPLATE(#1252), FILE 399;01/04/08
 D DE G BEGIN
...
BEGIN S DNM="IBXSC5",DQ=1
 ...
 M DIEZAR=^DIE(1252,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1252,U="^"
