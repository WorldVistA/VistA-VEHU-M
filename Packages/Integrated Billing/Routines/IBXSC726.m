...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBXSC726",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;5",DV="R*P399.1'",DU="",DLB="BEDSECTION",DIFLD=.05
 S DE(DW)="C1^IBXSC726"
 S DU="DGCR(399.1,"
 G RE
...
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 Q
X1 S DIC("S")="I $P(^(0),U,5)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
2 D:$D(DG)>9 F^DIE17 G ^IBXSC727
