IBYHONI1 ; ; 21-NOV-1995
 ...
 K DIF,DIK,D,DDF,DDT,DTO,D0,DLAYGO,DIC,DIR,DA,DFR,DTN,DIX,DZ D DT^IBYHONI2 S %=1,U="^",DSEC=1
 ...
 D DT^IBYHONI2 K ^UTILITY(U,$J),^UTILITY("DIK",$J) W !,"...OK, this may take a while, hold on please..." F R=1001:1:1002 D @("^IBYHO"_$E(R,2,4)) W "."
