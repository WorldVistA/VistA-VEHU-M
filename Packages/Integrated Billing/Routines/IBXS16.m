...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=2,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 ...
 I $D(^(.121)) S %Z=^(.121) S %=$P(%Z,U,1) S:%]"" DE(12)=% S %=$P(%Z,U,2) S:%]"" DE(14)=% S %=$P(%Z,U,7) S:%]"" DE(9)=% S %=$P(%Z,U,8) S:%]"" DE(11)=% S %=$P(%Z,U,9) S:%]"" DE(7)=%
...
C1F1 N X,X1,X2 S DIXR=255 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
C2F1 N X,X1,X2 S DIXR=256 D C2X1(U) K X2 M X2=X D C2X1("O") K X1 M X1=X
 D
...
C3F1 N X,X1,X2 S DIXR=157 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
...
C3X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C3F2 S DIXR=252 D C3X2(U) K X2 M X2=X D C3X2("O") K X1 M X1=X
 D
