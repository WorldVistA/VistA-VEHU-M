YTSMOC81 ;BAL/KTL - Score MOCA 8.1 ; 10/14/18 2:02pm
...
SCORESV ; calculate the score
 ...
 . I YTQ>9423,(YTQ<9429) S YTVAL=$S(YTVAL=3:1,1:0)  ;3 scored as 1 in Total
 . S YTRAW=YTRAW+YTVAL
 . I YTQ>9423,(YTQ<9429) S YTMIS=YTMIS+$P(^YTT(601.75,YTCHC,0),U,2)
 ...
 S ^TMP($J,"YSCOR",2)=$P(^YTT(601.87,1582,0),U,4)_"="_SCORE
 S ^TMP($J,"YSCOR",3)=$P(^YTT(601.87,1583,0),U,4)_"="_YTMIS
 Q
