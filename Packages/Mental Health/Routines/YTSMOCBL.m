YTSMOCBL ;BAL/KTL - Score MOCA BLIND ; 10/14/18 2:02pm
...
SCORESV ; calculate the score
 ...
 . I YTQ>9502,(YTQ<9508) S YTVAL=$S(YTVAL=3:1,1:0)  ;3 scored as 1 in Total
 . S YTRAW=YTRAW+YTVAL
 . I YTQ>9502,(YTQ<9508) S YTMIS=YTMIS+$P(^YTT(601.75,YTCHC,0),U,2)
 ...
 S ^TMP($J,"YSCOR",2)=$P(^YTT(601.87,1588,0),U,4)_"="_SCORE
 ;S ^TMP($J,"YSCOR",3)=$P(^YTT(601.87,1589,0),U,4)_"="_YTMIS
 Q
