RMPRONIT ; ; 19-OCT-1993
 ;;2.0;PROSTHETICS;;OCT 19, 1993
 ;
 K DIF,DIK,DDF,DDT,DTO,D0,DLAYGO,DIC,DIR,DA,ORVROM,DFR,DTN,DIX,DZ
 S DIFQ=0,ORVROM=22 W !!,"This version of 'RMPRONIT' was created on 19-OCT-1993"
 W !?9,"(at VAMC PHOENIX, by OE/RR V.2.5)",!
 G Q:DIFQ D ^RMPRONI1 G Q:'$D(DIFQ) S DIK(0)="B"
 D ^RMPRONI2,^RMPRONI3
