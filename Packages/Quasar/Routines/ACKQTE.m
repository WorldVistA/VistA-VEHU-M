ACKQTE ; GENERATED FROM 'ACKQAS VISIT ENTRY' INPUT TEMPLATE(#1860), FILE 509850.6;11/24/10
 D DE G BEGIN
...
BEGIN S DNM="ACKQTE",DQ=1
 ...
 M DIEZAR=^DIE(1860,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1860,U="^"
