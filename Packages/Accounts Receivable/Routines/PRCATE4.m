...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="PRCATE4",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;9",DV="R*P340X",DU="",DLB="DEBTOR",DIFLD=9
 S DE(DW)="C1^PRCATE4"
 S DU="RCD(340,"
 G RE
