...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="PRCATA14",DQ=1
1 S DW="0;3",DV="RNJ9,2X",DU="",DLB="TOTAL ORIGINAL AMOUNT",DIFLD=3
 S DE(DW)="C1^PRCATA14"
 G RE
...
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 Q
X1 S:X["$" X=$P(X,"$",2) K:X'?.N.1".".2N!(X>999999.99)!(X<0) X
 Q
 ;
2 D:$D(DG)>9 F^DIE17 G ^PRCATA15
