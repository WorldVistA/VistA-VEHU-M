PRCATRF ; GENERATED FROM 'PRCARFD' PRINT TEMPLATE (#1671) ; 05/26/95 ; (FILE 430, MARGIN=80)
 G BEGIN
N W !
...
BEGIN ;
 ...
 D N:$X>46 Q:'DN  W ?46 S Y=$P(X,U,21) S Y=$S(Y="":Y,$D(^VA(200,Y,0))#2:$P(^(0),U,1),1:Y) W $E(Y,1,30)
 K Y
 Q
HEAD ;
 W !,?0,"BILL NO."
