PSOERUT1 ;ALB/MFR - eRx Provider - ListMan Utilities; 06/25/2023 5:14pm
 ;;7.0;OUTPATIENT PHARMACY;**700,743**;DEC 1997;Build 24
 ;
SETPROV(MODE,ERXIEN,VAPRVIEN,NMSPC,PENFLG) ; Set ListMan Side-By-Side Section for Provider
 ...
 . S VAPDEA=$P($$VADEA^PSOERXU8(VAPRVIEN,ERXIEN),"^",2)  ; PSO*7*743
 . S VAPDEAEX=$$DEAXDT^XUSER(VAPDEA) I VAPDEAEX,VAPDEAEX<DT S DEAEXP=1  ; PSO*7*743
