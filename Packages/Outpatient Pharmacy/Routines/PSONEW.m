PSONEW ;BIR/SAB - new rx order main driver ;Jul 24, 2017@15:24
 ;;7.0;OUTPATIENT PHARMACY;**11,27,32,46,94,130,268,225,251,379,390,417,313,411,457,524,711,545,700,753**;DEC 1997;Build 53
...
EOJ ;
 ...
 K PSONOEDT,PSONEW,PSODRUG,ANQDATA,LSI,C,MAX,MIN,NDF,REF,SIG,SER,PSOFLAG,PSOHI,PSOLO,PSONOOR,PSOCOUU,PSOCOU,PSORX("EDIT"),ZNEW,PSOMAILX
 D CLEAN^PSOVER1
...
COUN ;patient counseling
 S PSOMAILX=$G(PSONEW("MAIL EXEMPTION")) ;mail exemption p743
