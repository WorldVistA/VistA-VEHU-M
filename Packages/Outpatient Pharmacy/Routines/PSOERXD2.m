PSOERXD2 ;ALB/BWF - eRx Drug edit actions ; Jan 06, 2023@08:14:59
 ;;7.0;OUTPATIENT PHARMACY;**467,506,520,508,551,581,617,651,689,700**;DEC 1997;Build 261
SBN ;
 N Y,ERXIEN
 S Y=$P(XQORNOD(0),"=",2)
 ;
...
VDRG3(PSOIEN,PSOIENS) ;
 N DIR,Y,PATINST,ERXDRUG,VDRG,VAOI,FDA,NEWVAL,DEL
 D DERX1(PSOIEN,PSOIENS,1)
...
VDRG4(PSOIEN,PSOIENS) ;
 ...
 S DIR(0)="FO^1:240",DIR("A")="VA Provider Comments"
