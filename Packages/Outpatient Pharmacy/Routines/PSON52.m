PSON52 ;BIR/DSD - files new entries in prescription file ;Jan 20, 2022@11:18:18
 ;;7.0;OUTPATIENT PHARMACY;**1,16,23,27,32,46,71,111,124,117,131,139,157,143,219,148,239,201,268,260,225,303,358,251,387,379,390,391,313,408,473,504,505,517,457,617,562,441,746,753**;DEC 1997;Build 53
...
NFILE I $G(OR0) D  Q:$G(PSONEW("DFLG"))
 ...
 . I $P(OR0,"^",24)!PSCSERX S $P(^PSRX(PSOX("IRXN"),"PKI"),"^",1,3)=$S($G(PSOSIGFL):"^1^",1:"1^^") D ACLOG Q
