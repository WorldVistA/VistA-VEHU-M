PSORXRP1 ;BIR/SAB-rx speed reprint listman ;03/06/95
 ;;7.0;OUTPATIENT PHARMACY;**11,27,120,156,148,367,641**;DEC 1997;Build 10
...
SEL N PSODISP,PSOMGREP,VALMCNT I '$G(PSOCNT) S VALMSG="This patient has no Prescriptions!" S VALMBCK="" Q
 ...
 K DIR,DIRUT,DTOUT,PSOOELSE,PSOREPX,PSOSUSID I +LST S PSOOELSE=1 D
 ...
 D ^PSOBUILD
 K PSOMSG,PSORPSRX,QFLG,%,DIR,DUOUT,DTOUT,DIROUT,DIRUT,PCOM,PCOMX,C,I,J,JJJ,K,RX,RXF,X,Y,Z,P,PDA,PSPRXN,COPIES,SIDE,PPL,REPRINT,PSOOELSE,ORD,LST,ORN,PSOSUSID D KVA^VADPT
 Q
 ;
