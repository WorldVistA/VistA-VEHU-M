...
ELIGSTS(VIEW,ERXSTS,MSGTYPE) ; Checks whether the eRx's status is eligible to be on the list (counted)
 ...
 . I PSOSTFLT="N",",RXN,N,CXN,"'[STS S SKIP=1
 . I PSOSTFLT="I",",RXI,I,CXI,"'[STS S SKIP=1
 . I PSOSTFLT="W",",RXW,W,CXW,"'[STS S SKIP=1
 . I PSOSTFLT="C" D  S SKIP=$S(PSOCCRST="ALL"&(CCRSTS[STS):0,PSOCCRST'="ALL"&(PSOCCRST=ERXSTS):0,1:1)
 . . S CCRSTS=",RXN,RXR,RXE,RXD,RXF,CAO,CAR,CAH,CAP,CAX,CAF,CXD,CXN,CXV,CXY,CXE,"
 . I PSOSTFLT="H" S SKIP=$S(PSOHDSTS="ALL"&(STS=",H,"):0,PSOHDSTS'="ALL"&(PSOHDSTS=ERXSTS):0,1:1)
 ; Default: Eligible
 Q 1
 ;
