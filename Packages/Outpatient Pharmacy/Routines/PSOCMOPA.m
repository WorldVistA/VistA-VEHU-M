PSOCMOPA ;BIR/HTW-Utility for Hold/Can/Park ;Feb 07, 2019@06:29:42
 ;;7.0;OUTPATIENT PHARMACY;**61,76,443,508,441,768,827**;DEC 1997;Build 4
 ...
 ;p827 I CMOP("L")>0,$P(^PSRX(DA,1,CMOP("L"),0),U,2)'="M" Q
 N PSORTE S PSORTE="" S:$G(CMOP("L")) PSORTE=$P(^PSRX(DA,1,CMOP("L"),0),U,2)
 Q:(CMOP("L")>0)&((PSORTE="W")!(PSORTE=""))  Q:$G(PSOREF("MAIL/WINDOW"))="W"  ;eot p827
