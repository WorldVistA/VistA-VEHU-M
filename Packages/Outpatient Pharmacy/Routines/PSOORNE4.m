PSOORNE4 ;BIR/SAB-display renew RXs from backdoor ;Mar 30, 2022@14:37:15
 ;;7.0;OUTPATIENT PHARMACY;**11,27,32,36,46,75,96,103,99,117,131,225,386,390,391,313,411,661,441,700,743**;DEC 1997;Build 24
...
EDTSEL S PSOLM=1,(PSONEW("DFLG"),PSONEW("FIELD"),PSONEW3)=0
 I '$G(PSORXIEN),$G(ORD),$$ERXIEN^PSOERXUT($G(ORD)_"P") S PSOVLMBG=VALMBG
...
RMK S IEN=IEN+1,^TMP("PSOPO",$J,IEN,0)="  (8)        Remarks: "_$S($G(PSONEW("REMARKS"))]"":PSONEW("REMARKS"),1:"")
 ...
 . D SETPEN^PSOERUT5("PSOPO",ERXIEN,+ORD,.PSONEW,.PSODRUG,.SIG,1) S (VALMCNT,PSOPF,IEN)=LINE-1
 . D RV^PSONFI
