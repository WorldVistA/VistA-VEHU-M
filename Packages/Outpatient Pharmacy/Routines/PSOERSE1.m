...
HDR ; -- header code
 ...
 E  D INSTR^VALM1("Written: "_IOINHI_$$FMTE^XLFDT($$GET1^DIQ(52.49,ERXIEN,5.9,"I"),"2Z"),64,3)
...
GETMTYPE(ERXIEN) ;Retrieve the eRx Message Type
 ...
 I $$GET1^DIQ(52.49,ERXIEN,95.1,"I") S $E(MTYPEE,63)="EPCS DEA VALIDATED" ;controlled substance indicator
 Q $G(MTYPEE)
 ;
INIT ;
...
S2017(MODE,NAMESPACE,ERXIEN,S2017) ;Retrieve erx written and effective/issue date
 ...
 I 'S2017 D
 . S WDATE=$$GET1^DIQ(52.49,ERXIEN,5.9,"I")
 . S ERXDT=$$GET1^DIQ(52.49,ERXIEN,.03,"I")
 . S XE="Written: "_$$COMPARE^PSOERUT0(MODE,$$FMTE^XLFDT(WDATE,2),$$FMTE^XLFDT(WDATE,2),10)
 . S XE=XE_"  Effective: "_$$COMPARE^PSOERUT0(MODE,$$FMTE^XLFDT($P(ERXDT,"."),2),$$FMTE^XLFDT($P(ERXDT,"."),2),31)
 ...
 . S ERXWDATE=$$GET1^DIQ(52.49,ERXIEN,5.9,"I")
 . S XE="Written: "_$$COMPARE^PSOERUT0(MODE,$$FMTE^XLFDT($P(ERXWDATE,"."),2),$$FMTE^XLFDT($P(ERXWDATE,"."),2),10)
 . S XE=XE_"  Effective: "_$$COMPARE^PSOERUT0(MODE,$$FMTE^XLFDT(ERXEFFDT,2),$$FMTE^XLFDT(ERXEFFDT,2),31)
 . D ADDLINE^PSOERUT0(MODE,NMSPC,XE,"|")
 Q
 ;
