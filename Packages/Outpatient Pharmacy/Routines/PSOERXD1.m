PSOERXD1 ;ALB/BWF - eRx Drug display/actions ; 8/3/2016 5:14pm
 ;;7.0;OUTPATIENT PHARMACY;**467,520,551,582,581,635,617,651,689,700,746**;DEC 1997;Build 106
 ;
...
HDR ; -- header code
 ...
 S VALMHDR(2)="Date Written   : "_IOINHI_$$FMTE^XLFDT($$GET1^DIQ(52.49,PSOIEN,5.9,"I"),"2Y")_IOINORM
