PSOHLD ;BIR/SAB - hold unhold functionality; Mar 22, 2026@18:00
 ;;7.0;OUTPATIENT PHARMACY;**1,16,21,24,27,32,55,82,114,130,166,148,268,281,298,358,353,385,386,370,488,562,441,712,780,827**;DEC 1997;Build 4
 ;
...
EN S RXF=0 F I=0:0 S I=$O(^PSRX(DA,1,I)) Q:'I  S RXF=I,RSDT=$P(^(I,0),"^")
 ...
 ;PSO*7.0*827: Moved line below from EN+67 to here:
