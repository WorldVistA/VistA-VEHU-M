PSOORFIN ;BIR/SAB - finish cprs orders ;Nov 30, 2021@08:00:32
 ;;7.0;OUTPATIENT PHARMACY;**7,15,27,32,44,46,84,106,111,117,131,146,139,195,225,315,266,338,391,372,416,446,505,508,557,628,441**;DEC 1997;Build 209
...
ORD I $G(PSOBCK) N LST,ORN
 ...
 I $P(OR0,"^",3)="RF",$D(^PSRX(+$P(OR0,"^",19),0)) D RF^PSOORFI2 D  G SUCC
 .N DA S DA=$O(^PS(52.41,"ARF",+$P(OR0,"^",19),0)) I DA D  S DIK="^PS(52.41," D ^DIK K DIK
