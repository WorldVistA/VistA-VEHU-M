APSPT042 ; ;07/11/93
 D DE G BEGIN
DE S DIE="^APSPQA(32.4,",DIC=DIE,DP=9009032.4,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^APSPQA(32.4,DA,-1))<0
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="APSPT042",DQ=1
1 S D=0 K DE(1) ;1400
 S Y="ACTION TAKEN^WL^^0;1^Q",DG="14" D DIEN^DIWE K DE(1) G A
 ;
2 S D=0 K DE(1) ;1500
 S Y="CLINICAL IMPACT^WL^^0;1^Q",DG="15" D DIEN^DIWE K DE(1) G A
 ;
3 S D=0 K DE(1) ;1600
 S Y="FINANCIAL IMPACT^WL^^0;1^Q",DG="16" D DIEN^DIWE K DE(1) G A
 ;
4 G 0^DIE17
