PSOBBC ;IHS/DSD/JCM - BATCH BARCODE DRIVER ;Feb 03, 2022@11:08
 ;;7.0;OUTPATIENT PHARMACY;**11,22,27,34,46,130,146,185,242,264,300,337,313,473,504,570,653,441,811**;DEC 1997;Build 5
 ;
...
PTC S (DFN,PSODFN)=$P(^PSRX(PSOBBC("IRXN"),0),"^",2)
 ...
 ;PSO*7.0*811: ADJUSTED LINE BELOW TO PREVENT UNDIFINED ERROR WHEN PSORX("NAME") IS CALLED.
 I $G(PSOPTPST(2,PSODFN,.351))]"" S PSORX("NAME")=$P(^DPT(PSODFN,0),"^"),PSOBBC("DFLG")=1 D DEAD^PSOPTPST G PTX
