PSOHLSNC ;BIR/RTR - Send CHCS message to CPRS ;07/03/02
 ;;7.0;OUTPATIENT PHARMACY;**111,157,143,225,404,755**;DEC 1997;Build 4
...
EN(PSOPND,PSOPNDST,PSOPNDPT) ;
 ...
 N PSOSEGMT,PSOHENT,PSOHPRO,PSOHIM,PSOHPC,PSOHPCTX,PSOHRT,PSOHRTE,PSOHRTEN,PSOHRTX,Y,DA,DIQ,DR,PSOWRDT
...
RXE ;Build RXE segment
 ...
 I $$GET1^DIQ(52.49,PSOIEN,95.1,"I"),$$CS^PSOERXA0(PSOHNDD) D     ;P755 Check if CS and send DEA#
 . S PSOWRDT=$$GET1^DIQ(52.49,PSOIEN,5.9,"I") S PSOXFLD(13)=$P($$DEA^XUSER(0,PSOHPRO,PSOWRDT),"-",1)
