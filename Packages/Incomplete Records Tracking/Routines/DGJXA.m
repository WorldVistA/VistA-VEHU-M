DGJXA ; GENERATED FROM 'DGJ ENTER IRT RECORD' INPUT TEMPLATE(#1167), FILE 393;01/26/04
 D DE G BEGIN
...
BEGIN S DNM="DGJXA",DQ=1
 ...
 M DIEZAR=^DIE(1167,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1167,U="^"
