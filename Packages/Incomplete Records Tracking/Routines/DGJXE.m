DGJXE ; GENERATED FROM 'DGJ EDIT IRT RECORD' INPUT TEMPLATE(#1166), FILE 393;01/26/04
 D DE G BEGIN
...
BEGIN S DNM="DGJXE",DQ=1
 ...
 M DIEZAR=^DIE(1166,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1166,U="^"
