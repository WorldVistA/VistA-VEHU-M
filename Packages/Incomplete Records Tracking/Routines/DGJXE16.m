DGJXE16 ; ;06/24/93
 D DE G BEGIN
DE S DIE="^VAS(393,",DIC=DIE,DP=393,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^VAS(393,DA,-1))<0
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGJXE16",DQ=1
1 S DW="DT;8",DV="P200'",DU="",DLB="REVIEWED BY",DIFLD=10.08
 S DU="VA(200,"
 G RE
X1 Q
