PRCHT2 ; GENERATED FROM 'PRCHPUSH' INPUT TEMPLATE(#818), FILE 442;11/22/00
 D DE G BEGIN
...
BEGIN S DNM="PRCHT2",DQ=1
 ...
 M DIEZAR=^DIE(818,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=818,U="^"
