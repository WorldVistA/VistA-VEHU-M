...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="PRCHT353",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;5",DV="*P441'X",DU="",DLB="ITEM MASTER FILE NO.",DIFLD=1.5
 S DE(DW)="C1^PRCHT353"
 S DU="PRC(441,"
 G RE
...
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 ...
 Q
X1 S DIC("S")="I 1",DIC(0)=DIC(0)_"O" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X I $D(X) D EN5^PRCHNPO5
 Q
 ;
2 D:$D(DG)>9 F^DIE17 G ^PRCHT354
