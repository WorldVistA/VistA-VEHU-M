...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="PRCHT345",DQ=1
1 S DW="3;9",DV="S",DU="",DLB="SSN/TAX ID INDICATOR",DIFLD=39
...
X3 W !!,"Please tell me whether the TAX ID/SSN field is a TAX NUMBER or a SSN NUMBER.",!
 Q
4 D:$D(DG)>9 F^DIE17 G ^PRCHT346
