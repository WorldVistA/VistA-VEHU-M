...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="PRCHT367",DQ=1
1 S DW="4;13",DV="F",DU="",DLB="DIETETIC CONVERSION FACTOR",DIFLD=42
 G RE
X1 K:$L(X)>5!($L(X)<1) X
 I $D(X),X'?.ANP K X
 Q
...
X2 S Y=$S(PRCHN("SC")'=9:4,1:"@4")
 Q
3 D:$D(DG)>9 F^DIE17 G ^PRCHT368
