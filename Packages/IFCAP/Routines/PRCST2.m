PRCST2 ; GENERATED FROM 'PRCSENR&NRS' INPUT TEMPLATE(#299), FILE 410;11/22/00
 D DE G BEGIN
...
BEGIN S DNM="PRCST2",DQ=1
 ...
 M DIEZAR=^DIE(299,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=299,U="^"
