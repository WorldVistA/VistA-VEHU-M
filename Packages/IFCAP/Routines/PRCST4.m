PRCST4 ; GENERATED FROM 'PRCSEN2237S' INPUT TEMPLATE(#292), FILE 410;11/22/00
 D DE G BEGIN
...
BEGIN S DNM="PRCST4",DQ=1
 ...
 M DIEZAR=^DIE(292,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=292,U="^"
