PRCPSPD0 ;WISC/AKS-disassemble set packs for secondaries ;6 May 92
 ;;4.0;IFCAP;;9/23/93
 ;
 K ^TMP($J)
 N ITEMDA,CST,ITEMZ,Y,PRCPAVG,PRCPCOST,PRCPDTI,PRCPI,PRCPITEM,PRCPITYP,PRCPMY,PRCPOAVG,PRCPODI,PRCPONH,PRCPORD,PRCPQ,PRCPQTY
 N PRCPSET,PRCPUI,PRCPUR,PRCPVPNT,PRCPDESC,PRCPNSN,PRCPSUB,PCE,PRCPUN,PRCPVEN,SLCT,PRCPCC,PRCPXCST,%,ORDERNO,X
 ; DISASSEMBLE RETURNED SETS/PACK--DECREMENTS SET/PACK INVENTORY BY 1, DECREMENTS SECONDARY'S INVENTORY FOR USED ITEMS
 ...
 S DIC("W")="S Z=^PRC(441,+Y,0),PRCPDESC=$P(Z,U,2) S:$D(^PRCP(445,DA(1),1,+Y,6)) PRCPDESC=$S($P(^(6),U,1)'="""":$P(^(6),U,1),1:$P(Z,U,2)) D WD^PRCPSPD2"
