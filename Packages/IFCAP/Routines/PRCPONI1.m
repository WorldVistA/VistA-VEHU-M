PRCPONI1 ; ; 28-FEB-1995
 ...
 K DIF,DIK,D,DDF,DDT,DTO,D0,DLAYGO,DIC,DIR,DA,DFR,DTN,DIX,DZ D DT^PRCPONI2 S %=1,U="^",DSEC=1
 ...
 D DT^PRCPONI2 K ^UTILITY(U,$J),^UTILITY("DIK",$J) W !,"...OK, this may take a while, hold on please..." F R=1001:1:1011 D @("^PRCPO"_$E(R,2,4)) W "."
