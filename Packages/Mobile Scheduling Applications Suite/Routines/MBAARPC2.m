MBAARPC2 ;OIT-PD/PB - Scheduling RPCs;08/27/2014
 ...
 ;  430
 ;  6044
 ;  6064 MBAA ACCESS TO SCTM(404.57
 ;  1945 DBIA1945
...
CLNDATA(RETURN,CLINICID) ; returns additional clinic data MBAA ADDITIONAL CLINIC DETAILS
 ...
 N NODE,STOPPTR,SPECPTR,CREDITPRT,SPECLTY,SPECL,SPEC,STOPCODE,CREDIT,CREDITPTR,CLINIC1,SPEC1  ;IRC#: 6044
 ...
 S SPEC=$G(CLINIC(44,CLINICID_",",9.5,"E")),STOPCODE=$G(CLINIC1(44,CLINICID_",",8,"E")),CREDIT=$G(CLINIC1(44,CLINICID_",",2503,"E"))
...
NEWEWL(RV,SDWLD) ; ZLV EWL NEW
 ...
 S X=$G(SDWLD("INSTITUTION")) S SITE=$$IEN^XUMF(4,,X) I +$G(SITE)'>0 S RV(0)="0^INVPARAM INVALID INSTITUTION NUMBER." Q  ;ICR#:3795 XUMF
