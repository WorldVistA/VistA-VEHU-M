...
DE S DIE="^RAO(75.1,",DIC=DIE,DP=75.1,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^RAO(75.1,DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,6) S:%]"" DE(3)=% S %=$P(%Z,U,20) S:%]"" DE(11)=%,DE(15)=% S %=$P(%Z,U,24) S:%]"" DE(1)=% S %=$P(%Z,U,26) S:%]"" DE(6)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="0;24",DV="S",DU="",DLB="IS PATIENT ON ISOLATION PROCEDURES?",DIFLD=24
 S DU="y:YES;n:NO;"
 S X="NO"
 S Y=X
 G Y
...
X2 S:$D(RAEXMUL) RAIP=X
 Q
3 S DW="0;6",DV="S",DU="",DLB="REQUEST URGENCY",DIFLD=6
...
X9 S RAREQLOC=$$ILOC^RAUTL18(RAPRI)
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 I 'RAREQLOC S Y="@165"
 Q
11 S DW="0;20",DV="*P79.1'",DU="",DLB="IMAGING LOCATION",DIFLD=20
 S DU="RA(79.1,"
 S X=RAREQLOC
 S Y=X
...
X14 I '$D(RALOCFLG) S Y="@175"
 Q
15 S DW="0;20",DV="*P79.1'R",DU="",DLB="SUBMIT REQUEST TO",DIFLD=20
 S DU="RA(79.1,"
 G RE
X15 S DIC("S")="I $$SUBMIT^RAUTL13(DA,+Y)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
16 S DQ=17 ;@170
17 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=17 D X17 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X17 S:$D(RAEXMUL) RAILOC=X
 Q
18 S DQ=19 ;@175
...
X21 K RAI,RAPRI,RAMOD,RAIMAG,RAWPFLAG,RAREQLOC,RAMODPRO
 Q
22 G 0^DIE17
