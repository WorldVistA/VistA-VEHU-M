RACTVR ; GENERATED FROM 'RA VERIFY REPORT ONLY' INPUT TEMPLATE(#240), FILE 74;03/19/10
 D DE G BEGIN
DE S DIE="^RARPT(",DIC=DIE,DP=74,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^RARPT(DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,5) S:%]"" DE(5)=%,DE(16)=%,DE(18)=%
...
BEGIN S DNM="RACTVR",DQ=1
 ...
 M DIEZAR=^DIE(240,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=240,U="^"
