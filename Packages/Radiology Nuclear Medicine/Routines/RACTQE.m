RACTQE ; GENERATED FROM 'RA QUICK EXAM ORDER' INPUT TEMPLATE(#1281), FILE 75.1;10/31/18
 D DE G BEGIN
DE S DIE="^RAO(75.1,",DIC=DIE,DP=75.1,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^RAO(75.1,DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,2) S:%]"" DE(2)=%,DE(9)=% S %=$P(%Z,U,4) S:%]"" DE(26)=% S %=$P(%Z,U,8) S:%]"" DE(14)=% S %=$P(%Z,U,12) S:%]"" DE(28)=% S %=$P(%Z,U,13) S:%]"" DE(31)=% S %=$P(%Z,U,20) S:%]"" DE(49)=%,DE(54)=%
 I  S %=$P(%Z,U,21) S:%]"" DE(39)=%,DE(42)=%,DE(45)=%
...
BEGIN S DNM="RACTQE",DQ=1
 ...
 M DIEZAR=^DIE(1281,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1281,U="^"
...
C39F1 N X,X1,X2 S DIXR=1487 D C39X1(U) K X2 M X2=X D C39X1("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C42S S X="" G:DG(DQ)=X C42F1 K DB
 S X=DG(DQ),DIC=DIE
 S ^RAO(75.1,"AP",+$P(^RAO(75.1,DA,0),U),+$P(^(0),U,2),9999999.9999-$E(X,1,30),DA)=""
C42F1 N X,X1,X2 S DIXR=1487 D C42X1(U) K X2 M X2=X D C42X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^RAO(75.1,"BDD",$E(X,1,30),DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^RAO(75.1,"BDD",$E(X,1,30),DA)=""
...
C45S S X="" G:DG(DQ)=X C45F1 K DB
 S X=DG(DQ),DIC=DIE
 S ^RAO(75.1,"AP",+$P(^RAO(75.1,DA,0),U),+$P(^(0),U,2),9999999.9999-$E(X,1,30),DA)=""
C45F1 N X,X1,X2 S DIXR=1487 D C45X1(U) K X2 M X2=X D C45X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^RAO(75.1,"BDD",$E(X,1,30),DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^RAO(75.1,"BDD",$E(X,1,30),DA)=""
