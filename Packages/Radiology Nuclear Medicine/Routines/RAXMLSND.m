...
X1 L +^XTMP(RAXTMPNM,"O"):20 I '$T S CNT=CNT+1 G X1:CNT<11,XMLOUT
 ...
 S RANOS2=0 I '$$PROD^XUPROD()!(AA'["VA.GOV") S RANOS2=1
 ;
...
NOTVALID ; if not valid to send to ISAAC then only send MAILMAN message to RANTRT group
 ...
 S A="",B="",C="",D="",E="" S:RANOS1=1 A="No Send Location" S:'$$PROD^XUPROD() B="Not a Production System" S:AA'["VA.GOV" C="Not a VA System"
