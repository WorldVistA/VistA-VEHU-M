...
1 S DW="0;19",DV="S",DU="",DLB="MODE OF TRANSPORT",DIFLD=19
...
X2 S:$D(RAEXMUL) RAMT=X
 Q
3 S DW="0;24",DV="S",DU="",DLB="IS PATIENT ON ISOLATION PROCEDURES?",DIFLD=24
 S DU="y:YES;n:NO;"
 S X="NO"
 S Y=X
 G Y
...
X4 S:$D(RAEXMUL) RAIP=X
 Q
5 S DW="0;6",DV="S",DU="",DLB="REQUEST URGENCY",DIFLD=6
...
X7 S:$$ORVR^RAORDU()<3 Y="@163"
 Q
8 S DW="0;26",DV="S",DU="",DLB="NATURE OF (NEW) ORDER ACTIVITY",DIFLD=26
