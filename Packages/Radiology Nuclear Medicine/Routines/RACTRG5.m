...
1 S DW="0;8",DV="*P44'R",DU="",DIFLD=8,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="SC("
...
X7 I RAWARD'="Unknown" S Y="@66"
 Q
8 S DW="0;6",DV="P42'R",DU="",DIFLD=6,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(42,"
 G RE
X8 Q
...
X9 S Y="@68"
 Q
10 S DQ=11 ;@66
11 S DW="0;6",DV="P42'",DU="",DIFLD=6,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(42,"
 S X=RAWARD
 S Y=X
...
X13 I RASER'="Unknown" S Y="@80"
 Q
14 S DW="0;7",DV="P49'R",DU="",DIFLD=7,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(49,"
 G RE
X14 Q
...
X15 S Y="@85"
 Q
16 S DQ=17 ;@80
17 S DW="0;7",DV="P49'",DU="",DIFLD=7,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(49,"
 S X=RASERIEN
 S Y=X
...
X19 I RABED'="Unknown" S Y="@95"
 Q
20 S DW="0;19",DV="P42.4'R",DU="",DIFLD=19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(42.4,"
 G RE
X20 Q
...
X21 S Y="@100"
 Q
22 S DQ=23 ;@95
23 S DW="0;19",DV="P42.4'",DU="",DIFLD=19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(42.4,"
 S X=RABED
 S Y=X
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
...
X23 Q
24 S DQ=25 ;@100
25 S DW="0;21",DV="D",DU="",DIFLD=21,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S X=$S($D(RARDTE):RARDTE,1:"")
 S Y=X
 S X=Y,DB(DQ)=1,DE(DW,"4/")="" G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD:X="@",Z
X25 Q
26 S DW="0;22",DV="P44'",DU="",DIFLD=22,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="SC("
...
X48 S:RAIEN702=-1 Y="@450"
 Q
49 S DW="0;28",DV="P70.2'",DU="",DIFLD=500,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C49^RACTRG5"
 S DU="RADPTN("
 S X=RAIEN702
 S Y=X
...
X61 S:($$PRSCR^RAUTL8(RADFN,RADTI,RACNI,"I")="n")!($$PRSCR^RAUTL8(RADFN,RADTI,RACNI,"I")="") Y="@8001"
 Q
62 S DW="PCOMM;E1,240",DV="FR",DU="",DIFLD=80,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
