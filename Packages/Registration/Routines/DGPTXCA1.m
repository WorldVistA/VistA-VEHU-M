...
DE S DIE="^DGPT(",DIC=DIE,DP=45,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^DGPT(DA,-1))<0
 I $D(^(101)) S %Z=^(101) S %=$P(%Z,U,1) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTXCA1",DQ=1
1 S DW="101;1",DV="*P45.1'",DU="",DLB="SOURCE OF ADMISSION",DIFLD=20
 S DU="DIC(45.1,"
 G RE
X1 S DIC("S")="S DGER=0 D SA^DGPTFJ K DGSU0,DGSU1 I 'DGER" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
