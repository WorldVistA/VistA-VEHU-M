...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 ...
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,1) S:%]"" DE(25)=% S %=$P(%Z,U,2) S:%]"" DE(35)=% S %=$P(%Z,U,3) S:%]"" DE(45)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
C22S S X="" G:DG(DQ)=X C22F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C22F1 N X,X1,X2 S DIXR=1613 D C22X1(U) K X2 M X2=X D C22X1("O") K X1 M X1=X
 D
...
C32S S X="" G:DG(DQ)=X C32F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C32F1 N X,X1,X2 S DIXR=1614 D C32X1(U) K X2 M X2=X D C32X1("O") K X1 M X1=X
 D
...
C42S S X="" G:DG(DQ)=X C42F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C42F1 N X,X1,X2 S DIXR=1615 D C42X1(U) K X2 M X2=X D C42X1("O") K X1 M X1=X
 D
...
C52S S X="" G:DG(DQ)=X C52F1 K DB
 D ^DGPTX53
C52F1 N X,X1,X2 S DIXR=1616 D C52X1(U) K X2 M X2=X D C52X1("O") K X1 M X1=X
 D
