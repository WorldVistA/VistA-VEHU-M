...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGMTXE2",DQ=1
1 S DW="1;2",DV="NJ8,2X",DU="",DLB="FUNERAL AND BURIAL EXPENSES",DIFLD=1.02
 G RE
X1 S:X["$" X=$P(X,"$",2) K:X'?.N.1".".2N!(X>99999)!(X<0) X D FUN^DGMTDD3:$D(X)
 Q
 ;
2 S DQ=3 ;@1010
3 D:$D(DG)>9 F^DIE17 G ^DGMTXE3
