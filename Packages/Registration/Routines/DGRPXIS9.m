DGRPXIS9 ; ;06/24/93
 D DE G BEGIN
DE S DIE="^DGMT(408.21,",DIC=DIE,DP=408.21,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^DGMT(408.21,DA,-1))<0
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,16) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
X3 S:DGDR'[910 Y="@998"
 Q
4 D:$D(DG)>9 F^DIE17 G ^DGRPXIS10
