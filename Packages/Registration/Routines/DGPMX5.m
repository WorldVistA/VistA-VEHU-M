DGPMX5 ; GENERATED FROM 'DGPM LODGER CHECK-OUT' INPUT TEMPLATE(#1101), FILE 405;12/05/12
 D DE G BEGIN
...
BEGIN S DNM="DGPMX5",DQ=1
 ...
 M DIEZAR=^DIE(1101,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1101,U="^"
