DGYPGLI ;ALB/LM - TREATING SPECIALTY INPATIENT INFO ;6/15/93
...
START I $D(IO("Q")) S DGTSDT=ZTSAVE("DGTSDT"),PTLWD=ZTSAVE("PTLWD"),PTLTS=ZTSAVE("PTLTS"),PTCTS=ZTSAVE("PTCTS")
 S (DGT,Y)=DGTSDT
 X ^DD("DD") S DGTSDT=Y
 F DFN=0:0 S DFN=$O(^DPT(DFN)) Q:'DFN  S DGTS=0,DGXFR0="" D EN ; I DG1 D TREAT,START^DGYPGLI1,START^DGYPGLI2
 D START^DGYPGLO
 Q
...
CA ; -- scan mvts for cor. adm that happened on or before DGT date 
 ...
 I DG1 D TREAT,START^DGYPGLI1,START^DGYPGLI2
 I $P(DG1,"^",3)=13 S DG1=""
CAQ Q
 ;
