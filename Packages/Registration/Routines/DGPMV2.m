DGPMV2 ;ALB/MRL/MIR - PATIENT MOVEMENT PROCESSOR; 21 APR 1989
 ;;5.3;Registration;**40,1105**;Aug 13, 1993;Build 9
 ;
 ;DG*5.3*1105 Called new HELP doc for ADMIT DATE to exclude future date info
 ;
...
SHOW I $O(^UTILITY("DGPMVN",$J,0)) W !,"CHOOSE FROM" S %DT="RSE" W ! F I=0:0 S I=$O(^UTILITY("DGPMVN",$J,I)) Q:'I  D WR^DGPMV20
 W ! D HELPLP^DGPMV21(16) K I,I1,N,D,C,%DT Q   ;DG*5.3*1105
 ;
