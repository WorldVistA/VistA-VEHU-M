...
1 S DW="71;6",DV="*P80'X",DU="",DIFLD=79.246,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1239,1603 S DIEZRXR(45,DIXR)=""
 Q
...
X3 I DGXX="" S Y="@141"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;16",DV="SX",DU="",DIFLD=82.16,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@160"
 Q
11 S DW="71;7",DV="*P80'X",DU="",DIFLD=79.247,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1240,1604 S DIEZRXR(45,DIXR)=""
 Q
...
X13 I DGXX="" S Y="@151"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;17",DV="SX",DU="",DIFLD=82.17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X20 S DGNFLD="@170"
 Q
21 S DW="71;8",DV="*P80'X",DU="",DIFLD=79.248,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1241,1605 S DIEZRXR(45,DIXR)=""
 Q
...
X23 I DGXX="" S Y="@161"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;18",DV="SX",DU="",DIFLD=82.18,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X30 S DGNFLD="@180"
 Q
31 S DW="71;9",DV="*P80'X",DU="",DIFLD=79.249,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C31F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1242,1606 S DIEZRXR(45,DIXR)=""
 Q
...
X33 I DGXX="" S Y="@171"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;19",DV="SX",DU="",DIFLD=82.19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X40 S DGNFLD="@190"
 Q
41 S DW="71;10",DV="*P80'X",DU="",DIFLD=79.2491,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C41F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1243,1607 S DIEZRXR(45,DIXR)=""
 Q
...
X43 I DGXX="" S Y="@181"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;20",DV="SX",DU="",DIFLD=82.2,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
