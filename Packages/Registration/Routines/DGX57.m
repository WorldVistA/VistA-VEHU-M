...
1 S DW="0;15",DV="*P80'X",DU="",DIFLD=15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1171,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X3 I DGXX="" S Y="@121"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;10",DV="SX",DU="",DIFLD=82.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@140"
 Q
11 S DW="81;1",DV="*P80'X",DU="",DIFLD=81.01,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1223,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X13 I DGXX="" S Y="@131"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;11",DV="SX",DU="",DIFLD=82.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X20 S DGNFLD="@150"
 Q
21 S DW="81;2",DV="*P80'X",DU="",DIFLD=81.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1224,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X23 I DGXX="" S Y="@141"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;12",DV="SX",DU="",DIFLD=82.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X30 S DGNFLD="@160"
 Q
31 S DW="81;3",DV="*P80'X",DU="",DIFLD=81.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C31F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1225,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X33 I DGXX="" S Y="@151"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;13",DV="SX",DU="",DIFLD=82.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X40 S DGNFLD="@170"
 Q
41 S DW="81;4",DV="*P80'X",DU="",DIFLD=81.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X43 I DGXX="" S Y="@161"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;14",DV="SX",DU="",DIFLD=82.14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
