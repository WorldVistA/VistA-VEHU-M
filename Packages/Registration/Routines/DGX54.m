...
1 S DW="0;9",DV="*P80'X",DU="",DIFLD=9,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1166,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X3 I DGXX="" S Y="@71"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;5",DV="SX",DU="",DIFLD=82.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X11 S DGNFLD="@90"
 Q
12 S DW="0;11",DV="*P80'X",DU="",DIFLD=11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C12^DGX54",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C12F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1167,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X14 I DGXX="" S Y="@81"
 Q
15 D:$D(DG)>9 F^DIE17,DE S DQ=15,DW="82;6",DV="SX",DU="",DIFLD=82.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X21 S DGNFLD="@100"
 Q
22 S DW="0;12",DV="*P80'X",DU="",DIFLD=12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C22^DGX54",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C22F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1168,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X24 I DGXX="" S Y="@91"
 Q
25 D:$D(DG)>9 F^DIE17,DE S DQ=25,DW="82;7",DV="SX",DU="",DIFLD=82.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X31 S DGNFLD="@110"
 Q
32 S DW="0;13",DV="*P80'X",DU="",DIFLD=13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C32^DGX54",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C32F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1169,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X34 I DGXX="" S Y="@101"
 Q
35 D:$D(DG)>9 F^DIE17,DE S DQ=35,DW="82;8",DV="SX",DU="",DIFLD=82.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X41 S DGNFLD="@120"
 Q
42 S DW="0;14",DV="*P80'X",DU="",DIFLD=14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C42^DGX54",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C42F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1170,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X44 I DGXX="" S Y="@111"
 Q
45 D:$D(DG)>9 F^DIE17,DE S DQ=45,DW="82;9",DV="SX",DU="",DIFLD=82.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
