DGMTXM ; GENERATED FROM 'DGMT ENTER/EDIT MARITAL STATUS' INPUT TEMPLATE(#1231), FILE 408.22;01/26/16
 D DE G BEGIN
...
BEGIN S DNM="DGMTXM",DQ=1
 ...
 M DIEZAR=^DIE(1231,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1231,U="^"
