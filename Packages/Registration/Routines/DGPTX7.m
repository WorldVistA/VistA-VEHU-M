DGPTX7 ; GENERATED FROM 'DG701' INPUT TEMPLATE(#92), FILE 45;06/22/22
 D DE G BEGIN
...
BEGIN S DNM="DGPTX7",DQ=1
 ...
 M DIEZAR=^DIE(92,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=92,U="^"
