...
X1 S DFN=DA D AAC^DGLOCK2
 ...
 ;
2 S D=0 K DE(1) ;361
 S DIFLD=361,DGO="^DGRPX711",DC="3^2.0361IP^E^",DV="2.0361M*P8'X",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DIC(8,"
...
9 D:$D(DG)>9 F^DIE17,DE S DQ=9,D=0 K DE(1) ;.3731
 S DIFLD=.3731,DGO="^DGRPX712",DC="2^2.05A^.373^",DV="2.05MFX",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
...
X12 D:'$G(DGEMHCNVT) YN^DGPPSYCH(DFN) S Y="@706"
 Q
13 S DQ=14 ;@706
14 S DQ=15 ;@99
15 G 0^DIE17
