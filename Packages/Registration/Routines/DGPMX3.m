DGPMX3 ; GENERATED FROM 'DGPM DISCHARGE' INPUT TEMPLATE(#1100), FILE 405;12/05/12
 D DE G BEGIN
DE S DIE="^DGPM(",DIC=DIE,DP=405,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DGPM(DA,""))=""
 ...
 I $D(^("ODS")) S %Z=^("ODS") S %=$P(%Z,U,2) S:%]"" DE(12)=% S %=$P(%Z,U,3) S:%]"" DE(14)=% S %=$P(%Z,U,5) S:%]"" DE(16)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
