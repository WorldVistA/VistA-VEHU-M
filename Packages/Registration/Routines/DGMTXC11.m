...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGMTXC11",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;7",DV="DXR",DU="",DLB="DATE/TIME COMPLETED",DIFLD=.07
 G RE
X1 S %DT="ETX",%DT(0)="-NOW" D ^%DT S X=Y K:Y<1 X I $D(X) D COM^DGMTDD
 Q
 ;
2 S DQ=3 ;@998
