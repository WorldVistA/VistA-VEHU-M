...
C4F1 N X,X1,X2 S DIXR=852 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 D
...
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,D=0 K DE(1) ;361
 S DIFLD=361,DGO="^DGRPTX29",DC="3^2.0361IP^E^",DV="2.0361M*P8'X",DW="0;1",DOW="ELIGIBILITY",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
 S DU="DIC(8,"
