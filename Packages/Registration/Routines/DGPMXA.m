DGPMXA ; GENERATED FROM 'DGPM ASIH ADMIT' INPUT TEMPLATE(#1104), FILE 405;12/05/12
 D DE G BEGIN
...
BEGIN S DNM="DGPMXA",DQ=1
 ...
 M DIEZAR=^DIE(1104,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1104,U="^"
