...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,8) S:%]"" DE(8)=% S %=$P(%Z,U,9) S:%]"" DE(18)=% S %=$P(%Z,U,10) S:%]"" DE(28)=% S %=$P(%Z,U,11) S:%]"" DE(38)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,17) S:%]"" DE(1)=% S %=$P(%Z,U,18) S:%]"" DE(11)=% S %=$P(%Z,U,19) S:%]"" DE(21)=% S %=$P(%Z,U,20) S:%]"" DE(31)=% S %=$P(%Z,U,21) S:%]"" DE(41)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="DGX5FD10",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="82;17",DV="SX",DU="",DIFLD=82.17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X1 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,7) X
 Q
 ;
2 S DQ=3 ;@191
...
X4 I X K DGPTIT S DGNFLD="@200",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
5 S DQ=6 ;@200
6 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=6 D X6 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X6 I DGADD,$P(DGHOLD1,U,8)]"" S Y="@210"
 Q
7 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=7 D X7 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X7 S DGNFLD="@210"
 Q
8 S DW="81;8",DV="*P80'X",DU="",DIFLD=81.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C8^DGX5FD10",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C8S S X="" G:DG(DQ)=X C8F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C8F1 N X,X1,X2 S DIXR=1630 D C8X1(U) K X2 M X2=X D C8X1("O") K X1 M X1=X
 D
...
X10 I DGXX="" S Y="@201"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="82;18",DV="SX",DU="",DIFLD=82.18,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X11 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,8) X
 Q
 ;
12 S DQ=13 ;@201
...
X14 I X K DGPTIT S DGNFLD="@210",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
15 S DQ=16 ;@210
16 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=16 D X16 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X16 I DGADD,$P(DGHOLD1,U,9)]"" S Y="@220"
 Q
17 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=17 D X17 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X17 S DGNFLD="@220"
 Q
18 S DW="81;9",DV="*P80'X",DU="",DIFLD=81.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C18^DGX5FD10",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C18S S X="" G:DG(DQ)=X C18F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C18F1 N X,X1,X2 S DIXR=1631 D C18X1(U) K X2 M X2=X D C18X1("O") K X1 M X1=X
 D
...
X20 I DGXX="" S Y="@211"
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW="82;19",DV="SX",DU="",DIFLD=82.19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X21 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,9) X
 Q
 ;
22 S DQ=23 ;@211
...
C28S S X="" G:DG(DQ)=X C28F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C28F1 N X,X1,X2 S DIXR=1632 D C28X1(U) K X2 M X2=X D C28X1("O") K X1 M X1=X
 D
...
X30 I DGXX="" S Y="@221"
 Q
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW="82;20",DV="SX",DU="",DIFLD=82.2,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X31 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,10) X
 Q
 ;
32 S DQ=33 ;@221
...
C38S S X="" G:DG(DQ)=X C38F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C38F1 N X,X1,X2 S DIXR=1633 D C38X1(U) K X2 M X2=X D C38X1("O") K X1 M X1=X
 D
...
X40 I DGXX="" S Y="@231"
 Q
41 D:$D(DG)>9 F^DIE17,DE S DQ=41,DW="82;21",DV="SX",DU="",DIFLD=82.21,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X41 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,11) X
 Q
 ;
42 S DQ=43 ;@231
