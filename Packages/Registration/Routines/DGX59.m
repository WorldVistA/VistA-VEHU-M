...
1 S DW="81;10",DV="*P80'X",DU="",DIFLD=81.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C1^DGX59",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
11 S DW="81;11",DV="*P80'X",DU="",DIFLD=81.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX59",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
21 S DW="81;12",DV="*P80'X",DU="",DIFLD=81.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C21^DGX59",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
31 S DW="81;13",DV="*P80'X",DU="",DIFLD=81.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGX59",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
41 S DW="81;14",DV="*P80'X",DU="",DIFLD=81.14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^DGX59",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C41F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1236,1701 S DIEZRXR(45.02,DIXR)=""
 Q
