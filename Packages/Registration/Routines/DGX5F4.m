...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,26) S:%]"" DE(1)=% S %=$P(%Z,U,27) S:%]"" DE(4)=%,DE(7)=% S %=$P(%Z,U,28) S:%]"" DE(10)=%,DE(13)=% S %=$P(%Z,U,29) S:%]"" DE(22)=%,DE(25)=% S %=$P(%Z,U,30) S:%]"" DE(28)=%,DE(32)=%
 I  S %=$P(%Z,U,32) S:%]"" DE(16)=%,DE(19)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="0;26",DV="SX",DU="",DIFLD=26,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X1 S DGFLAG=1 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
2 S DQ=3 ;@9150
3 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=3 D X3 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X3 I '$D(DGEXQ(2)) S Y="@9200"
 Q
4 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB="WAS TREATMENT RELATED TO IONIZING RADIATION EXPOSURE?"
 S DU="Y:YES;N:NO;"
 G RE
X4 S DGFLAG=2 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
...
X5 S Y="@9250"
 Q
6 S DQ=7 ;@9200
7 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X7 S DGFLAG=2 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
8 S DQ=9 ;@9250
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I '$D(DGEXQ(3)) S Y="@9300"
 Q
10 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB="WAS TREATMENT RELATED TO SERVICE IN SW ASIA?"
 S DU="Y:YES;N:NO;"
 G RE
X10 S DGFLAG=3 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
...
X11 S Y="@9350"
 Q
12 S DQ=13 ;@9300
13 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X13 S DGFLAG=3 D 501^DGPTSPQ K:DGER X K DGER,DGFLAG
 Q
 ;
14 S DQ=15 ;@9350
15 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=15 D X15 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X15 I '$D(DGEXQ(7)) S Y="@9400"
 Q
16 S DW="0;32",DV="S",DU="",DIFLD=32,DLB="WAS TREATMENT RELATED TO PROJ 112/SHAD?"
 S DU="Y:YES;N:NO;"
 G RE
X16 Q
...
X17 S Y="@9450"
 Q
18 S DQ=19 ;@9400
19 S DW="0;32",DV="S",DU="",DIFLD=32,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X21 I '$D(DGEXQ(4)) S Y="@9500"
 Q
22 S DW="0;29",DV="S",DU="",DIFLD=29,DLB="WAS TREATMENT RELATED TO MILITARY SEXUAL TRAUMA?"
 S DU="Y:YES;N:NO;"
 G RE
X22 Q
...
X23 S Y="@9550"
 Q
24 S DQ=25 ;@9500
25 S DW="0;29",DV="S",DU="",DIFLD=29,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X27 I '$D(DGEXQ(5)) S Y="@9600"
 Q
28 S DW="0;30",DV="S",DU="",DIFLD=30,DLB="WAS TREATMENT RELATED TO HEAD AND/OR NECK CANCER?"
 S DU="Y:YES;N:NO;"
 G RE
X28 Q
29 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=29 D X29 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X29 I X["Y",$D(DFN),$$FILEHNC^DGNTAPI1(DFN)
 Q
