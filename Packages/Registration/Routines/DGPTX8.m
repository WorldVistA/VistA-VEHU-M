DGPTX8 ; GENERATED FROM 'DG801' INPUT TEMPLATE(#2175), FILE 46.1;04/12/09
 D DE G BEGIN
...
BEGIN S DNM="DGPTX8",DQ=1
 ...
 M DIEZAR=^DIE(2175,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2175,U="^"
