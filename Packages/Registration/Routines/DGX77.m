...
X5 I $P(DG701,U,3)]"" S Y="@840"
 Q
6 S DW="300;3",DV="SX",DU="",DIFLD=300.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="1:Yes;2:No;"
 G RE
...
X11 D DRUG^DGPTSC01 I $D(DGTX) S Y="@850"
 Q
12 S DW="300;4",DV="P45.61'X",DU="",DIFLD=300.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(45.61,"
 G RE
...
X14 S Y="@860"
 Q
15 S DQ=16 ;@850
16 S DW="300;4",DV="P45.61'X",DU="",DIFLD=300.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(45.61,"
 S X=DGTX
 S Y=X
 G Y
...
X20 I $P(DG701,U,5)]"" S Y="@870"
 Q
21 S DW="300;5",DV="SX",DU="",DIFLD=300.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X25 I $P(DG701,U,6)]"" S Y="@880"
 Q
26 S DW="300;6",DV="NJ2,0X",DU="",DIFLD=300.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
...
X30 I $P(DG701,U,7)]"" S Y="@890"
 Q
31 S DW="300;7",DV="NJ2,0X",DU="",DIFLD=300.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
