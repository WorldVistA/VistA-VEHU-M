DGPTXMS1 ; ;06/24/93
 D DE G BEGIN
DE S DIE="^DGM(",DIC=DIE,DP=45.5,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^DGM(DA,-1))<0
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGPTXMS1",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;3",DV="P200'",DU="",DLB="ENTRY CLERK",DIFLD=2
 S DU="VA(200,"
 S X=DUZ
 S Y=X
