...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGMTXN2",DQ=1
1 S DW="2;2",DV="NJ9,2X",DU="",DLB="STOCKS AND BONDS",DIFLD=2.02
 G RE
X1 S:X["$" X=$P(X,"$",2) K:X'?.N.1".".2N!(X>999999)!(X<0) X D NET^DGMTDD3:$D(X)
 Q
 ;
2 S DQ=3 ;@103
