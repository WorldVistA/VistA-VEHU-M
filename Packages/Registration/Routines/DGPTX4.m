DGPTX4 ; GENERATED FROM 'DG401' INPUT TEMPLATE(#85), FILE 45;03/11/23
 D DE G BEGIN
...
1 S D=0 K DE(1) ;40
 S DIFLD=40,DGO="^DGPTX41",DC="33^45.01D^S^",DV="45.01MDX",DW="0;1",DOW=$$LABEL^DIALOGZ(DP,DIFLD),DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
