...
BEGIN S DNM="DGX511",DQ=1
1 S DW="0;29",DV="S",DU="",DIFLD=29,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
...
X3 I '$D(DGEXQ(5)) S Y="@9600"
 Q
4 S DW="0;30",DV="S",DU="",DIFLD=30,DLB="WAS TREATMENT RELATED TO HEAD AND/OR NECK CANCER?"
 S DU="Y:YES;N:NO;"
 G RE
X4 Q
...
X6 S Y="@9650"
 Q
7 S DQ=8 ;@9600
8 S DW="0;30",DV="S",DU="",DIFLD=30,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
