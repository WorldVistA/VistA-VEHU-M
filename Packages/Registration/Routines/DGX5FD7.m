...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,3) S:%]"" DE(1)=% S %=$P(%Z,U,4) S:%]"" DE(11)=% S %=$P(%Z,U,5) S:%]"" DE(21)=% S %=$P(%Z,U,6) S:%]"" DE(31)=% S %=$P(%Z,U,7) S:%]"" DE(41)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,13) S:%]"" DE(4)=% S %=$P(%Z,U,14) S:%]"" DE(14)=% S %=$P(%Z,U,15) S:%]"" DE(24)=% S %=$P(%Z,U,16) S:%]"" DE(34)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1625 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1626 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C21F1 N X,X1,X2 S DIXR=1627 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C31F1 N X,X1,X2 S DIXR=1628 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 D
...
C41S S X="" G:DG(DQ)=X C41F1 K DB
 D ^DGX5FD9
C41F1 N X,X1,X2 S DIXR=1629 D C41X1(U) K X2 M X2=X D C41X1("O") K X1 M X1=X
 D
...
X43 I DGXX="" S Y="@191"
 Q
44 D:$D(DG)>9 F^DIE17 G ^DGX5FD10
