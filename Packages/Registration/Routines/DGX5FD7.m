...
1 S DW="81;9",DV="*P80'X",DU="",DIFLD=81.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1231,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X3 I DGXX="" S Y="@211"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;19",DV="SX",DU="",DIFLD=82.19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@230"
 Q
11 S DW="81;10",DV="*P80'X",DU="",DIFLD=81.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1232,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X13 I DGXX="" S Y="@221"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;20",DV="SX",DU="",DIFLD=82.2,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X20 S DGNFLD="@240"
 Q
21 S DW="81;11",DV="*P80'X",DU="",DIFLD=81.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1233,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X23 I DGXX="" S Y="@231"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;21",DV="SX",DU="",DIFLD=82.21,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X30 S DGNFLD="@250"
 Q
31 S DW="81;12",DV="*P80'X",DU="",DIFLD=81.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C31F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1234,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X33 I DGXX="" S Y="@241"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;22",DV="SX",DU="",DIFLD=82.22,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X40 S DGNFLD="@260"
 Q
41 S DW="81;13",DV="*P80'X",DU="",DIFLD=81.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C41F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1235,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X43 I DGXX="" S Y="@251"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;23",DV="SX",DU="",DIFLD=82.23,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
