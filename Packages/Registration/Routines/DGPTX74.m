...
1 S DW="71;1",DV="*P80'X",DU="",DIFLD=79.241,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1158,1699 S DIEZRXR(45,DIXR)=""
 Q
...
X3 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@91"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;11",DV="SX",DU="",DIFLD=82.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@110"
 Q
11 S DW="71;2",DV="*P80'X",DU="",DIFLD=79.242,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1159,1699 S DIEZRXR(45,DIXR)=""
 Q
...
X13 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@101"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;12",DV="SX",DU="",DIFLD=82.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X20 S DGNFLD="@120"
 Q
21 S DW="71;3",DV="*P80'X",DU="",DIFLD=79.243,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1160,1699 S DIEZRXR(45,DIXR)=""
 Q
...
X23 I DGCODSYS="ICD9"!(DGXX="")!(DGTYPE=2) S Y="@111"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;13",DV="SX",DU="",DIFLD=82.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X33 I $P(DG701,U,2)]"" S Y="@820"
 Q
34 S DW="300;2",DV="SX",DU="",DIFLD=300.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X38 I $P(DG701,U,3)]"" S Y="@840"
 Q
39 S DW="300;3",DV="SX",DU="",DIFLD=300.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="1:Yes;2:No;"
 G RE
...
X44 D DRUG^DGPTSC01 I $D(DGTX) S Y="@850"
 Q
45 S DW="300;4",DV="P45.61'X",DU="",DIFLD=300.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="DIC(45.61,"
 G RE
...
X53 I $P(DG701,U,5)]"" S Y="@870"
 Q
54 S DW="300;5",DV="SX",DU="",DIFLD=300.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X58 I $P(DG701,U,6)]"" S Y="@880"
 Q
59 S DW="300;6",DV="NJ2,0X",DU="",DIFLD=300.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
