...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,8) S:%]"" DE(1)=% S %=$P(%Z,U,9) S:%]"" DE(11)=% S %=$P(%Z,U,10) S:%]"" DE(21)=% S %=$P(%Z,U,11) S:%]"" DE(31)=% S %=$P(%Z,U,12) S:%]"" DE(41)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,18) S:%]"" DE(4)=% S %=$P(%Z,U,19) S:%]"" DE(14)=% S %=$P(%Z,U,20) S:%]"" DE(24)=% S %=$P(%Z,U,21) S:%]"" DE(34)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1630 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
11 S DW="81;9",DV="*P80'X",DU="",DIFLD=81.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX510",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1631 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
21 S DW="81;10",DV="*P80'X",DU="",DIFLD=81.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C21^DGX510",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C21F1 N X,X1,X2 S DIXR=1632 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
...
31 S DW="81;11",DV="*P80'X",DU="",DIFLD=81.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGX510",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C31F1 N X,X1,X2 S DIXR=1633 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 D
...
41 S DW="81;12",DV="*P80'X",DU="",DIFLD=81.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^DGX510",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C41S S X="" G:DG(DQ)=X C41F1 K DB
 D ^DGX512
C41F1 N X,X1,X2 S DIXR=1634 D C41X1(U) K X2 M X2=X D C41X1("O") K X1 M X1=X
 D
