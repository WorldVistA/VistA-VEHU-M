...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,27) S:%]"" DE(1)=%,DE(4)=% S %=$P(%Z,U,28) S:%]"" DE(7)=%,DE(10)=% S %=$P(%Z,U,29) S:%]"" DE(19)=%,DE(22)=% S %=$P(%Z,U,30) S:%]"" DE(25)=%,DE(29)=% S %=$P(%Z,U,32) S:%]"" DE(13)=%,DE(16)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB="WAS TREATMENT RELATED TO IONIZING RADIATION EXPOSURE?"
 S DU="Y:YES;N:NO;"
 G RE
...
X2 S Y="@9250"
 Q
3 S DQ=4 ;@9200
4 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
...
X6 I '$D(DGEXQ(3)) S Y="@9300"
 Q
7 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB="WAS TREATMENT RELATED TO SERVICE IN SW ASIA?"
 S DU="Y:YES;N:NO;"
 G RE
...
X8 S Y="@9350"
 Q
9 S DQ=10 ;@9300
10 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X12 I '$D(DGEXQ(7)) S Y="@9400"
 Q
13 S DW="0;32",DV="S",DU="",DIFLD=32,DLB="WAS TREATMENT RELATED TO PROJ 112/SHAD?"
 S DU="Y:YES;N:NO;"
 G RE
X13 Q
...
X14 S Y="@9450"
 Q
15 S DQ=16 ;@9400
16 S DW="0;32",DV="S",DU="",DIFLD=32,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X18 I '$D(DGEXQ(4)) S Y="@9500"
 Q
19 S DW="0;29",DV="S",DU="",DIFLD=29,DLB="WAS TREATMENT RELATED TO MILITARY SEXUAL TRAUMA?"
 S DU="Y:YES;N:NO;"
 G RE
X19 Q
...
X20 S Y="@9550"
 Q
21 S DQ=22 ;@9500
22 S DW="0;29",DV="S",DU="",DIFLD=29,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
