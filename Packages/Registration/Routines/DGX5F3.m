...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,8) S:%]"" DE(1)=% S %=$P(%Z,U,9) S:%]"" DE(11)=% S %=$P(%Z,U,26) S:%]"" DE(61)=% S %=$P(%Z,U,31) S:%]"" DE(55)=%,DE(58)=%
...
1 S DW="0;8",DV="*P80'X",DU="",DIFLD=8,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C1^DGX5F3",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
11 S DW="0;9",DV="*P80'X",DU="",DIFLD=9,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX5F3",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
