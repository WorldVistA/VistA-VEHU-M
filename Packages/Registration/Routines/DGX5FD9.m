...
1 S DW="0;27",DV="SX",DU="",DIFLD=27,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
...
X3 I '$D(DGEXQ(3)) S Y="@9300"
 Q
4 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB="WAS TREATMENT RELATED TO SERVICE IN SW ASIA?"
 S DU="Y:YES;N:NO;"
 G RE
...
X5 S Y="@9350"
 Q
6 S DQ=7 ;@9300
7 S DW="0;28",DV="SX",DU="",DIFLD=28,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X9 I '$D(DGEXQ(7)) S Y="@9400"
 Q
10 S DW="0;32",DV="S",DU="",DIFLD=32,DLB="WAS TREATMENT RELATED TO PROJ 112/SHAD?"
 S DU="Y:YES;N:NO;"
 G RE
X10 Q
...
X11 S Y="@9450"
 Q
12 S DQ=13 ;@9400
13 S DW="0;32",DV="S",DU="",DIFLD=32,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X15 I '$D(DGEXQ(4)) S Y="@9500"
 Q
16 S DW="0;29",DV="S",DU="",DIFLD=29,DLB="WAS TREATMENT RELATED TO MILITARY SEXUAL TRAUMA?"
 S DU="Y:YES;N:NO;"
 G RE
X16 Q
...
X17 S Y="@9550"
 Q
18 S DQ=19 ;@9500
19 S DW="0;29",DV="S",DU="",DIFLD=29,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
X21 I '$D(DGEXQ(5)) S Y="@9600"
 Q
22 S DW="0;30",DV="S",DU="",DIFLD=30,DLB="WAS TREATMENT RELATED TO HEAD AND/OR NECK CANCER?"
 S DU="Y:YES;N:NO;"
 G RE
X22 Q
...
X24 S Y="@9650"
 Q
25 S DQ=26 ;@9600
26 S DW="0;30",DV="S",DU="",DIFLD=30,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:YES;N:NO;"
 S Y="@"
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
