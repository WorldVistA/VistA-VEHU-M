VAFCPDAT ;BIR/CML/ALS-DISPLAY MPI/PD INFORMATION FOR SELECTED PATIENT ; 7/12/16 11:11am
 ;;5.3;Registration;**333,414,474,505,707,712,837,863,876,902,926,937,950,1059**;Aug 13, 1993;Build 6
...
START ;Entry point without device call, used for RPC calls
 ...
 S DIC=2,DR=".01;.02;.03;.09;.111;.112;.113;.114;.115;.1112;.131;.313;.351;994;.0907;.0906;.121;.1171;.1172;.1173;.024;.352;.353;.354;.355;.357;.358;.2405;.025;.0251;.2406;.24061;991.11;.1151;.1152;.1153;.1154;.1155;.1156;.11571;.11572;.11573"
 ...
 S PHN=$G(DNODE(2,DFN,.131,"E")),PREAS=$G(DNODE(2,DFN,.0906,"E"))  ;**707
 ...
 S RESCN=$G(DNODE(2,DFN,.11573,"I")),(CCODE,CNAME)="" I RESCN]"" S RCCODE=$$GET1^DIQ(779.004,+COUNTRY_",",.01),RCNAME=$$GET1^DIQ(779.004,+COUNTRY_",",1.3)
