...
C15F1 N X,X1,X2 S DIXR=1289 D C15X1(U) K X2 M X2=X D C15X1("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C20F1 N X,X1,X2 S DIXR=1300 D C20X1(U) K X2 M X2=X D C20X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C25F1 N X,X1,X2 S DIXR=1307 D C25X1(U) K X2 M X2=X D C25X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C30F1 N X,X1,X2 S DIXR=1308 D C30X1(U) K X2 M X2=X D C30X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C35F1 N X,X1,X2 S DIXR=1309 D C35X1(U) K X2 M X2=X D C35X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
