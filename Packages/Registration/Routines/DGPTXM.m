DGPTXM ; GENERATED FROM 'DG PTF ADD MESSAGE' INPUT TEMPLATE(#1106), FILE 45.5;12/03/01
 D DE G BEGIN
...
BEGIN S DNM="DGPTXM",DQ=1
 ...
 M DIEZAR=^DIE(1106,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1106,U="^"
