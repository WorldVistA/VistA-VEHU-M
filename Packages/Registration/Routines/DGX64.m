...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;14",DV="*P80.1'X",DU="",DIFLD=13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1249,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X5 S DGNFLD="@140"
 Q
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW="0;15",DV="*P80.1'X",DU="",DIFLD=14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C6F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1250,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X10 S DGNFLD="150"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="0;16",DV="*P80.1'X",DU="",DIFLD=15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1251,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X15 S DGNFLD="@160"
 Q
16 D:$D(DG)>9 F^DIE17,DE S DQ=16,DW="0;17",DV="*P80.1'X",DU="",DIFLD=16,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C16F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1252,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X20 S DGNFLD="@170"
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW="0;18",DV="*P80.1'X",DU="",DIFLD=17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1253,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X25 S DGNFLD="@180"
 Q
26 D:$D(DG)>9 F^DIE17,DE S DQ=26,DW="0;19",DV="*P80.1'X",DU="",DIFLD=18,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C26^DGX64",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C26F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1254,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X30 S DGNFLD="@190"
 Q
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW="0;20",DV="*P80.1'X",DU="",DIFLD=19,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGX64",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C31F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1255,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X35 S DGNFLD="@200"
 Q
36 D:$D(DG)>9 F^DIE17,DE S DQ=36,DW="0;21",DV="*P80.1'X",DU="",DIFLD=20,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C36^DGX64",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C36F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1256,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X40 S DGNFLD="@210"
 Q
41 D:$D(DG)>9 F^DIE17,DE S DQ=41,DW="0;22",DV="*P80.1'X",DU="",DIFLD=21,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^DGX64",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C41F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1257,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X45 S DGNFLD="@220"
 Q
46 D:$D(DG)>9 F^DIE17,DE S DQ=46,DW="0;23",DV="*P80.1'X",DU="",DIFLD=22,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C46^DGX64",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C46F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1258,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X50 S DGNFLD="@230"
 Q
51 D:$D(DG)>9 F^DIE17,DE S DQ=51,DW="0;24",DV="*P80.1'X",DU="",DIFLD=23,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C51^DGX64",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C51F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1259,1670 S DIEZRXR(45.05,DIXR)=""
 Q
