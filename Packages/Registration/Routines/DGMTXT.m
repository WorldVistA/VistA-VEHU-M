DGMTXT ; GENERATED FROM 'DGMT V1 ENTER/EDIT DEPENDENTS' INPUT TEMPLATE(#2240), FILE 408.22;01/26/16
 D DE G BEGIN
...
BEGIN S DNM="DGMTXT",DQ=1
 ...
 M DIEZAR=^DIE(2240,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2240,U="^"
