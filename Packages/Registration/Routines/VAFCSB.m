VAFCSB ;BIR/CMC-CONT ADT PROCESSOR TO RETRIGGER A08 or A04 MESSAGES WITH AL/AL (COMMIT/APPLICATION) ACKNOWLEDGEMENTS ;7/14/21  15:25
 ;;5.3;Registration;**707,756,825,876,902,926,967,1059**;Aug 13, 1993;Build 6
 ;
...
SEXOR(DFN,OBX) ;build obx for sexual orientation multiple ;**1059, VAMPI-11114 (dri)
 N IENS,OBXCNT,SEXOR,SEXORCODE,SEXORIEN,SEXORTYP
 D GETS^DIQ(2,DFN_",",".025*","IE","SEXOR")
 I '$D(SEXOR) Q
 S OBXCNT=1,IENS="" F  S IENS=$O(SEXOR(2.025,IENS)) Q:IENS=""  S SEXORIEN=+$G(SEXOR(2.025,IENS,.01,"I")) I SEXORIEN D
 .S SEXORCODE=$$GET1^DIQ(47.77,SEXORIEN_",",1)
 .S SEXORTYP=$G(SEXOR(2.025,IENS,.01,"E"))
 .S OBX(OBXCNT)="OBX"_HL("FS")_HL("FS")_"CE"_HL("FS")_"Sexual Orientation"_HL("FS")_HL("FS")_SEXORCODE_$E(HL("ECH"),1)_SEXORTYP_$E(HL("ECH"),1)_"L" S OBXCNT=OBXCNT+1
 Q
 ;
