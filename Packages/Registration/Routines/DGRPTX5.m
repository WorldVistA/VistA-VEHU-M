...
C4F1 N X,X1,X2 S DIXR=157 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 D
...
C4X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C4F2 S DIXR=252 D C4X2(U) K X2 M X2=X D C4X2("O") K X1 M X1=X
 D
...
C5S S X="" G:DG(DQ)=X C5F1 K DB
 D ^DGRPTX7
C5F1 N X,X1,X2 S DIXR=255 D C5X1(U) K X2 M X2=X D C5X1("O") K X1 M X1=X
 D
