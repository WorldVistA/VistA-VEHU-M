DGMTXI ; GENERATED FROM 'DGMT ENTER/EDIT ANNUAL INCOME' INPUT TEMPLATE(#1233), FILE 408.21;06/02/14
 D DE G BEGIN
...
BEGIN S DNM="DGMTXI",DQ=1
 ...
 M DIEZAR=^DIE(1233,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1233,U="^"
