...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 ...
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,9) S:%]"" DE(4)=% S %=$P(%Z,U,10) S:%]"" DE(14)=% S %=$P(%Z,U,11) S:%]"" DE(24)=% S %=$P(%Z,U,12) S:%]"" DE(34)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 S DW="0;14",DV="*P80'X",DU="",DIFLD=14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1621 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
X3 I DGXX="" S Y="@111"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;9",DV="SX",DU="",DIFLD=82.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@130"
 Q
11 S DW="0;15",DV="*P80'X",DU="",DIFLD=15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1622 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
X13 I DGXX="" S Y="@121"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;10",DV="SX",DU="",DIFLD=82.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X20 S DGNFLD="@140"
 Q
21 S DW="81;1",DV="*P80'X",DU="",DIFLD=81.01,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C21F1 N X,X1,X2 S DIXR=1623 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
...
X23 I DGXX="" S Y="@131"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;11",DV="SX",DU="",DIFLD=82.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X30 S DGNFLD="@150"
 Q
31 S DW="81;2",DV="*P80'X",DU="",DIFLD=81.02,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C31F1 N X,X1,X2 S DIXR=1624 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 D
...
X33 I DGXX="" S Y="@141"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;12",DV="SX",DU="",DIFLD=82.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
...
X40 S DGNFLD="@160"
 Q
41 S DW="81;3",DV="*P80'X",DU="",DIFLD=81.03,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C41S S X="" G:DG(DQ)=X C41F1 K DB
 D ^DGX58
C41F1 N X,X1,X2 S DIXR=1625 D C41X1(U) K X2 M X2=X D C41X1("O") K X1 M X1=X
 D
