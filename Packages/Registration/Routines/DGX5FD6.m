...
1 S DW="81;4",DV="*P80'X",DU="",DIFLD=81.04,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C1F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1226,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X3 I DGXX="" S Y="@161"
 Q
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;14",DV="SX",DU="",DIFLD=82.14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@180"
 Q
11 S DW="81;5",DV="*P80'X",DU="",DIFLD=81.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1227,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X13 I DGXX="" S Y="@171"
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;15",DV="SX",DU="",DIFLD=82.15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X20 S DGNFLD="@190"
 Q
21 S DW="81;6",DV="*P80'X",DU="",DIFLD=81.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C21F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1228,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X23 I DGXX="" S Y="@181"
 Q
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;16",DV="SX",DU="",DIFLD=82.16,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X30 S DGNFLD="@200"
 Q
31 S DW="81;7",DV="*P80'X",DU="",DIFLD=81.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C31F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1229,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X33 I DGXX="" S Y="@191"
 Q
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;17",DV="SX",DU="",DIFLD=82.17,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
...
X40 S DGNFLD="@210"
 Q
41 S DW="81;8",DV="*P80'X",DU="",DIFLD=81.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C41F1 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1230,1701 S DIEZRXR(45.02,DIXR)=""
 Q
...
X43 I DGXX="" S Y="@201"
 Q
44 D:$D(DG)>9 F^DIE17,DE S DQ=44,DW="82;18",DV="SX",DU="",DIFLD=82.18,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;1:Exempt;"
 G RE
