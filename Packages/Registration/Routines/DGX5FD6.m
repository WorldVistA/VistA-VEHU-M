...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,14) S:%]"" DE(8)=% S %=$P(%Z,U,15) S:%]"" DE(18)=%
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,1) S:%]"" DE(28)=% S %=$P(%Z,U,2) S:%]"" DE(38)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,8) S:%]"" DE(1)=% S %=$P(%Z,U,9) S:%]"" DE(11)=% S %=$P(%Z,U,10) S:%]"" DE(21)=% S %=$P(%Z,U,11) S:%]"" DE(31)=% S %=$P(%Z,U,12) S:%]"" DE(41)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="82;8",DV="SX",DU="",DIFLD=82.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X1 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,13) X
 Q
 ;
2 S DQ=3 ;@101
...
X4 I X K DGPTIT S DGNFLD="@110",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
5 S DQ=6 ;@110
6 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=6 D X6 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X6 I DGADD,$P(DGHOLD,U,14)]"" S Y="@120"
 Q
7 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=7 D X7 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X7 S DGNFLD="@120"
 Q
8 S DW="0;14",DV="*P80'X",DU="",DIFLD=14,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C8^DGX5FD6",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C8S S X="" G:DG(DQ)=X C8F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C8F1 N X,X1,X2 S DIXR=1621 D C8X1(U) K X2 M X2=X D C8X1("O") K X1 M X1=X
 D
...
C8F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1170 S DIEZRXR(45.02,DIXR)=""
 Q
...
X10 I DGXX="" S Y="@111"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="82;9",DV="SX",DU="",DIFLD=82.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X11 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,14) X
 Q
 ;
12 S DQ=13 ;@111
...
X14 I X K DGPTIT S DGNFLD="@120",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
15 S DQ=16 ;@120
16 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=16 D X16 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X16 I DGADD,$P(DGHOLD,U,15)]"" S Y="@130"
 Q
17 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=17 D X17 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X17 S DGNFLD="@130"
 Q
18 S DW="0;15",DV="*P80'X",DU="",DIFLD=15,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C18^DGX5FD6",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C18S S X="" G:DG(DQ)=X C18F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C18F1 N X,X1,X2 S DIXR=1622 D C18X1(U) K X2 M X2=X D C18X1("O") K X1 M X1=X
 D
...
C18F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1171 S DIEZRXR(45.02,DIXR)=""
 Q
...
X20 I DGXX="" S Y="@121"
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW="82;10",DV="SX",DU="",DIFLD=82.1,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X21 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,0,15) X
 Q
 ;
22 S DQ=23 ;@121
...
C28S S X="" G:DG(DQ)=X C28F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C28F1 N X,X1,X2 S DIXR=1623 D C28X1(U) K X2 M X2=X D C28X1("O") K X1 M X1=X
 D
...
C28F2 S DIEZRXR(45.02,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1223 S DIEZRXR(45.02,DIXR)=""
 Q
...
X30 I DGXX="" S Y="@131"
 Q
31 D:$D(DG)>9 F^DIE17,DE S DQ=31,DW="82;11",DV="SX",DU="",DIFLD=82.11,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X31 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,1) X
 Q
 ;
32 S DQ=33 ;@131
...
C38S S X="" G:DG(DQ)=X C38F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C38F1 N X,X1,X2 S DIXR=1624 D C38X1(U) K X2 M X2=X D C38X1("O") K X1 M X1=X
 D
...
X40 I DGXX="" S Y="@141"
 Q
41 D:$D(DG)>9 F^DIE17,DE S DQ=41,DW="82;12",DV="SX",DU="",DIFLD=82.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X41 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,2) X
 Q
 ;
42 S DQ=43 ;@141
