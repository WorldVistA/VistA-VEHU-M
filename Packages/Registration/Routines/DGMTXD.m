DGMTXD ; GENERATED FROM 'DGMT ENTER/EDIT DEPENDENTS' INPUT TEMPLATE(#1232), FILE 408.22;01/26/16
 D DE G BEGIN
...
BEGIN S DNM="DGMTXD",DQ=1
 ...
 M DIEZAR=^DIE(1232,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1232,U="^"
