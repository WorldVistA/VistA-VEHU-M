...
DE S DIE="^DGMT(408.31,",DIC=DIE,DP=408.31,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$N(^DGMT(408.31,DA,-1))<0
 I $D(^(0)) S %Z=^(0) S %=$P(%Z,U,11) S:%]"" DE(1)=% S %=$P(%Z,U,12) S:%]"" DE(3)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGMTXC8",DQ=1
1 S DW="0;11",DV="SR",DU="",DLB="AGREED TO PAY DEDUCTIBLE",DIFLD=.11
 S DU="1:YES;0:NO;"
 G RE
X1 Q
2 S DQ=3 ;@40
3 S DW="0;12",DV="NJ8,2",DU="",DLB="THRESHOLD A",DIFLD=.12
 S X=DGTHA
 S Y=X
