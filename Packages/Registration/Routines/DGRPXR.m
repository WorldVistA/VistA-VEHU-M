DGRPXR ; GENERATED FROM 'DGRP COLLATERAL REGISTER' INPUT TEMPLATE(#1095), FILE 2;06/22/22
 D DE G BEGIN
...
BEGIN S DNM="DGRPXR",DQ=1
 ...
 M DIEZAR=^DIE(1095,"AR") S DICRREC="TRIG^DIE17"
...
C2F1 N X,X1,X2 S DIXR=852 D C2X1(U) K X2 M X2=X D C2X1("O") K X1 M X1=X
 D
