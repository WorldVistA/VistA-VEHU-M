DGRPXC ; GENERATED FROM 'DG CONSISTENCY CHECKER' INPUT TEMPLATE(#1094), FILE 2;06/22/22
 D DE G BEGIN
...
BEGIN S DNM="DGRPXC",DQ=1
 ...
 M DIEZAR=^DIE(1094,"AR") S DICRREC="TRIG^DIE17"
...
C1F1 N X,X1,X2 S DIXR=852 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
