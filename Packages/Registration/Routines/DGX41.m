...
C6F1 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1172,1173,1174,1175,1176,1269,1270,1271,1272,1273,1274,1275,1276,1277,1278,1279,1280,1281,1282,1283,1284,1285,1286,1287,1288,1671 S DIEZRXR(45.01,DIXR)=""
 Q
...
C16F1 N X,X1,X2 S DIXR=1289 D C16X1(U) K X2 M X2=X D C16X1("O") K X1 M X1=X
 I $G(X(1))]"" D
...
C16F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1172,1671 S DIEZRXR(45.01,DIXR)=""
 Q
...
C21F1 N X,X1,X2 S DIXR=1300 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C21F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1173,1671 S DIEZRXR(45.01,DIXR)=""
 Q
...
C26F1 N X,X1,X2 S DIXR=1307 D C26X1(U) K X2 M X2=X D C26X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C26F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1174,1671 S DIEZRXR(45.01,DIXR)=""
 Q
...
C31F1 N X,X1,X2 S DIXR=1308 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C31F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1175,1671 S DIEZRXR(45.01,DIXR)=""
 Q
...
C36F1 N X,X1,X2 S DIXR=1309 D C36X1(U) K X2 M X2=X D C36X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C36F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1176,1671 S DIEZRXR(45.01,DIXR)=""
 Q
...
C41F1 N X,X1,X2 S DIXR=1310 D C41X1(U) K X2 M X2=X D C41X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C41F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1285,1671 S DIEZRXR(45.01,DIXR)=""
 Q
...
C46F1 N X,X1,X2 S DIXR=1311 D C46X1(U) K X2 M X2=X D C46X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DGPT(DA(1),"S","AO",X,DA)
 K X M X=X2 I $G(X(1))]"" D
 . S ^DGPT(DA(1),"S","AO",X,DA)=""
...
C46F2 S DIEZRXR(45.01,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1286,1671 S DIEZRXR(45.01,DIXR)=""
 Q
