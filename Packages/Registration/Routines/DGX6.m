DGX6 ; GENERATED FROM 'DG601-10P' INPUT TEMPLATE(#2303), FILE 45;03/11/23
 D DE G BEGIN
...
BEGIN S DNM="DGX6",DQ=1
 ...
 M DIEZAR=^DIE(2303,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=2303,U="^"
