DGPTX1 ; GENERATED FROM 'DG101' INPUT TEMPLATE(#83), FILE 45;06/26/22
 D DE G BEGIN
...
BEGIN S DNM="DGPTX1",DQ=1
 ...
 M DIEZAR=^DIE(83,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=83,U="^"
