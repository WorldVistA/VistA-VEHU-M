...
C25S S X="" G:DG(DQ)=X C25F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C25F1 N X,X1,X2 S DIXR=1613 D C25X1(U) K X2 M X2=X D C25X1("O") K X1 M X1=X
 D
...
C35S S X="" G:DG(DQ)=X C35F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C35F1 N X,X1,X2 S DIXR=1614 D C35X1(U) K X2 M X2=X D C35X1("O") K X1 M X1=X
 D
...
C45S S X="" G:DG(DQ)=X C45F1 K DB
 D ^DGX5F2
C45F1 N X,X1,X2 S DIXR=1615 D C45X1(U) K X2 M X2=X D C45X1("O") K X1 M X1=X
 D
