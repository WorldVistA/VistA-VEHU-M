...
DE S DIE="^DGPT(D0,""M"",",DIC=DIE,DP=45.02,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^DGPT(D0,"M",DA,""))=""
 I $D(^(81)) S %Z=^(81) S %=$P(%Z,U,12) S:%]"" DE(1)=% S %=$P(%Z,U,13) S:%]"" DE(11)=% S %=$P(%Z,U,14) S:%]"" DE(21)=% S %=$P(%Z,U,15) S:%]"" DE(31)=%
 I $D(^(82)) S %Z=^(82) S %=$P(%Z,U,22) S:%]"" DE(4)=% S %=$P(%Z,U,23) S:%]"" DE(14)=% S %=$P(%Z,U,24) S:%]"" DE(24)=% S %=$P(%Z,U,25) S:%]"" DE(34)=%
 I $D(^(300)) S %Z=^(300) S %=$P(%Z,U,2) S:%]"" DE(43)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
BEGIN S DNM="DGX5FD11",DQ=1
1 S DW="81;12",DV="*P80'X",DU="",DIFLD=81.12,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C1^DGX5FD11",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C1S S X="" G:DG(DQ)=X C1F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C1F1 N X,X1,X2 S DIXR=1634 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW="82;22",DV="SX",DU="",DIFLD=82.22,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 ...
 G RE
X4 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,12) X
 Q
 ;
5 S DQ=6 ;@241
...
X7 I X K DGPTIT S DGNFLD="@250",Y="@8000",DGPTIT(X_$C(59)_"ICD9(")=""
 Q
8 S DQ=9 ;@250
9 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=9 D X9 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X9 I DGADD,$P(DGHOLD1,U,13)]"" S Y="@260"
 Q
10 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=10 D X10 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X10 S DGNFLD="@260"
 Q
11 S DW="81;13",DV="*P80'X",DU="",DIFLD=81.13,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX5FD11",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
C11S S X="" G:DG(DQ)=X C11F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C11F1 N X,X1,X2 S DIXR=1635 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW="82;23",DV="SX",DU="",DIFLD=82.23,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X14 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,13) X
 Q
 ;
15 S DQ=16 ;@251
...
C21S S X="" G:DG(DQ)=X C21F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C21F1 N X,X1,X2 S DIXR=1636 D C21X1(U) K X2 M X2=X D C21X1("O") K X1 M X1=X
 D
...
24 D:$D(DG)>9 F^DIE17,DE S DQ=24,DW="82;24",DV="SX",DU="",DIFLD=82.24,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X24 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,14) X
 Q
 ;
25 S DQ=26 ;@261
...
C31S S X="" G:DG(DQ)=X C31F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 X "N X S X=""DGRUDD01"" X ^%ZOSF(""TEST"") Q:'$T  N DG1 S DG1=+$P(^DGPT(DA(1),0),""^"",1) D:(DG1>0) ADGRU^DGRUDD01(DG1)"
C31F1 N X,X1,X2 S DIXR=1637 D C31X1(U) K X2 M X2=X D C31X1("O") K X1 M X1=X
 D
...
34 D:$D(DG)>9 F^DIE17,DE S DQ=34,DW="82;25",DV="SX",DU="",DIFLD=82.25,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DU="Y:Present on Admission;N:Not Present on Admission;U:Insufficient Docum to Present on Admission;W:Can't Determine if Present on Admission;"
 G RE
X34 I X]"",$G(DA),$G(DA(1)) K:'$$POA501^DGPTFUT1(X,DA(1),DA,81,15) X
 Q
 ;
35 S DQ=36 ;@271
...
X46 I '$D(DGBPC(3))!(DGDUP(3)) S Y="@8300"
 Q
47 D:$D(DG)>9 F^DIE17 G ^DGX5FD12
