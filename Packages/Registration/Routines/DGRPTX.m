DGRPTX ; GENERATED FROM 'DGRPT 10-10T REGISTRATION' INPUT TEMPLATE(#1879), FILE 2;06/26/22
 D DE G BEGIN
...
BEGIN S DNM="DGRPTX",DQ=1
 ...
 M DIEZAR=^DIE(1879,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1879,U="^"
...
C3F1 N X,X1,X2 S DIXR=848 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
...
C4F1 N X,X1,X2 S DIXR=636 D C4X1(U) K X2 M X2=X D C4X1("O") K X1 M X1=X
 I $G(X(1))]"" D
 . K ^DPT("APTYPE",X,DA)
...
C7F1 N X,X1,X2 S DIXR=251 D C7X1(U) K X2 M X2=X D C7X1("O") K X1 M X1=X
 D
...
C9F1 N X,X1,X2 S DIXR=253 D C9X1(U) K X2 M X2=X D C9X1("O") K X1 M X1=X
 D
...
C11F1 N X,X1,X2 S DIXR=254 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
C14S S X="" G:DG(DQ)=X C14F1 K DB
 D ^DGRPTX2
C14F1 N X,X1,X2 S DIXR=157 D C14X1(U) K X2 M X2=X D C14X1("O") K X1 M X1=X
 D
...
C14X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C14F2 S DIXR=252 D C14X2(U) K X2 M X2=X D C14X2("O") K X1 M X1=X
 D
...
C15S S X="" G:DG(DQ)=X C15F1 K DB
 D ^DGRPTX4
C15F1 N X,X1,X2 S DIXR=255 D C15X1(U) K X2 M X2=X D C15X1("O") K X1 M X1=X
 D
