DGPMX6 ; GENERATED FROM 'DGPM SPECIALTY TRANSFER' INPUT TEMPLATE(#1103), FILE 405;12/05/12
 D DE G BEGIN
...
BEGIN S DNM="DGPMX6",DQ=1
 ...
 M DIEZAR=^DIE(1103,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1103,U="^"
