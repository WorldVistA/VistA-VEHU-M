DGPTXC ; GENERATED FROM 'DG PTF CREATE PTF ENTRY' INPUT TEMPLATE(#855), FILE 45;08/27/14
 D DE G BEGIN
...
C1F1 S DIEZRXR(45,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1147,1148,1149,1150,1151,1152,1153,1154,1155,1156,1157,1158,1159,1160,1161 S DIEZRXR(45,DIXR)=""
 Q
X1 Q
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,D=0 K DE(1) ;50
 S DIFLD=50,DGO="^DGPTXC1",DC="40^45.02AI^M^",DV="45.02MNJ6,1X",DW="0;1",DOW="MOVEMENT RECORD",DLB=$P($$EZBLD^DIALOG(8042,DOW),": ") S:D DC=DC_D
