...
1 S DW="81;5",DV="*P80'X",DU="",DIFLD=81.05,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
X10 S DGNFLD="@190"
 Q
11 S DW="81;6",DV="*P80'X",DU="",DIFLD=81.06,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX58",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X20 S DGNFLD="@200"
 Q
21 S DW="81;7",DV="*P80'X",DU="",DIFLD=81.07,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C21^DGX58",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X30 S DGNFLD="@210"
 Q
31 S DW="81;8",DV="*P80'X",DU="",DIFLD=81.08,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C31^DGX58",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
...
X40 S DGNFLD="@220"
 Q
41 S DW="81;9",DV="*P80'X",DU="",DIFLD=81.09,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C41^DGX58",DE(DW,"INDEX")=1
 S DU="ICD9("
 G RE
