...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGMTXC7",DQ=1
1 S DW="0;7",DV="DX",DU="",DLB="DATE/TIME COMPLETED",DIFLD=.07
 S X=$S(DGMTDT=DT:"NOW",1:DGMTDT)
 S Y=X
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
X1 S %DT="TX",%DT(0)="-NOW" D ^%DT S X=Y K:Y<1 X I $D(X) D COM^DGMTDD
 Q
 ;
