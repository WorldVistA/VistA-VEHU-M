...
X13(DION) K X
 ...
 S X=$G(X(1))
 Q
14 N X,X1,X2 S DIXR=1587 D X14(U) K X2 M X2=X D X14("F") K X1 M X1=X
 D
...
X14(DION) K X
 ...
 S X=$G(X(1))
 Q
15 N X,X1,X2 S DIXR=1589 D X15(U) K X2 M X2=X D X15("F") K X1 M X1=X
 D
...
X15(DION) K X
 ...
 S X=$G(X(1))
 Q
16 N X,X1,X2 S DIXR=1590 D X16(U) K X2 M X2=X D X16("F") K X1 M X1=X
 D
...
X16(DION) K X
 ...
 S X=$G(X(1))
 Q
17 N X,X1,X2 S DIXR=1591 D X17(U) K X2 M X2=X D X17("F") K X1 M X1=X
 D
...
X17(DION) K X
 ...
 S X=$G(X(1))
 Q
18 N X,X1,X2 S DIXR=1592 D X18(U) K X2 M X2=X D X18("F") K X1 M X1=X
 D
...
X18(DION) K X
 ...
 S X=$G(X(1))
 Q
19 N X,X1,X2 S DIXR=1593 D X19(U) K X2 M X2=X D X19("F") K X1 M X1=X
 D
...
X19(DION) K X
 ...
 S X=$G(X(1))
 Q
20 N X,X1,X2 S DIXR=1594 D X20(U) K X2 M X2=X D X20("F") K X1 M X1=X
 D
...
X20(DION) K X
 ...
 S X=$G(X(1))
 Q
21 N X,X1,X2 S DIXR=1595 D X21(U) K X2 M X2=X D X21("F") K X1 M X1=X
 D
...
X21(DION) K X
 ...
 S X=$G(X(1))
 Q
22 N X,X1,X2 S DIXR=1596 D X22(U) K X2 M X2=X D X22("F") K X1 M X1=X
 D
...
X22(DION) K X
 ...
 S X=$G(X(1))
 Q
23 N X,X1,X2 S DIXR=1597 D X23(U) K X2 M X2=X D X23("F") K X1 M X1=X
 D
