...
BEGIN S DNM="DGX66",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="1;1",DV="*P80.1'X",DU="",DIFLD=24,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C1^DGX66",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C1F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1260,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X5 S DGNFLD="@250"
 Q
6 D:$D(DG)>9 F^DIE17,DE S DQ=6,DW="1;2",DV="*P80.1'X",DU="",DIFLD=25,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C6^DGX66",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C6F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1261,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X10 S DGNFLD="@260"
 Q
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW="1;3",DV="*P80.1'X",DU="",DIFLD=26,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C11^DGX66",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C11F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1262,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X15 S DGNFLD="@270"
 Q
16 D:$D(DG)>9 F^DIE17,DE S DQ=16,DW="1;4",DV="*P80.1'X",DU="",DIFLD=27,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C16^DGX66",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C16F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1263,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X20 S DGNFLD="@280"
 Q
21 D:$D(DG)>9 F^DIE17,DE S DQ=21,DW="1;5",DV="*P80.1'X",DU="",DIFLD=28,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C21^DGX66",DE(DW,"INDEX")=1
 S DU="ICD0("
 G RE
...
C21F1 S DIEZRXR(45.05,DIIENS)=$$OREF^DILF($NA(@$$CREF^DILF(DIE)))
 F DIXR=1264,1670 S DIEZRXR(45.05,DIXR)=""
 Q
...
X27 I '$D(DGBPC(8))!(DGDUP(8)) S Y="@899"
 Q
28 D:$D(DG)>9 F^DIE17,DE S DQ=28,DW="0;4",DV="NJ3,0",DU="",DIFLD=3,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 G RE
