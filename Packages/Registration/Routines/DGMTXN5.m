...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="DGMTXN5",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="2;5",DV="NJ9,2X",DU="",DLB="DEBTS",DIFLD=2.05
 G RE
X1 S:X["$" X=$P(X,"$",2) K:X'?.N.1".".2N!(X>999999)!(X<0) X D DEB^DGMTDD3:$D(X)
 Q
 ;
2 S DQ=3 ;@998
