ICD130P ;ALB/RFS - SEMI-ANNUAL DRG UPDATE; June 24, 2026@09:50
 ;;18.0;DRG Grouper;**130**;October 20, 2000;Build 1
 ;Per VA Directive 6402, this routine should not be modified.
 ;This routine will kick off routines needed for 
 ;FY 2026 Semi-annual updates to the DRG Grouper V43R1.
 ;
 ;
 Q
 ;
EN ; start update
 D PRES
 ;follwing lines not needed for V43R1 as there are no DRG changes 
