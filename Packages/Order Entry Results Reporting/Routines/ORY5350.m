ORY5350 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*535) ;FEB 15,2024 at 09:13
...
WARN(RTN,MSG,LINES) ;
 ...
 W !!,"--------------",MSG,DASH
 ;
 W !,RTN,?10,"[CPRSNGUIA.DOMAIN.EXT] -> [",$$NETNAME^OCXSEND,"] Line"
 ;
