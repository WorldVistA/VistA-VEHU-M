ORWU ;SLC/KCM - GENERAL UTILITIES FOR WINDOWS CALLS ;Jun 22, 2020@08:08:24
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,132,148,149,187,195,215,243,350,424,377,519**;Dec 17, 1997;Build 36
 ;
...
HOSPLOC(Y,FROM,DIR) ; Return a set of locations from HOSPITAL LOCATION
 ...
 . . S I=I+1,Y(I)=IEN_"^"_FROM
 Q
NEWPERS(ORY,ORFROM,ORDIR,ORKEY,ORDATE,ORVIZ,ORALL,ORPDMP) ; Return a set of names from the NEW PERSON file.
