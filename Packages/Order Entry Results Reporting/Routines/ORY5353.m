ORY5353 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*535) ;FEB 15,2024 at 09:13
...
ADDMULT(OCXCREF,OCXDD,OCXFLD) ;
 ...
 ;
 S OCXGREF=$$GETREF^ORY5352(+OCXFLD,.OCXDA,1)
...
DELMULT(OCXCREF,OCXDD) ;
 ...
 S DA=$G(DA(0)) K DA(0)
 S OCXGREF=$$GETREF^ORY5352(+OCXDD,.DA,1)
 ;
 D DIE^ORY5352(+OCXDD,OCXGREF,.01,"@",.DA,$L(DDPATH,",")-1)
