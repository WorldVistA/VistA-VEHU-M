ORY582ES ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*582) ;NOV 7,2025 at 12:05
...
S ;
 ...
 W !," Created: NOV 7,2025 at 12:05  at  CPRSNGUIB.DOMAIN.EXT"
 W !," Current Date: ",$$NOW^ORY5820,"  at  ",$$NETNAME^OCXSEND,!!
...
RUN ;
 ...
 ..;
 ..I OPCODE="KEY" D DOT S LOCAL="",D0=$$GETFILE^ORY5820(+$P(TEXT,U,1),$P(TEXT,U,2),.LOCAL) S QUIT=(D0=(-10)) Q
 ..I OPCODE="R" S REF="REMOTE("_$P(TEXT,":",1)_":"_D0_$P(TEXT,":",2,99)_")" Q
 ..I OPCODE="D",$D(REF) S @REF=$P(TEXT,U,1,999) K REF Q
 ..;
 ..I OPCODE="EOR" S QUIT=$$COMPARE^ORY5821(.LOCAL,.REMOTE) K LOCAL,REMOTE Q
 ...
 ..;
 ..W !,"Unknown OpCode: ",OPCODE,"  in: ",TEXT S QUIT=$$PAUSE^ORY5820 W !
 ;
 K ^TMP("OCXRULE",$J)
 ;
 I $D(^OCXS) D
