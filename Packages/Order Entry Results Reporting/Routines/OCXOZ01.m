OCXOZ01 ;SLC/RJS,CLA - Order Check Scan ;NOV 22,2024 at 16:47
...
TERM(OCXTERM,OCXLIST) ; Local Term Lookup
 ...
 ;
 ;TERM DATA;
 ;;SERUM CREATININE^60^173^CREATININE
 ;;SERUM UREA NITROGEN^60^174^UREA NITROGEN
 ;;SERUM UREA NITROGEN^60^1245^PROFILE 3 (ROUTINE)
 ;;DNR^101.43^79^Do Not Resuscitate
 ;;PROTHROMBIN TIME^101.43^547^PROTIME
 ;;THROMBOPLASTIN TIME PARTIAL^60^468^PTT
 ;;NPO^101.43^81^NPO
 ;;NPO^101.43^141^NPO
 ;;SERUM SPECIMEN^61^72^SERUM
 ;;ANGIOGRAM (PERIPHERAL)^101.43^3059^ANGIOGRAM,CATH - VISCERAL
 ;;WBC^60^1^WBC
 ;;ONE TIME MED^51.1^57^ONCE
 ;;EGFR^60^5179^GFR CALC CREATININE BL
 ;;EGFR^60^5180^GFR CALC CREATININE NON-BL
 ;;EGFR^60^5181^GFR CALC CREATININE
 ;;EGFR^60^5182^GFR CALC CYSTATIN
 ;;EGFR^60^5183^GFR CALC CREATININE FEM
 ;;PLASMA SPECIMEN^61^73^PLASMA
 ;1;
 ;
 Q
 ;
