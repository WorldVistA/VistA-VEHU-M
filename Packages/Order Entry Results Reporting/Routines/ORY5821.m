ORY5821 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*582) ;NOV 7,2025 at 12:05
...
MULT(CREF,OCXDD) ;
 ...
 ...S QUIT=$$LOADWORD^ORY5822(RREF,OCXDD,OCXFLD,OCXSUB)
 .;
...
DSPFLD(CREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 ;
 W:($D(@RREF@(OCXFLD,OCXSUB))) !,?(5+(($L(OCXDDPTH,",")+2)*4)),"(R) CPRSNGUIB.DOMAIN.EXT: ",@RREF@(OCXFLD,OCXSUB)
