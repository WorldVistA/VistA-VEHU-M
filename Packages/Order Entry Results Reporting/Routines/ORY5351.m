ORY5351 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*535) ;FEB 15,2024 at 09:13
...
MULT(CREF,OCXDD) ;
 ...
 ...S QUIT=$$LOADWORD^ORY5352(RREF,OCXDD,OCXFLD,OCXSUB)
 .;
...
DSPFLD(CREF,OCXDD,OCXFLD,OCXSUB) ;
 ...
 ;
 W:($D(@RREF@(OCXFLD,OCXSUB))) !,?(5+(($L(OCXDDPTH,",")+2)*4)),"(R) CPRSNGUIA.DOMAIN.EXT: ",@RREF@(OCXFLD,OCXSUB)
