OCXOZ0F ;SLC/RJS,CLA - Order Check Scan ;NOV 22,2024 at 16:47
...
CHK488 ; Look through the current environment for valid Event/Elements for this patient.
 ...
 ;
 ;      Local Extrinsic Functions
 ; FILE(DFN,145, ----> FILE DATA IN PATIENT ACTIVE DATA FILE  (Event/Element: CLOZAPINE ANC < 1.0)
 ;
...
CHK494 ; Look through the current environment for valid Event/Elements for this patient.
 ...
 ;
 ;      Local Extrinsic Functions
 ; FILE(DFN,146, ----> FILE DATA IN PATIENT ACTIVE DATA FILE  (Event/Element: CLOZAPINE ANC >= 1.0 & < 1.5)
 ;
 S OCXDF(130)=$P($$CLOZLABS^ORKLR(OCXDF(37),"",OCXDF(131)),"^",4),OCXOERR=$$FILE(DFN,146,"130") Q:OCXOERR 
 Q
 ;
