ORY5820 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*582) ;NOV 7,2025 at 12:05
...
WARN(RTN,MSG,LINES) ;
 ...
 W !!,"--------------",MSG,DASH
 ;
 W !,RTN,?10,"[CPRSNGUIB.DOMAIN.EXT] -> [",$$NETNAME^OCXSEND,"] Line"
 ;
