ORWPCE ;SLC/JM,REV - Wrap Calls to PCE and AICS ;04/26/2021
 ;;3.0;ORDER ENTRY/RESULTS REPORTING;**10,85,116,173,190,195,215,243,295,280,306,361,385,398,377,476,539**;Dec 17, 1997;Build 41
 ;
...
I10IMPX Q
 ;
NOTASK() ;
 I '$$PATCH^XPDUTL("PX*1.0*211") Q 0
 Q +$$GET^XPAR("ALL","OR PCE TASKING UPDATES OFF",1,"I")
 ;
