ORY5823 ;SLC/RJS,CLA - OCX PACKAGE RULE TRANSPORT ROUTINE (Delete after Install of OR*3*582) ;NOV 7,2025 at 12:05
...
ADDMULT(OCXCREF,OCXDD,OCXFLD) ;
 ...
 ;
 S OCXGREF=$$GETREF^ORY5822(+OCXFLD,.OCXDA,1)
...
DELMULT(OCXCREF,OCXDD) ;
 ...
 S DA=$G(DA(0)) K DA(0)
 S OCXGREF=$$GETREF^ORY5822(+OCXDD,.DA,1)
 ;
 D DIE^ORY5822(+OCXDD,OCXGREF,.01,"@",.DA,$L(DDPATH,",")-1)
