...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBDXI52",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;3",DV="*P357.6'",DU="",DLB="TYPE OF DATA",DIFLD=.03
 S DU="IBE(357.6,"
 S X=$G(IBRTN)
 S Y=X
