...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBDXI226",DQ=1
1 S DW="0;5",DV="NJ1,0XR",DU="",DLB="Select Subcolumn's Data",DIFLD=.05
 G RE
X1 K:'$$OKPIECE^IBDFU5($P($G(^IBE(357.2,D0,0)),U,11),X) X
 Q
 ;
...
X3 N IBDFFLG D SCDEL^IBDF9A3 I $D(IBDFFLG) S Y="@99"
 Q
4 D:$D(DG)>9 F^DIE17 G ^IBDXI227
