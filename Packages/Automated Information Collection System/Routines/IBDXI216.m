...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBDXI216",DQ=1
1 S DW="0;1",DV="MRNJ1,0X",DU="",DLB="SUBCOLUMN NUMBER",DIFLD=.01
 S DE(DW)="C1^IBDXI216"
 G RE:'D S DQ=2 G 2
