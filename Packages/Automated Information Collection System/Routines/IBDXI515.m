...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBDXI515",DQ=1
1 S DW="0;9",DV="NJ1,0X",DU="",DLB="Select Subfield's Data",DIFLD=.09
 G RE
X1 K:'$$OKPIECE^IBDFU5(+$P($G(^IBE(357.5,D0,0)),U,3),X) X
 Q
 ;
