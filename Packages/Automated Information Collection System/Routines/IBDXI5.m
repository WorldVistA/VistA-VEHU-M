IBDXI5 ; GENERATED FROM 'IBDF EDIT DATA FIELD' INPUT TEMPLATE(#1527), FILE 357.5;05/04/04
 D DE G BEGIN
...
BEGIN S DNM="IBDXI5",DQ=1
 ...
 M DIEZAR=^DIE(1527,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1527,U="^"
...
X26 S (IBY,IBX)=1
 Q
27 S D=0 K DE(1) ;2
 S DIFLD=2,DGO="^IBDXI51",DC="8^357.52I^2^",DV="357.52MF",DW="0;1",DOW="SUBFIELD LABEL",DLB="Select "_DOW S:D DC=DC_D
