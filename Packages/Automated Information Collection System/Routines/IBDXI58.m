...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBDXI58",DQ=1
1 S DW="0;14",DV="NJ3,0R",DU="",DLB="HOW MANY CHARACTERS ACROSS SHOULD THE TEXT LINES BE?",DIFLD=.14
 G RE
X1 K:+X'=X!(X>200)!(X<0)!(X?.E1"."1N.N) X
 Q
 ;
