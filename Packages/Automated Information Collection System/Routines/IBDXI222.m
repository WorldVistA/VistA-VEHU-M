...
SET N DIR S DIR(0)="SV"_$E("o",$D(DB(DQ)))_U_DU,DIR("V")=1
 ...
 Q
BEGIN S DNM="IBDXI222",DQ=1
1 S DW="0;9",DV="*P357.98'",DU="",DLB="DATA QUALIFIER",DIFLD=.09
 S DU="IBD(357.98,"
 G RE
X1 S DIC("S")="I $$DQGOOD^IBDFU9($P($G(^IBE(357.2,DA(1),0)),""^"",11),Y)" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
...
X4 I $P(^IBE(357.2,D0,2,D1,0),U,2)'="" S Y="@10"
 Q
5 D:$D(DG)>9 F^DIE17 G ^IBDXI223
