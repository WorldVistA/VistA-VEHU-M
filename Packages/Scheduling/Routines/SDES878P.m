SDES878P ;ALB/MGD - SD*5.3*878 Post Init Routine ; Apr 03, 2024
...
FIND ;FIND THE IEN FOR "VS GUI NATIONAL"
 ...
 Q
VERSION ;SET THE NEW VERSION UPDATE IN SDEC SETTING FILE #409.98 TO 1.7.56
 S DA=SDECDA,DIE=409.98,DR="2///1.7.56;3///"_DT D ^DIE  ;update VS GUI NATIONAL
 K DIE,DR,DA
 S SDECDA1=0,SDECDA1=$O(^SDEC(409.98,"B","VS GUI LOCAL",SDECDA1)) Q:$G(SDECDA1)=""    ;get DA for the VS GUI LOCAL
 S DA=SDECDA1,DIE=409.98,DR="2///1.7.56;3///"_DT D ^DIE  ;update VS GUI LOCAL
 K DIE,DR,DA
 Q
 ;
