SDECVVS ;ALB/RJT,TAW SDEC AND VIDEO VISIT SERVICE (VVS) INTEGRATION ;Jan 7, 2022
 ;;5.3;Scheduling;**781,784,785,788,790,792,800,801,804,805**;;Build 9
...
GETSYSTEMINFO(RETURN,CLINICIEN) ;GET SYSTEM INFO NEED TO CALL MAKE VIDEO VISIT SERVICE (VVS) CALL
 ...
 N OFFSETDST,SYSTEMTIMEZONEE,TIMEFRAMEIEN,TIMEFRAMEARY,POP,X
 S POP=0,(OFFSET,OFFSETDST)=""
 ...
 S TIMEZONEEXECPT=$$GET1^DIQ(4,CLINICSITECODE,802)
 I TIMEZONEEXECPT'=0 S TIMEZONEEXECPT=1
 F X=1:1:3 D  Q:POP
