...
QUERY(JSONRETURN,SDCONTEXT,SDINPUT) ;
 N ERRORS,FLTRORIGDATE,FLTRPIDDATE,STARTDT,ENDDDT,REQUESTS,NEWLASTREC,TOTALRECORDS,LASTREC,SDDUZ
 ...
 .S NEWLASTREC=$$BUILDBYLASTREC($G(SDINPUT("LAST RECORD")),$G(SDINPUT("MAX NUMBER OF RECORDS")),.REQUESTS,SDDUZ)
