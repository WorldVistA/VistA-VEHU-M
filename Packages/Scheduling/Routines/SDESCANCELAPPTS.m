SDESCANCELAPPTS ;ALB/BLB,MGD,BWF - SCHEDULING CANCEL APPOINTMENTS RPC ;Jan 17, 2023
 ;;5.3;Scheduling;**818,820,828,835**;Aug 13, 1993;Build 4
...
CANCELAPPTS(JSONRETURN,APPTIEN,CLINICIEN,DFN,CANBYCLINORPAT,CANCELREASONIEN,NOTE,CANCELHASH,EAS) ;
 ...
 N RECALLREQIEN,RECALLREQLINK,RESOURCE,OLDRECALLPTR
 ;
 ...
 .D REOPEN^SDESRECALLREQ(.RETURN,$G(APPTIEN),,,CANBYCLINORPAT)
 .S RECALLREQIEN=$P(RETURN,U)
 .S RECALLREQLINK=$P(RETURN,U,2)
 .S OLDRECALLPTR=$P(RETURN,U,3)
 .; update contact main sequence upon re-open
