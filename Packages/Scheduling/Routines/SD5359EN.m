SD5359EN ;ALB/REW - SD*5.3*59 Environment Checker ; 7 JUN 1996
 ;;5.3;Scheduling;**59**;AUG 13, 1993
EN ;entry point
 W !,"SD*5.3*59 Installation Requirements:",!
 IF $D(XPDABORT)#2 W !!?4,"*** Warning: Because variable XPDABORT exists, SD*5.3*59 will not install."
...
PKGCHK ;check package file entries
 ...
 W:$D(XPDABORT) !,">>> SD*5.3*59 Aborted in Environment Checker"
