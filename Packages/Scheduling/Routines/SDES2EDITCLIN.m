SDES2EDITCLIN ;ALB/BWF,MGD/BLB,BWF - SDES2 EDIT CLINIC ;JAN 02, 2024
 ;;5.3;Scheduling;**853,857,864,866,871,885**;Aug 13, 1993;Build 5
...
EDITCLINIC(RESULTS,SDCONTEXT,SDCLINIC) ;
 N ERRORS,SDIEN,CLINRETURN,FILEDATA,VRES
 ...
 I $D(SDCLINIC("VETERAN SELF-CANCEL")) D 
 .I $G(SDCLINIC("VETERAN SELF-CANCEL"))="@" S FILEDATA("VETERAN SELF-CANCEL")="@" Q
 .D VALBOOLEAN^SDES2VALUTIL(.VRES,.ERRORS,44,63,$G(SDCLINIC("VETERAN SELF-CANCEL")),,1,,571) I VRES S FILEDATA("VETERAN SELF-CANCEL")=$G(VRES(44,63,"I"))
 ; Credit AMIS
