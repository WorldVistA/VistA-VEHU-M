SDES2EDITCLIN ;ALB/BWF - SDES2 EDIT CLINIC ;JULY 10, 2023
 ...
 ; SDCILNIC("INCLUDE ON FILE ROOM LISTS")           Y/N for (YES/NO)
...
EDITCLINIC(RESULTS,SDCONTEXT,SDCLINIC) ;
 ...
 I $D(SDCLINIC("REQUIRE X-RAY")) D VALXRAY^SDES2VAL44(.ERRORS,SDCLINIC("REQUIRE X-RAY"),.FILEDATA)
