...
PRECANLIST(SDRES,SDCLNIEN,SDFULLPART,SDESBEGDTTM,SDESENDDTTM,SDEAS) ;
 ...
 I $D(ERRORS) S ERRORS("PreCancellationList",1)="" D BUILDJSON^SDESBUILDJSON(.SDCLNJSON,.ERRORS) Q
...
BLDPRECANLIST(APPTDATA,FULLPART,CLINICIEN,STARTDTTM,ENDDTTM) ;
 ...
 D GETAPPOINTMENTS^SDESGETAPPTWRAP2(.APPTDATA,CLINICIEN,STARTDTTM,ENDDTTM,1)
 Q
