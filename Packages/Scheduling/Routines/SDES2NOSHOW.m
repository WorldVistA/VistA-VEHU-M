SDES2NOSHOW ;ALB/BLB,BLB,JAS,MGD,BLB,LAB,TJB,JHC,LAB,MCB,AGW,JDJ - SDES2 NO-SHOW ;JUN 16,2026
 ;;5.3;Scheduling;**871,875,889,915,919,927,909,929,943,944,949**;Aug 13, 1993;Build 4
...
NOSHOW(JSON,SDCONTEXT,NOSHOW) ;
 ...
 N %,%L,D,D0,DG,DIG,DI,DIC,DIH,DIU,DIV,DIW,I,PXKOE,SDCNT,ANS,CNT,D1,D2,DA,HLN,HLPARAM,SUB4,X1,ZMID,ERR,ERRPTR,FS,HL7XMIT,HLHDR,HLSAN,HLTYPE,HLX
 ;
