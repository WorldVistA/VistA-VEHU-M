SDXACSE9 ; ;06/24/93
 D DE G BEGIN
DE S DIE="^SDV(D0,""CS"",",DIC=DIE,DP=409.51,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$N(^SDV(D0,"CS",DA,-1))<0
 I $D(^("PR")) S %Z=^("PR") S %=$P(%Z,U,4) S:%]"" DE(1)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="SDXACSE9",DQ=1
1 S DW="PR;4",DV="*P409.71'X",DU="",DLB="PROCEDURE 4",DIFLD=24
 S DU="SD(409.71,"
 S X=$P(SDCPT(SDJ),U,6)
 S Y=X
...
X2 I $P(SDCPT(SDJ),U,7)']"" S Y="@99"
 Q
3 D:$D(DG)>9 F^DIE17 G ^SDXACSE10
