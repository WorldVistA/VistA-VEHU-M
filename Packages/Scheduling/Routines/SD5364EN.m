SD5364EN ;ALB/REW - SD*5.3*64 Environment Checker ; 7 JUN 1996
 ;;5.3;Scheduling;**64**;AUG 13, 1993
EN ;entry point
 W !,"SD*5.3*64 Installation Requirements:",!
 IF $D(XPDABORT)#2 W !!?4,"*** Warning: Because variable XPDABORT exists, SD*5.3*64 will not install."
...
PKGCHK ;check package file entries
 ...
 W:$D(XPDABORT) !,">>> SD*5.3*64 Aborted in Environment Checker"
 W:'$D(XPDABORT) !!,">>> Environment is Ok"
 IF $G(XPDENV) W !,"... continuing with installation"
 Q
 ;
PACKAGE ;
 ;;SD*5.3*44
