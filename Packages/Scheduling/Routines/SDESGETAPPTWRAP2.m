SDESGETAPPTWRAP2 ;ALB/RRM - RPC WRAPPER FOR VIEWING AN APPOINTMENT ;APR 26, 2022@13:47
...
GETAPPTBYPATDFN(RETURNJSON,DFN,SDBEGDATE,SDENDDATE,SDEAS) ;Called from the RPC: SDES GET APPTS BY PATIENT DFN
 ...
 ;
 I $O(RETURNERROR("Error",""))'="" D BUILDJSON(.RETURNERROR,.RETURNJSON) Q  ;do not continue, errors detected
 ;
