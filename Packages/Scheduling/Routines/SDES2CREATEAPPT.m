SDES2CREATEAPPT  ;ALB/BLB,LAB/BLB,ANU,TJB,LAB,TJB,ANU,BLB,TJB,BLB,JAS,MCB,JDJ,JAS,JAS - SDES2 CREATE APPOINTMENT ; MAY 7, 2025
 ;;5.3;Scheduling;**866,869,873,875,877,880,881,886,893,895,898,901,905,907**;Aug 13, 1993;Build 5
...
CREATE(JSON,SDCONTEXT,APPOINTMENT) ;
 ...
 ;
 D CREATE40984(.ERRORS,.DELETE,.APPTIEN,.APPOINTMENT,$P($G(APPOINTMENT("REQUEST TYPE")),"|"),$P($G(APPOINTMENT("REQUEST TYPE")),"|",2),$G(SDCONTEXT("USER DUZ")),$E($G(APPOINTMENT("NOTE")),1,150),$G(SDCONTEXT("ACHERON AUDIT ID")))
...
CREATE40984(ERRORS,DELETE,APPTIEN,APPOINTMENT,REQUESTTYPE,REQUESTIEN,USERID,NOTE,EAS) ;
 ...
 .S FDA(409.847,"+1,"_APPTIEN_",",1)=$S(USERID:USERID,1:DUZ)
