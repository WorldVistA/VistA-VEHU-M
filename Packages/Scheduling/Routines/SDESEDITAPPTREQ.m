SDESEDITAPPTREQ ;ALB/BLB,MGD,LAB - VISTA SCHEDULING RPCS; Feb 17,2023:12:00
 ;;5.3;Scheduling;**823,826,837**;Aug 13, 1993;Build 4
...
BUILDMRTCLINKS(REQUEST,REQUESTIEN) ; called from SDESCREATEAPPT after appt is made from mrtc child
 N FDA,FDAERR,SUBIEN
 S SUBIEN=$O(^SDEC(409.85,REQUESTIEN,2,"B",REQUEST("MRTC","CHILD REQUEST"),0))
 S FDA(409.852,SUBIEN_","_REQUESTIEN_",",.02)=$G(REQUEST("MRTC","MRTC APPOINTMENT"))
...
BUILDMRTCPID(REQUEST,REQUESTIEN) ; called from SDESCREATEAPPT after appt is made from mrtc child
 N FDA,FDAERR
 Q:$O(^SDEC(409.85,REQUESTIEN,5,"B",REQUEST("MRTC","PATIENT INDICATED DATE"),0)) 
