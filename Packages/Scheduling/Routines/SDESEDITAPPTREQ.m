SDESEDITAPPTREQ ;ALB/BLB,MGD,TJB,BWF,TJB,BLB,LAB,JAS,JAS - SCHEDULING EDIT APPT REQUEST; FEB 16,2024@15:05
 ;;5.3;Scheduling;**823,826,837,845,846,847,864,871,873**;Aug 13, 1993;Build 10
...
VALIDATE(REQUEST,ERRORS) ;
 ...
 ;
 I $L($G(REQUEST("SERVICE CONNECTED"))) S ISSERVCONNVALID=$$VALIDATESERVCONN^SDESCREATEAPPREQ(.ERRORS,$G(REQUEST("SERVICE CONNECTED")),$G(REQUEST("SERVICE CONNECTED PERCENTAGE")))
 ;
