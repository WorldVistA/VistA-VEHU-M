SDESADDRG ;ALB/ANU - VISTA SCHEDULING RPCS - ROUTINE ADD RESOURCE GROUP ;Sept 9, 2022@14:21
...
RGADDEDIT(RETURNJSON,SDRGIEN,SDRGNAME) ;ADD/EDIT RESOURCE GROUP
 ;
 ; Input:
 ;    SRRGIEN        [Optional] = Resoruce Group IEN
 ;    SRRGNAME       [Required] = Resource Group Name
 ;
 ; Output:
