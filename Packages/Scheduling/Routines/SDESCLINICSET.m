SDESCLINICSET ;ALB/TAW,LAB,MGD - CLINIC CREATE AND UPDATE ;Sept 06, 2022
 ;;5.3;Scheduling;**799,805,820,824,825**;Aug 13, 1993;Build 2
...
VALIDATE(EDIT) ;
 ...
 ;
 S PRIAMIS=$G(P42)
 I PRIAMIS="",'EDIT,+SDSTOPCODE=0 S POP=1 D ERRLOG(272)
 I $L(PRIAMIS) D
 . I +PRIAMIS=0 S POP=1 D ERRLOG(270) Q
 . I +PRIAMIS=900 S POP=1 D ERRLOG(273) Q
 . I +PRIAMIS,'$D(^DIC(40.7,"C",+PRIAMIS)) S POP=1 D ERRLOG(270) Q
 . ; AMIS Stop Code has priority over passed in Stop Code
 . N STOPIEN
 . S STOPIEN=$$AMISTOSTOPCODE^SDESUTIL(PRIAMIS)
 . I $$RESCHKFAILED^SDESUTIL(STOPIEN,"P") D ERRLOG(287) Q
 . S SDSTOPCODE=STOPIEN
 ;
 S CREDITAMIS=$G(P43)
 I $L(CREDITAMIS) D
 . I +CREDITAMIS=0 S POP=1 D ERRLOG(271) Q
 . I +CREDITAMIS=900 S POP=1 D ERRLOG(273) Q
 . I +CREDITAMIS,('$D(^DIC(40.7,"C",+CREDITAMIS))) S POP=1 D ERRLOG(271) Q
 . ; AMIS Credit Stop Code has priority over passed in Credit Stop Code
 . N STOPIEN
 . S STOPIEN=$$AMISTOSTOPCODE^SDESUTIL(CREDITAMIS)
 . I $$RESCHKFAILED^SDESUTIL(STOPIEN,"S") D ERRLOG(288) Q
 . S SDCREDITSTOP=STOPIEN
 Q
 ;
