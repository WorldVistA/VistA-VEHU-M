SDESCANAPPT2 ;ALB/DJS,LAB,MGD,BWF,BLB,ANU - SCHEDULING CANCEL APPOINTMENTS RPC ;OCT 25, 2023
 ;;5.3;Scheduling;**838,842,844,845,847,851,864**;Aug 13, 1993;Build 15
...
CANAPPT2(JSONRETURN,APPTIEN,CLINICIEN,DFN,CANBYCLINORPAT,CANCELREASON,NOTE,CANCELHASH,EAS,NEWPID) ;
 ...
 D CANCEL44(.ERRORS,CLINICIEN,APPTSTARTTIME,DFN,APPTIEN,WALKIN)
 D CANCEL2(.ERRORS,DFN,APPTSTARTTIME,CANBYCLINORPAT,CANCELREASON,$G(NOTE),APPTIEN,CLINICIEN)
 I $D(ERRORS) S ERRORS("Appointment",1)="" M RETURN=ERRORS D BUILDJSON(.JSONRETURN,.RETURN) Q
 ;
...
CANCEL40984(ERRORS,APPTIEN,CANCELREASON,CANBYCLINORPAT,WALKIN,EAS) ;
 ...
 Q
 ;
CANCEL44(ERRORS,CLINICIEN,APPTSTARTTIME,DFN,APPTIEN,WALKIN) ;
...
CANCEL2(ERRORS,DFN,APPTSTARTTIME,CANBYCLINORPAT,CANCELREASON,NOTE,APPTIEN,CLINICIEN) ;
 ...
 L +^DPT(DFN):3 I '$T D ERRLOG^SDESJSON(.ERRORS,187),CLEAN40984(APPTIEN),CLEAN44003(DFN,CLINICIEN,APPTSTARTTIME) Q
 D FILE^DIE("","FDA298","ERR298") K FDA298
 L -^DPT(DFN)
 I $D(ERR298) D ERRLOG^SDESJSON(.ERRORS,191),CLEAN40984(APPTIEN),CLEAN44003(DFN,CLINICIEN,APPTSTARTTIME) Q
 Q
 ;
...
VALIDATENEWPID(ERRORS,PID,CANBYCLINORPAT,APPTIEN) ;
 ...
 .I $P($$GET1^DIQ(409.84,APPTIEN,.22,"I"),";",2)="GMR(123," D ERRLOG^SDESJSON(.ERRORS,450) Q
 Q
 ;
