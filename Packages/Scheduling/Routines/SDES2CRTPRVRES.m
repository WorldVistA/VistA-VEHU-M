SDES2CRTPRVRES ;ALB/LAB,TAW,RN - VISTA SCHEDULING SDES2 CREATE PROVIDER RESOURCE ;JULY 17,2026
 ;;5.3;Scheduling;**869,871,909,951**;Aug 13, 1993;Build 5
...
CREATERESOURCE(RETURN,ERRORS,SDCONTEXT,SDPARAM,RESOURCE) ;create the provider resource
 ...
 S FILEDATA(409.831,"+1,",100)=$G(SDCONTEXT("ACHERON AUDIT ID"))
 S FILEDATA(409.831,"+1,",101)=$G(XWB(2,"RPC"))
 S FILEDATA(409.831,"+1,",102)=$G(SDCONTEXT("APPID"))
