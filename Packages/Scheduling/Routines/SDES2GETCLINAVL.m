SDES2GETCLINAVL ;ALB/BWF,TJB,JV,JDJ,JHC - SDES2 GET CLINIC AVAIL BY SVC; MAY 29,2026
 ;;5.3;Scheduling;**880,887,898,901,902,909,947**;Aug 13, 1993;Build 3
...
CLINICAVAIL(RESULT,SDCONTEXT,SDINPUT) ;
 N CLINLIST,ERRORS,CLINAVAIL,STARTDTFM,ENDDTFM,PRIMARYSTOP,SECSTOPLIST,NUMBERRET,RESULTDATA,I
...
MATCHCLIN(CLINLIST,STCODE,SDINPUT) ;
 ...
 .I '$D(CREDSTOPIENS) D  Q
 ..I $D(^SC("AST",STOPIEN,CLINIEN)) S @CLINLIST@(CLINIEN)="" Q
