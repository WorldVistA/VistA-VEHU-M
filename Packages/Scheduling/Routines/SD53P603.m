...
SETHWSC ;Add/update records in 18.02, 18.12, 18.13
 ...
 SET SDSVRNM1="PCMMR"
 SET SDADRS="10.208.148.63"
 SET SDADRS="vaww-pcmm.cc.med.va.gov"
 SET SDPORT=80
 ...
 SET SDADRS="vaww-sqa-x.ciss.cc.med.va.gov"
 SET SDADRS="10.208.148.71" ; remove this line when load balancer is back online <<<<<<<<<<<<<<<
 SET SDPORT=10100
