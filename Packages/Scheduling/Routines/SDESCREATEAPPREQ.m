SDESCREATEAPPREQ  ;ALB/BLB - VISTA SCHEDULING RPCS; May 31, 2022@11:20
...
CREATEREQUEST(JSONRETURN,REQUEST) ;
 N REQUESTIEN,ERRORS,RETURN,ISDFNVALID,ISDATETIMEVALID,ISMODALINVALID,ISEASVALID,INSTITUTIONIEN,ISCLINSTOPVALID,ISREQUESTBYVALID,ISPROVIDERVALID,ISMODALITYVALID
 N ISPIDVALID,ISPRIGROUPVALID,ISREQTYPEVALID,ISPRIORITYVALID,ISSERVCONNVALID,ISAPPTTYPEVALID,ISPATSTATVALID,ISDATEPREFVALID,ISMTRCDATAVALID,ISCPRSDATAVALID
 ;
...
VALIDATE(REQUEST,ERRORS) ;
 ...
 ;
 I $L($G(REQUEST("APPOINTMENT TYPE IEN"))) S ISAPPTTYPEVALID=$$VALIDATEAPPTTYPE(.ERRORS,$G(REQUEST("APPOINTMENT TYPE IEN")))
 ;
...
VALIDATEPRIORITY(ERRORS,PRIORITY) ;
 ...
 S REQUEST("PRIORITY")=$S(PRIORITY="ASAP":"A",REQUESTEDBY="FUTURE":"F",1:"")
 Q 1
 ;
...
VALIDATESERVCONN(ERRORS,SERVCONN,SERVCONNPERC) ;
 ...
 Q 1
 ;
VALIDATEAPPTTYPE(ERRORS,APPTTYPEIEN) ;
 I APPTTYPEIEN'="",'$D(^SD(409.1,APPTTYPEIEN,0)) D ERRLOG^SDESJSON(.ERRORS,180) Q 0
 Q 1
 ;
