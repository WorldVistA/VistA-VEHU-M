SDES883P ;ALB/MGD - FY25 - Stop Code Updates; Aug 14, 2024@11:23
 ;;5.3;Scheduling;**883**;AUG 13, 1993;Build 3
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 ; Post-init routine updating stop codes in CLINIC STOP file (#40.7)
 ; for FY25 updates - effective 10/01/2024.
 ;
 Q
 ;
POST     ; Update stop codes in Clinic Stop file 40.7
 ;
 D BMES^XPDUTL("SD*5.3*883 Post-Install starts...")
 ...
 D MES^XPDUTL("SD*5.3*883 Post-Install is complete."),MES^XPDUTL("")
...
ADD      ; Add new stop code
 ...
 D BMES^XPDUTL("    [NOTE: These Stop Codes CANNOT be used UNTIL 10/01/2024]")
 ;
...
REACT    ; Reactivate stop code
 ...
 . . . . K SDINTERR
 . . . I '$D(SDINTERR) D
 . . . . D BMES^XPDUTL("     >> Reactivated: "_+SDCODE_"   "_SDNM_" as of 10/01/2024")
 ;
...
NEW      ; codes to add - ;;stop code name^code #^restriction type^restriction date^CDR
 ;;SYNCH CHAT BY TEXT^732^S^10/1/2024
 ;;QUIT
 ;
...
CHG      ; Code name changes - ;;code name^code #^^new code name
 ;;GERI PROB CONSULT CLINIC^318^^GERIATRIC EVALUATIONS
 ;;QUIT
 ;
