SDES2CRTAPREQ ;ALB/BWF,JAS,TJB,JAS,BWF,JDJ - CREATE APPOINTMENT REQUEST ; JAN 25, 2025
 ;;5.3;Scheduling;**869,871,875,877,893,895,897,899**;Aug 13, 1993;Build 2
...
BUILDER(REQUEST,INSTITUTIONIEN,ORIGUSER,EAS) ;
 ...
 S FDA(409.85,"+1,",23)="O"
 S FDA(409.85,"+1,",25)=$$CTRL^XMXUTIL1($G(REQUEST("REQUEST COMMENT")))
 ...
 . S FDA(409.8527,"+1,"_REQUESTIEN_",",1)=ORIGUSER
 . S FDA(409.8527,"+1,"_REQUESTIEN_",",2)=$$CTRL^XMXUTIL1($G(REQUEST("REQUEST COMMENT")))
