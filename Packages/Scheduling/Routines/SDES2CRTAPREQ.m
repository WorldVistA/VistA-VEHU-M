SDES2CRTAPREQ ;ALB/BWF,JAS,TJB,JAS,BWF,JDJ - CREATE APPOINTMENT REQUEST ; JAN 25, 2025
 ;;5.3;Scheduling;**869,871,875,877,893,895,897,899,901**;Aug 13, 1993;Build 7
...
VALIDATE(REQUEST,FILEDATA,INSTITUTIONIEN,ERRORS) ;
 ...
 ;
 S FILEDATA("REQUEST COMMENT")=$$CTRL^XMXUTIL1($G(REQUEST("REQUEST COMMENT"))) ;strip any control characters
