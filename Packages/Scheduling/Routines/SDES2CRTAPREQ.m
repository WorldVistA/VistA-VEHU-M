SDES2CRTAPREQ ;ALB/BWF,JAS - CREATE APPOINTMENT REQUEST; JAN 29 2024
...
VALIDATE(REQUEST,FILEDATA,INSTITUTIONIEN,ERRORS) ;
 ...
 ;
 D VALFIELD^SDES2VALUTIL(.VALRETURN,.ERRORS,409.85,8.7,$G(REQUEST("APPOINTMENT TYPE")),1,,181,180)
...
VALIDATEMRTCDATA(ERRORS,REQUEST,FILEDATA) ;
 ...
 I VRET S FILEDATA("MRTC","NEEDED")=$G(VRET(409.85,41,"I"))
 ; if this is not an mrtc, check for other mrtc fields and quit
 I FILEDATA("MRTC","NEEDED")=0 D  Q
