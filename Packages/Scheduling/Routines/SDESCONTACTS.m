...
ADDUPD(RESULT,CONTACT) ;
 ...
 D VALIDATECLINIC(.ERRORS,CLINIC)
 ...
 ..Q:$$GET1^DIQ(403.5,REQUESTIEN,4.5,"I")'=CLINIC
 ..S SDREQPTR40986=REQUESTIEN_";"_"SD(403.5,"
 ..S PREFDATE=$$GET1^DIQ(403.5,REQUESTIEN,5.5,"I")
...
GETCONTIEN(ERRORS,REQIEN,REQTYPE)  ;
 ...
 S CONTACTIEN=$O(^SDEC(409.86,"REQPTR",FULLREF,9999),-1)
 I 'CONTACTIEN D  Q ""
...
DISPMULT(RESULT,CONTACTIEN,CLINIC) ;
 ...
 .I $D(CERR) K CERR Q
 .S CCNT=CCNT+1
 .S CONTDATE=$G(CONTDATA(409.863,CIENS,1,"I"))
 ...
 .S CONTACTS("ContactAttempts",CCNT,"EnteredBy")=$G(CONTDATA(409.863,CIENS,5,"E"))
