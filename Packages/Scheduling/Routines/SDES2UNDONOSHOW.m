SDES2UNDONOSHOW ;ALB/BLB,LAB,TJB,JHC,LAB,AGW,MCB - SDES2 UNDO NO-SHOW ; JUNE 02,2026
 ;;5.3;Scheduling;**871,875,927,909,929,944,947**;Aug 13, 1993;Build 3
...
UNDONOSHOW(JSON,SDCONTEXT,NOSHOW) ;
 ...
 I $D(ERRORS) S ERRORS("UndoNoShow",1)="" S ERRORS("Appointment",1)="" D BUILDJSON^SDESBUILDJSON(.JSON,.ERRORS) Q
 ...
 I $D(ERRORS) M ERRORS("Appointment",1)=RETURN("Appointment",1) D BUILDJSON^SDES2JSON(.JSON,.ERRORS) Q
