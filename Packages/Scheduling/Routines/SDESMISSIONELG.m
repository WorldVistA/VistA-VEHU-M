SDESMISSIONELG ;ALB/ANU,MGD,LAB,BWF - VISTA SCHEDULING RPCS GET MISSION ELIGIBILITY ; MAR 30,2023
 ;;5.3;Scheduling;**814,815,818,820,826,835,842,844**;Aug 13, 1993;Build 12
...
GETMISSIONELG(ELGRETURN,APPTREQIEN,PID,APPTREQTYP,SDEAS,APPTDATE,SDCLNIEN,FILEENTRYDATE) ; Get Mission Eligibility
 ...
 N SDPRIM,SDSTOPCDIEN,SDI,REQDATENET,REQENDDTNET,PREQENDDT,APPTRETURN,NUMBER
 ...
 I 'HASVLDERRORS S HASFIELDS=$$GETMSNELG(.ELGFIELDSARRAY,REQDATE,PREQENDDT,PIDDATE,.SDAPPTAVAIL,APPTDATE,REQENDDT,SDCLNIEN)
...
VALIDATE(ERRORS,APPTREQIEN,PID,APPTREQTYP,SDEAS,SDAPPTAVAIL,APPTDATE,APPTRETURN,SDCLNIEN,NUMBER,FILEENTRYDATE) ; Validate Appointment Request IEN, Request Date, PID Date
 ...
 I PIDDATE>PREQENDDT S ERRORFLAG=1 D ERRLOG^SDESJSON(.ERRORS,432) Q $D(ERRORFLAG)
 ;
 S SDEAS=$G(SDEAS,"")
...
GETAVAIL(RETURN,CLINLIST,START,END,NUMBER) ;
 ...
 Q
 ;
GETMSNELG(ELGARRAY,REQDATE,PREQENDDT,PIDDATE,SDAPPTAVAIL,APPTDATE,REQENDDT,SDCLNIEN) ; GET Eligibility
 ...
 .I (SDAPPTAVAIL="") D
 ..I ((PIDDATE>=REQDATE)&(PIDDATE<=PREQENDDT)) D
