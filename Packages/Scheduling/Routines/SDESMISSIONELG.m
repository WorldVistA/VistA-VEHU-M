SDESMISSIONELG ;ALB/MGD,ANU,LAB - VISTA SCHEDULING RPCS GET MISSION ELIGIBILITY ; JAN 13,2023
 ;;5.3;Scheduling;**814,815,818,820,826,835**;Aug 13, 1993;Build 4
...
GETMISSIONELG(ELGRETURN,APPTREQIEN,PID,APPTREQTYP,SDEAS,APPTDATE,SDCLNIEN) ; Get Mission Eligibility
 ...
 N SDPRIM,SDSTOPCDIEN,SDI,REQDATENET,REQENDDTNET,PREQENDDT
 ...
 I 'HASVLDERRORS S HASFIELDS=$$GETMSNELG(.ELGFIELDSARRAY,REQDATE,PREQENDDT,PIDDATE,.SDAPPTAVAIL,APPTDATE,REQENDDT)
...
VALIDATE(ERRORS,APPTREQIEN,PID,APPTREQTYP,SDEAS,SDAPPTAVAIL,APPTDATE) ; Validate Appointment Request IEN, Request Date, PID Date
 ...
 Q $D(ERRORFLAG)
 ;
GETMSNELG(ELGARRAY,REQDATE,PREQENDDT,PIDDATE,SDAPPTAVAIL,APPTDATE,REQENDDT) ; GET Eligibility
 N HASDATA
