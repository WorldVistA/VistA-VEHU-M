SDESMISSIONELG ;ALB/ANU - VISTA SCHEDULING RPCS GET MISSION ELIGIBILITY ; Mar 09, 2022@15:20
 ;;5.3;Scheduling;**814,815**;Aug 13, 1993;Build 4
 ...
 Q
 ;
GETMISSIONELG(ELGRETURN,APPTREQIEN,PID,APPTREQTYP,SDEAS) ; Get Mission Eligibility
...
VALIDATE(ERRORS,APPTREQIEN,PID,APPTREQTYP,SDEAS) ; Validate Appointment Request IEN, Request Date, PID Date
 ...
 I "APPT,RTC,CONSULT,PROCEDURE,PTCSCH"'[APPTREQTYP S ERRORFLAG=1 D ERRLOG^SDESJSON(.ERRORS,61) Q $D(ERRORFLAG)
