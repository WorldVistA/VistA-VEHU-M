SDES2APPTUTIL ;ALB/BLB- SDES2 CREATE APPOINTMENT UTILITIES ;Dec 11,2023
...
APPTREQ(APPOINTMENT,APPTIEN,REQUESTIEN,REQUESTTYPE) ;
 ...
 D BUILDAPPTDATA^SDESEDITAPPTREQ(REQUESTIEN,STARTDATETIME,CLINICIEN,$G(APPOINTMENT("SERVICEC ONNECTED")),$G(APPOINTMENT("SERVICE CONNECTED PERCENTAGE")),$G(APPOINTMENT("APPOINTMENT TYPE")),$G(SDCONTEXT("ACHERON AUDIT ID")))
...
CONSULT(APPOINTMENT,APPTIEN44) ;
 N FDA,REQUESTIEN,PROVIDERIEN,NOTE,STARTDATETIME,RESOURCEIEN,DFN
 ;
 ...
 ;
 D REQSET^SDEC07A(REQUESTIEN,PROVIDERIEN,"",1,"",$TR($E(NOTE,1,150),"^"," "),STARTDATETIME,RESOURCEIEN,DFN)
 ;
