SDES2APPTUTIL ;ALB/BLB,TJB,TJB - SDES2 CREATE APPOINTMENT UTILITIES ;MAR 19,2024
 ;;5.3;Scheduling;**866,871,875**;Aug 13, 1993;Build 25
 ;;Per VHA Directive 6402, this routine should not be modified
 ;---------------------------------------------------------------
 Q
 ;
APPTREQ(APPOINTMENT,APPTIEN,REQUESTIEN,REQUESTTYPE) ;
 N STARTDATETIME,CLINICIEN
 ...
 D BUILDAPPTDATA^SDESEDITAPPTREQ(REQUESTIEN,STARTDATETIME,CLINICIEN,$G(APPOINTMENT("SERVICE CONNECTED PERCENTAGE")),$G(APPOINTMENT("SERVICE CONNECTED")),$G(APPOINTMENT("APPOINTMENT TYPE")),$G(SDCONTEXT("ACHERON AUDIT ID")))
...
CONSULT(APPOINTMENT,APPTIEN44) ;
 N FDA,REQUESTIEN,PROVIDERIEN,NOTE,STARTDATETIME,RESOURCEIEN,DFN,CLINICIEN,NETSTARTDT
 ;
 ...
 ;
 D REQSET^SDEC07A(REQUESTIEN,PROVIDERIEN,"",1,"",$TR($E(NOTE,1,150),"^"," "),NETSTARTDT,RESOURCEIEN,DFN)
 ;
