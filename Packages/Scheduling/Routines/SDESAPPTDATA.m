SDESAPPTDATA ;ALB/TAW/RRM/BWF/MGD - VISTA Appointment data getter ;July 1, 2022@12:40
 ;;5.3;Scheduling;**788,814,815,820**;Aug 13, 1993;Build 10
...
SUMMARY(APPTDATA,IEN) ;
 ...
 D SETSTATUS^SDESGETAPPTWRAP3(.APPTDATA,IEN,CLINICIEN)
...
SUMMARY2(APPTDATA,IEN) ;
 ...
 K APPTDATA
 S FN=409.84,IENS=IEN_",",OVERBOOK=0
 D GETS^DIQ(FN,IEN,".01;.02;.03;.04;.05;.06;.07;.14;.16;.17;.18;1;3;100","IE","APPTARY","SDMSG") ;SD,814-Added 100 for the EAS Tracking Number
 S RESOURCEIEN=$G(APPTARY(FN,IENS,.07,"I"))
 S CLINICIEN=$$GET1^DIQ(409.831,RESOURCEIEN,.04,"I")
 S STIME=$G(APPTARY(FN,IENS,.01,"I"))
 ...
 S CIENDATETIME=$G(APPTARY(FN,IENS,.04,"E"))
