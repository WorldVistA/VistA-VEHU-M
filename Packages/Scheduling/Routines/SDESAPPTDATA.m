SDESAPPTDATA ;ALB/TAW,BWF,MGD,RRM,ANU,LAB - VISTA Appointment data getter ;FEB 24, 2023@10:38
 ;;5.3;Scheduling;**788,814,815,820,823,827,837,838**;Aug 13, 1993;Build 7
...
SUMMARY(APPTDATA,IEN) ;
 ...
 ..Q:DFN'=$$GET1^DIQ(44.003,SIEN_","_STIME_","_CLINICIEN_",",.01,"I")
 ...
 S APPTDATA("DFN")=DFN
 S APPTDATA("Patient","EligibilityIEN")=$$GET1^DIQ(2,DFN_",",.361,"I")
 S APPTDATA("Patient","Name")=$$GET1^DIQ(2,DFN_",",.01,"E")
 ;
...
SUMMARY2(APPTDATA,IEN) ;
 N APPTARY,FN,IENS,SDMSG,DFN,RESOURCEIEN,CLINICIEN,SIEN,OVERBOOK,STIME,ETIME,X,PROV,CUSER
