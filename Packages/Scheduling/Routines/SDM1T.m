SDM1T ; GENERATED FROM 'SDM1' INPUT TEMPLATE(#100), FILE 2;05/21/26
 D DE G BEGIN
...
BEGIN S DNM="SDM1T",DQ=1
 ...
 M DIEZAR=^DIE(100,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=100,U="^"
...
C1F1 N X,X1,X2 S DIXR=251 D C1X1(U) K X2 M X2=X D C1X1("O") K X1 M X1=X
 D
...
C3F1 N X,X1,X2 S DIXR=253 D C3X1(U) K X2 M X2=X D C3X1("O") K X1 M X1=X
 D
