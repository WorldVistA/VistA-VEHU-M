SD5361EN ;ALB/REW - SD*5.3*61 Environment Checker ; 7 JUN 1996
 ;;5.3;Scheduling;**61**;AUG 13, 1993
EN ;entry point
 W !,"SD*5.3*61 Installation Requirements:",!
 IF $D(XPDABORT)#2 W !!?4,"*** Warning: Because variable XPDABORT exists, SD*5.3*61 will not install."
...
PKGCHK ;check package file entries
 ...
 W:$D(XPDABORT) !,">>> SD*5.3*61 Aborted in Environment Checker"
