SDES2EDITPATDEMO ;ALB/BLB,BWF,JDJ,JHC,JHC - SDES2 EDIT PATIENT DEMOGRAPHICS ;JUL15,2026
 ;;5.3;Scheduling;**877,878,881,909,951**;Aug 13, 1993;Build 5
...
EDITDEMO(DFN) ;
 ...
 N %DT,%L,D0,D1,DGUSER,VAERR,X,Y ;ADDED DUE TO LEAKING VARIABLES FROM FILEMAN UPDATES
 ;
 ; top level patient
