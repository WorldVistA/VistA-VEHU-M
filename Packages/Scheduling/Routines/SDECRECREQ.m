SDECRECREQ   ;ALB/SAT/JSM,WTC,LAB,LEG - VISTA SCHEDULING RPCS (SOURCE FROM SDEC08) ;Jul 23, 2021@09:30
 ;;5.3;Scheduling;**790,792**;Aug 13, 1993;Build 9
 ;;Per VHA Directive 2004-038, this routine should not be modified
 ;
 ; Reference to ^DPT (Patient File) is supported by IA #7030
 Q
 ;
RECREQ(SDECY,SDECAPTID,SDAPTYP,NEWPID) ;for Recall Requests
 ...
 Q:("^3^9^10^12^"[(U_$P(SD409840REC,U,22)_U))
