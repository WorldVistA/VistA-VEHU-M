SDESCREATEAPPT  ;ALB/BLB - VISTA SCHEDULING RPCS; Apr 4, 2022@15:20
 ...
 ;
VALIDATE(ERRORS,ARY84) ; Validate input
 N MAXDAYS,SDECRNOD,RESOURCED,ENCOUNTER
 ;
 ...
 I ARY84("SDAPPTYPE")="" D ERRLOG^SDESJSON(.ERRORS,60) Q
 I ARY84("SDAPPTYPE")'="",('$D(^SD(409.1,"B",ARY84("SDAPPTYPE")))) D ERRLOG^SDESJSON(.ERRORS,61) Q
 I ARY84("SDAPPTYPE")'="",($D(^SD(409.1,"B",ARY84("SDAPPTYPE")))) S ARY84("SDAPPTYPE")=$O(^SD(409.1,"B",ARY84("SDAPPTYPE"),0))
 ;
 ; patient Status
 ...
 S ARY84("SDAPPTLENGTH")=$G(ARY84("SDAPPTLENGTH"))
...
CLEANUP40984(ARY84,NEWIEN40984) ;
 ...
 .D UPDATE^SDECAR2($P(ARY84("SDREQTYPE"),"|",2),ARY84("SDAPPTSTARTDTTM"),ARY84("CLINICIEN"),ARY84("SDSERVCONNPERC"),ARY84("SDSERVCONN"),,ARY84("SDPATIENTSTATUS"),ARY84("SDEAS"))
 .I $G(ARY84("SDMRTC")),$G(ARY84("SDPARENT")) D AR433^SDECAR2(ARY84("SDPARENT"),NEWIEN40984_"~"_$P(ARY84("SDREQTYPE"),"|",2))
 .D:$G(ARY84("SDPARENT")) AR438^SDECAR2($P(ARY84("SDREQTYPE"),"|",2),ARY84("SDPARENT"))
 ;
