SDESHASHCLIN ;ALB/LAB,MGD,BWF,BLB - VISTA SCHEDULING RPCS HASH CLINIC ;Nov 14, 2022
 ;;5.3;Scheduling;**823,824,828,871,902**;Aug 13, 1993;Build 1
...
HASHALL ;hash all clinics this will be a jobbed option: SDES HASH ALL CLINICS
 ...
 . ;
 . I $$GET1^DIQ(44,CLIN,2505,"I"),$$GET1^DIQ(44,CLIN,2505,"I")<=DT,$$INACTIVE^SDESUTIL(CLIN),'+$$GET1^DIQ(44,CLIN,2605,"I") D
 . . D REMOVEPROVS(CLIN)
 . ;
