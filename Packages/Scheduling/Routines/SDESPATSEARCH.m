SDESPATSEARCH  ;ALB/BLB - SDES PATIENT SEARCH; Apr 04, 2023@09:49
 ;;5.3;Scheduling;**833,838,842,843,844**;Aug 13, 1993;Build 12
...
INDEX(SEARCHSTRING) ; returns the index to be searched in ^DPT
 ...
 I $G(SEARCHSTRING)[",",$L($TR($G(SEARCHSTRING),",",""))<3 Q "B" ;last name containing only 1 or 2 characters
