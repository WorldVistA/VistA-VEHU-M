...
ENV ; install environment
 ...
 S DNS("P")="vac10cluhl7r201-hl7.domain.ext^xx.xxx.xx.xx^xxxx"
 S DNS("T")="vac10cluhshhl7rtr401.domain.ext^xx.xxx.xx.xx^xxxx"
 S DNS("Q")="vac10apphsh924.domain.ext^xx.xxx.xx.xx^xxxx"
 S DNS("D")="vac10apphsh804.domain.ext^xx.xxx.xx.xx^xxxx"
