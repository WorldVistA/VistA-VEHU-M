SDES874P ;ALB/MGD - FY24 - Mid Year Stop Code Updates; Feb 26, 2024@16:10
 ;;5.3;Scheduling;**874**;AUG 13, 1993;Build 4
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 ; Post-init routine updating stop codes in CLINIC STOP file (#40.7)
 ; for FY24 updates - effective 4/01/2024.
 ;
 Q
 ;
POST     ; Update stop codes in Clinic Stop file 40.7
 ;
 D BMES^XPDUTL("SD*5.3*874 Post-Install starts...")
 ...
 D MES^XPDUTL("SD*5.3*874 Post-Install is complete."),MES^XPDUTL("")
 K SDIEN,%H,%I,DIC,X,Y
 ;
 Q
 ;
ADD      ; Add new stop code
 ...
 D BMES^XPDUTL("    [NOTE: These Stop Codes CANNOT be used UNTIL 04/01/2024]")
 ;
...
REACT    ; Reactivate stop code
 ...
 . . . . K SDINTERR
 . . . I '$D(SDINTERR) D
 . . . . D BMES^XPDUTL("     >> Reactivated: "_+SDCODE_"   "_SDNM_" as of 04/01/2024")
 ;
...
CHG      ; Code name changes - ;;code name^code #^^new code name
 ;;MH INTGRTD CARE IND^534^^PCMHI INDIV
 ;;MH INTGRTD CARE GRP^539^^PCMHI GROUP
 ;;QUIT
 ;
RT       ; Change Restriction - ;;stop code name^CODE #^rest type^rest date
 ;;PM&RS DRIVER TRAINING^230^E^4/1/2024
 ;;LOW VISION CARE^439^E^4/1/2024
 ;;PCMHI GROUP^539^E^4/1/2024
 ;;QUIT
