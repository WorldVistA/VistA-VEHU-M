...
LOOP ; Loop through the enrollment info
 ...
 .S SDCLN=0 F  S SDCLN=$O(^DPT(SDPAT,"DE",SDCLN)) Q:'SDCLN  S SDCLIN=$G(^(SDCLN,0)) I SDCLIN D
 ..S SDENR=0 F  S SDENR=$O(^DPT(SDPAT,"DE",SDCLN,1,SDENR)) Q:'SDENR  S SDENROL=$G(^(SDENR,0)) I SDENROL D
