...
FLTRAPPTREQ(REQIEN,SDINPUT,FLTRORIGDATE,FLTRPIDDATE,STARTDT,ENDDT,PRIORITYGROUP,PATSVCCONN,PATSCPERCENT,COUNT,REQCNT) ;
 N REQIENS,CLINICIEN,APPTREQ,WAITDAYS,DATEENTERED,PATNAME
 Q:'REQIEN
 S REQIENS=REQIEN_","
 ...
 I PIDDATE,$D(SDINPUT("FILTER","PID")),PIDDATE'=FLTRPIDDATE Q
 ...
 I CLINICNAME="" S CLINICNAME="_UNKNOWN"
 ...
 D SETDATA($G(SDINPUT("SORT")),PATNAME,CLINICNAME,PRIORITYGROUP,PIDDATE,DATEENTERED,"A",REQIEN,SERVICEREL,SCPERCENT,WAITDAYS)
 Q
 ;
FLTRCONSULT(CONSIEN,SDINPUT,FLTRORIGDATE,FLTRPIDDATE,STARTDT,ENDDT,PRIORITYGROUP,PATSVCCONN,PATSCPERCENT,COUNT,REQCNT) ;
 ...
 Q:'CONSIEN
 S CONSIENS=CONSIEN_","
 D GETS^DIQ(123,CONSIENS,".01;.02;.05;.07;1;2","I","CONSULT")
 ; clinics
 ...
 S SCPERCENT=100-$G(PATSCPERCENT)
 S COUNT=$G(COUNT)+1,REQCNT=$G(REQCNT)+1
 D SETDATA($G(SDINPUT("SORT")),PATNAME,CLINICNAME,PRIORITYGROUP,PIDDATE,DATEENTERED,"C",CONSIEN,SERVICEREL,SCPERCENT,WAITDAYS)
 Q
 ;
FLTRRECALL(RECALLIEN,SDINPUT,FLTRORIGDATE,FLTRPIDDATE,STARTDT,ENDDT,PRIORITYGROUP,PATSVCCONN,PATSCPERCENT,COUNT,REQCNT) ;
 ...
 D GETS^DIQ(403.5,RECALLIENS,".01;4.5;5;5.5;7.5","I","RECALL")
 ; clinics
 ...
 S COUNT=$G(COUNT)+1,REQCNT=$G(REQCNT)+1
 D SETDATA($G(SDINPUT("SORT")),PATNAME,CLINICNAME,PRIORITYGROUP,RECALLDATE,DATEENTERED,"R",RECALLIEN,SERVICEREL,SCPERCENT,WAITDAYS)
 Q
 ; set data into ^TMP for final processing
SETDATA(SORT,PATNAME,CLINICNAME,PRIOGROUP,DESIREDDATE,ORIGDATE,REQTYPE,REQIEN,SERVICEREL,SCPERCENT,WAITDAYS) ;
 ;
 I $G(SORT)="DEFAULT" D
 ...
 I $G(SORT)="REQUEST TYPE" D
 .S ^TMP("SDES2QUERY",$J,"DATA",REQTYPE,REQIEN)=""
 I $G(SORT)="WAIT TIME" D
 .S ^TMP("SDES2QUERY",$J,"DATA",WAITDAYS,REQIEN)=""
 I $G(SORT)="ORIGINATION DATE" D
 .S ^TMP("SDES2QUERY",$J,"DATA",ORIGDATE,REQIEN)=""
 I $G(SORT)="PID DATE" D
 .S ^TMP("SDES2QUERY",$J,"DATA",DESIREDDATE,REQIEN)=""
 I $G(SORT)="SERVICE RELATED" D
 .S ^TMP("SDES2QUERY",$J,"DATA",SERVICEREL,REQIEN)=""
 I $G(SORT)="SCVISIT" D
 .S ^TMP("SDES2QUERY",$J,"DATA",SCPERCENT,REQIEN)=""
