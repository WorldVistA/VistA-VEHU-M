SDES2CREATECLIN ;ALB/MGD/BLB,BWF,TJB,JAS,TJB,MGD,JDJ/JAS,JDJ - SDES2 CREATE CLINIC MAIN DRIVER ;JAN 12, 2026
 ;;5.3;Scheduling;**853,860,871,885,893,895,899,914,909,949**;Aug 13, 1993;Build 4
...
CREATECLINIC(SDRETURN,SDCONTEXT,SDCLINIC) ; Add a new clinic to the HOSPITAL LOCATION  file (#44)
 ;
 N SDERRORS,SDJSONERRORS,SDFDA,SDCLINRETURN,SDFILEDATA,SDCLINICIEN,SDRESULTS,SDPARAM,CLIN,SDECI
 ...
 S SDPARAM("CLINICIEN")=SDCLINICIEN
 D BLDCLNREC^SDES2CLININFO(.CLIN,$G(SDPARAM("CLINICIEN")))
 M SDCLINRETURN=CLIN
