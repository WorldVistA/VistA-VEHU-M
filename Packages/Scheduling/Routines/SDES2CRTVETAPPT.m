SDES2CRTVETAPPT ;ALB/BLB,MGD,TJB,TAW,MCB - SDES2 CREATE VET REQ AND APPT ;June 17, 2026
 ;;5.3;Scheduling;**867,869,877,881,909,949**;Aug 13, 1993;Build 4
...
CREATEREQANDAPPT(JSON,SDCONTEXT,REQUEST) ;
 ...
 ;
 ; Newing Leaking Variables
 N DIERR,VEFS11,VEFS12,VEFS9,VEFSFAC,VEFSPID,VEFSQ,D,D0,DI,DIC,DIU,DQ
 ; validate
...
CREATEREQUEST(JSONREQUEST,REQUESTRETURN,REQUEST,REQUESTIEN,ERRORS) ;
 ...
 ; Newing Leaking Variables
 N REQTYPE,ISAPPTTYPEVALID,ISCLINSTOPVALID,ISDATETIMEVALID,ISDFNVALID,ISEASVALID,ISMODALINVALID,ISPATSTATVALID,ISPIDVALID
 N ISPRIGROUPVALID,ISPRIORITYVALID,ISREQTYPEVALID,ISREQUESTBYVALID,ISSERVCONNVALID,ENDDATE,STARTDATE
 ;
