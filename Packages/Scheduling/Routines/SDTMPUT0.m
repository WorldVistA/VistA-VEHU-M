SDTMPUT0 ;MS/SJA - TELEHEALTH SEARCH UTILITY ;Dec 17, 2020
 ;;5.3;Scheduling;**773,779**;Aug 13, 1993;Build 7
 ;
 ;
...
EN W @IOF W ?22,"Telehealth Inquiries",!!
 K DIRUT,DUOUT,DIR
 S DIR(0)="SA^C:Clinic;M:Medical Center Division;I:Institution;P:Patient Information;L:List Stop codes;S:Stop Code Lookup;Q:QUIT"
...
C ; Search by clinic
 ...
 W "Medical Division",?18,": ",DIV,"-",$$GET1^DIQ(40.8,DIV,.01)
