SDES939P ;ALB/MGD - FY26 Mid-Year Stop Code Updates; Feb 23, 2026@10:09
 ;;5.3;Scheduling;**939**;AUG 13, 1993;Build 1
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 ; Post-init routine updating stop codes in CLINIC STOP (#40.7) file
 ; for FY26 Mid-Year updates - effective 04/01/2026.
 ;
 Q
 ;
POST     ; Update stop codes in Clinic Stop file 40.7
 ;
 D BMES^XPDUTL("SD*5.3*939 Post-Install starts...")
 ...
 D MES^XPDUTL("SD*5.3*939 Post-Install is complete."),MES^XPDUTL("")
...
ADD      ; Add new stop code
 ...
 D BMES^XPDUTL("    [NOTE: These Stop Codes CANNOT be used UNTIL 04/01/2026]")
 ;
...
REACT    ; Reactivate stop code
 ...
 . . . . K SDINTERR
 . . . I '$D(SDINTERR) D
 . . . . D BMES^XPDUTL("     >> Reactivated: "_+SDCODE_"   "_SDNM_" as of 04/01/2026")
 ;
