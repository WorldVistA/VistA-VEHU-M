SDES2BLDAPPTOBJ ;ALB/LAB - VISTA SCHEDULING BUILD APPOINTMENT OBJECT ;JAN 15, 2024
 ;;5.3;Scheduling;**871**;Aug 13, 1993;Build 13
 ;;Per VHA Directive 6402, this routine should not be modified
 ;
 Q
 ;
BUILDAPPTOBJ(APPTOBJ,APPTIEN,RECCNT,ERRORS) ;Called from GET APPT RPCs to build appointment object.
 N SDDFN,CLINIEN,CANCELID,SDIEN
 D GET40984INFO(.APPTOBJ,APPTIEN,.SDDFN,.CLINIEN,.CANCELID,RECCNT)
 D GET2INFO^SDES2BLDAPPT2(.APPTOBJ,APPTIEN,SDDFN,RECCNT)
 ...
 I 'SDIEN D ERRLOG^SDESJSON(.ERRORS,555,"Appointment IEN "_APPTIEN_". Unable to retrieve Clinic appointment data") Q
...
GET40984INFO(APPTOBJ,APPTIEN,SDDFN,CLINIEN,CANCELID,RECCNT) ;
 ...
 S APPTOBJ("Appointment",RECCNT,"DateAppointmentMade")=$$FMTISO^SDAMUTDT($G(ARRAY40984(409.84,IENS,.09,"I")),CLINIEN)
