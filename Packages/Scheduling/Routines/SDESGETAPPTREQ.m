SDESGETAPPTREQ ;ALB/BLB,RRM,MGD,DJS,BLB,BWF,BLB,CGP,ANU,LAB,TJB - GET APPT REQ RPCS ;JUL 18, 2023@15:35
 ;;5.3;Scheduling;**815,818,819,823,824,825,828,831,833,837,838,839,845,847,851**;Aug 13, 1993;Build 10
...
GETREQBYAPPTIEN(JSONRETURN,APPTIEN,EAS) ;GET APPT REQ BY APPT IEN
 ...
 ;
 S ISAPPTIENVALID=$$VALIDATEAPPTIEN^SDESGETAPPTREQ2(.ERRORS,$G(APPTIEN))
 S ISEASVALID=$$VALIDATEEAS^SDESGETAPPTREQ2(.ERRORS,$G(EAS))
