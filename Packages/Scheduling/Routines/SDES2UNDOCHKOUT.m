SDES2UNDOCHKOUT ;ALB/ANU/TJB,MCB,MCB,AGW,JDJ,RN - VISTA SCHEDULING RPCS - SDES2 UNDO CHECKOUT ;MAY 22,2026
 ;;5.3;Scheduling;**877,919,909,942,945,947,949**;Aug 13, 1993;Build 4
...
UNDOCHECKOUT(JSONRETURN,SDCONTEXT,SDINPUT) ;
 ...
 . D BUILDAPPTOBJ^SDES2BLDAPPTOBJ(.SDRETURN,PARAMETERS("APPOINTMENT IEN"),1,.ERRORS)
 I $D(ERRORS) M ERRORS=SDRETURN D BUILDJSON^SDES2JSON(.SDRETURN,.ERRORS) Q
...
UNDO(APPTIEN,CLINICIEN,APPTSTARTTIME,DFN) ;
 ...
 ;
 I $D(^SCE($G(ENCOUNTERIEN),0)) D
 .N SDSTAT,APPTNOD
 .S APPTNOD=$G(^SDEC(409.84,APPTIEN,0))
 .I $P(APPTNOD,U,17)="I" Q
 .S SDSTAT=$O(^SD(409.63,"B","ACTION REQUIRED",0))
 .S FDA40968(409.68,ENCOUNTERIEN_",",.07)="@"
 .S FDA40968(409.68,ENCOUNTERIEN_",",.12)=SDSTAT
