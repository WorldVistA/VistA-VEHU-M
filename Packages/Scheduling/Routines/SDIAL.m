SDIAL ;ALB/TMP - INPATIENT APPOINTMENT LIST ; 16 JAN 86
 ;;MAS VERSION 5.1;
...
RD1 D DATE^SDUTL G:POP END I BEGDATE<DT W *7,!,"Start date must be in the future" G RD1
 S ENDDATE=ENDDATE_".9999",VAR="DIV^SDW^BEGDATE^ENDDATE",VAL=DIV_"^"_SDW_"^"_BEGDATE_"^"_ENDDATE,PGM="START^SDIAL"
