SDESAPPT ;ALB/BLB,MGD,KML,TAW- VISTA SCHEDULING RPCS ;Mar 8, 2022
 ;;5.3;Scheduling;**788,805,807,809**;Aug 13, 1993;Build 10
 ;
...
APPGETJSON(SDECY,DFN,BDATE,EDATE,SDEAS) ; Return a list of appointments and associated data by PATIENT
 ...
 I +SDEAS=-1 S POP=1 D ERRLOG^SDESJSON(.SDAPPT,142)
 I 'POP D
 ...
 Q
 ;
APPGETONEJSON(SDECY,IEN,SDEAS) ; Return a sing appointment and associated data by IEN
