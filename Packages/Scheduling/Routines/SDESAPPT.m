SDESAPPT ;ALB/BLB,MGD,KML,TAW,BWF- VISTA SCHEDULING RPCS ;Apr 18, 2022
 ;;5.3;Scheduling;**788,805,807,809,815**;Aug 13, 1993;Build 4
 ;
...
APPTBYRIENAPTYP(SDECY,REQIEN,REQTYPE,SDEAS) ;
 ...
 I $D(SDERR) D BUILDJSON(.SDECY,.SDERR) Q
