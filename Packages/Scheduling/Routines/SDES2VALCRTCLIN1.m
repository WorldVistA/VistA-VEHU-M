SDES2VALCRTCLIN1 ;ALB/MGD - CLINIC VALIDATION UTILITIES DRIVER ;JUNE 08,2023
...
VALCLINIC(SDERRORS,SDCLINIC,SDFILEDATA) ; Validate Clinic Input Array
 ...
 ; Use $D check on subfiles
 I $D(SDCLINIC("DIAGNOSIS")) D VALDIAG(.SDERRORS,.SDCLINIC,.SDFILEDATA) ; Call Create only Validator
 D VALSTARTHOUR^SDES2VAL44(.SDERRORS,$G(SDCLINIC("HOUR CLINIC DISPLAY BEGINS")),.SDFILEDATA) ; Default to 8 am if not passed in
...
VALSPECINSTRUCT(SDERRORS,SDSPECINST,SDFDATA) ;
 ...
 .S SDINSTEXT=$P(SDINSDATA,"|",2,99)
 .S SDINSTEXT=$TR(SDINSTEXT,"^"," ")
 .I SDINSTEXT="" Q
 .I SDINSTEXT="@" D ERRLOG^SDES2JSON(.SDERRORS,459,"SPECIAL INSTRUCTIONS") Q
