SDES01C ;ALB/ANU - VISTA SCHEDULING RPCS ;Jul 06, 2021@13:18
...
CLINICRSC(CLINICLIST,SEARCHSTRING) ;Returns first 50 matching RESOURCE names
 ...
 ;
 Q:$L(SEARCHSTRING)<3
 N SDTYPE,MAXREC,SDACT,CLINICINFO,SDX,SDXT,SDECI,SDECRES,SDRT,SDF,SDECRNOD,SDTYPE,SDHL,SDCN
 D SDINIT
 ;partial name lookup
 I SEARCHSTRING'="" D
