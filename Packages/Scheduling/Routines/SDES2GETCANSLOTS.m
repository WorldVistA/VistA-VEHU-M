SDES2GETCANSLOTS ;ALB/MGD,JAS - VISTA SCHEDULING RPCS GET CLINIC CANCELLED SLOTS ; May 21, 2024@16:10
 ;;5.3;Scheduling;**866,880**;Aug 13, 1993;Build 5
...
BUILDDATA(SDGETCANCSLOTS,SDCANCDATA,SDTMPARY) ; retrieve clinic availability data
 N CLINICIEN,SDP1,SDP2,SDP3,SDP4,SDSLOTS,SDSTOPTM,SDSTRTTM,SDTOTAL,II,SDDIV,SDINST,SDAPDTTM,SDCANMSG,SDFIRST
 I $O(@SDTMPARY@(""))="" Q
 S CLINICIEN=$G(SDCANCDATA("CLINICIEN"))
 ...
 . S SDAPDTTM=+SDP1
 . S SDCANMSG=$$GET1^DIQ(44.001,SDAPDTTM_","_CLINICIEN_",",1400)
