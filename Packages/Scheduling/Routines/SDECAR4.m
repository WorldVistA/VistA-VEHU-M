SDECAR4 ;ALB/TAW,LAB,BLB - VISTA SCHEDULING RPCS ;Oct 31, 2022@14:00
 ;;5.3;Scheduling;**784,785,788,805,813,826,833,835**;Aug 13, 1993;Build 4
...
GETREQBYTYPEVET(RET) ; SDES GET APPT REQ BY TYPE VET
 N RETURN,ERRORS,APPT,CNT,ARIEN,ARDATA,FNUM
 ;
