SDESCKNSTEP ;ALB/BLB,TAW,MGD - VISTA SCHEDULING RPCS ;Jan 28, 2022
 ;;5.3;Scheduling;**788,790,792,800,805,807**;Aug 13, 1993;Build 5
...
GETAPPTCKNSTEP(SDECY,IEN,STATUS,EAS) ; Get check-in status associated appointment IEN and passed in status
  ...
  S EAS=$G(EAS,"")
  I $L(EAS) S EAS=$$EASVALIDATE^SDESUTIL(EAS)
  I +EAS=-1 D ERRLOG^SDESJSON(.SDCHECKIN,142),BUILDER Q
  ;
  S SIEN=0
