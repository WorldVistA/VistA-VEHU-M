SDES2EDITAPREQ ;ALB/BWF,JAS,JAS,TJB/JAS,BWF,JAS,LAB/JAS,JDJ,JAS - EDIT APPOINTMENT REQUEST ; MAR 27, 2025
 ;;5.3;Scheduling;**869,871,873,875,890,893,895,901,904**;Aug 13, 1993;Build 1
...
BUILDER(REQUEST,INSTITUTIONIEN,EAS,EDITUSER) ;
 ...
 S REQUEST("REQUEST COMMENT")=$$CTRL^XMXUTIL1($G(REQUEST("REQUEST COMMENT")))
