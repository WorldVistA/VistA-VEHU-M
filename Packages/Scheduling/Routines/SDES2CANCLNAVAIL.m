SDES2CANCLNAVAIL ;ALB/BLB,BLB,TJB,BLB,JAS,BLB,BWF,BLB,MCB,AGW,AGW,JAS - SDES2 CANCEL CLINIC AVAILABILITY ; JUN 05, 2026
 ;;5.3;Scheduling;**869,873,875,880,886,893,898,902,914,922,909,947**;Aug 13, 1993;Build 3
...
CANCEL(JSON,SDCONTEXT,CANCEL) ;
 N ERRORS,RETURN
 ; Next line of News are to address leaking variables from other APIs
 N %DT,%L,C,DSIHCL,DSIHFS,DSPV150,EVN,HL16,HL7STRG,HLA,HLECH,HLFS,HLQ,IEN,J,PIVOT,PXKOE,R,REF,RTN,S,SDCNT,SDCODES,SEQ,SLOTSTATUSSTRING,VA,VACNTRY,VAERR,XQXFLG,XS,Y,Z0
 ;
...
CANCELAPPTS(CLINICIEN,STARTDATETIME,ENDDATETIME,FLAG,CANCELREMARKS,SDCONTEXT,RETURN) ;
 ...
 ..;
 I FLAG="P" D EN^SDTMPHLC(CLINICIEN,STARTDATETIME,ENDDATETIME,"P",CANCELREMARKS)
 I FLAG="F" D EN^SDTMPHLC(CLINICIEN,$P(STARTDATETIME,"."),,"C","**CANCELLED**")
 Q
 ;
