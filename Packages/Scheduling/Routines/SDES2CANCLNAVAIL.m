...
CANCEL(JSON,SDCONTEXT,CANCEL) ;
 ...
 ;
 D CANCELAVAIL(CANCEL("CLINIC IEN"),CANCEL("START DATE TIME"),CANCEL("END DATE TIME"),CANCEL("FULL PARTIAL FLAG"),CANCEL("REMARKS"))
 D CANCELAPPTS(CANCEL("CLINIC IEN"),CANCEL("START DATE TIME"),CANCEL("END DATE TIME"),CANCEL("FULL PARTIAL FLAG"),CANCEL("REMARKS"),.SDCONTEXT,.RETURN)
 ;
