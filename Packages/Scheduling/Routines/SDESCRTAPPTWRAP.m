SDESCRTAPPTWRAP  ;ALB/BLB - VISTA SCHEDULING RPCS ; Apr 4, 2022@10:30
 ;;5.3;Scheduling;**814,816**;Aug 13, 1993;Build 3
...
CREATEAPPTS(JSONRETURN,APPTARRAY) ;
 ...
 ; validate parameters
 S HAS40984ERRORS=$$VALIDATE40984(.ERRORS,.ARY84)
...
VALIDATE2(ERRORS,ARY2) ;
 ...
 Q $D(ERRORFLAG)
 ;
CREATE40984(ARY84,ERRORS) ;
 N ARY84FDA,SDERROR,NEWIEN40984,SDERROR
...
CREATE44(ARY44,ERRORS) ;
 ...
 S ARRAYDELETE(44.001)=$G(IENS44(1))
 ;
 L +^SC(ARY44("CLINICIEN")):3
...
CREATE2(ARY2,ERRORS) ;
 ...
 D CREATE^SDESCREATEAPPT2(.ARRAY2FDA,.NEWIEN2,.ARY2)
 L +^DPT(ARY2("DFN")):3
