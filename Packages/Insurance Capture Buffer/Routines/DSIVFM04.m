DSIVFM04 ;DSS/BPD - FILEMAN FILER RPC ; 10/9/14 10:19am
 ...
 ;
FILE(DSIV,FILE,IENS,FLAG,INPUT) ; RPC: DSIV FM FILER
 ...
 ;
 ;  DSIV - return array where
 ;         DSIV(1) = 1^  if everything was successfully filed
 ;                 = -1^error message if any problems encountered
 ;         DSIV(2...n) = additional error messages
 ;
 ...
 I CNT>1 M DSIV=DSITMP K DSITMP Q
 ...
 .Q
F1 I '$D(DSITMP) S DSIV(1)="1^"
 E  M DSIV=DSITMP S DSIV(1)="-1^Problems encountered while filing data"
 Q
 ;
