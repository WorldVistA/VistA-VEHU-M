DSIVDT ;DSS/BPD - DATE FUNCTION RPCS ;10/21/2013 12:51
 ...
 ;
CNVT(DSIV,INVAL,INTYPE,OUTYPE,OUTFMT,TIMEFMT,FUN) ;
 ; RPC: DSIV DATE CONVERT
 ...
 I $L(OUTYPE)>1 S DSIV=RET
 E  S X=$F("DFEMHG",OUTYPE)-1 S:X>0 DSIV=$P(RET,U,X)
 S:'$D(DSIV) DSIV="ERR"
OUT Q:+$G(FUN) DSIV
 Q
 ;
