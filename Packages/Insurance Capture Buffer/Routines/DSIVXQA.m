DSIVXQA ;DSS/AJ - ICB KERNAL ALERT RPCS ;10/21/2013
 ...
 ;  This routine was cloned from DSICXQA
 ;
 ; DBIA#   SUPPORTED
 ; -----   ---------------------------------------------
 ...
 ; 10081   SETUP^XQALERT
 ;
SEND(DSIV,DATA,FUN) ;  RPC: DSIV XQA SEND ALERT
 ;  DSIV - return 1 if alert successfully sent, else return -1^msg
 ...
 .S DSIV="-1^" S:'$D(XQAMSG) DSIV=DSIV_"No display message received; "
 .S:'$D(XQA) DSIV=DSIV_"No recipients received"
 .Q
 E  D SETUP^XQALERT S DSIV=1
 Q:'$G(FUN)  Q DSIV
 ;
