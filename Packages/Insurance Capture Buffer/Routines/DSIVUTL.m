DSIVUTL ;DSS/BPD - VARIOUS UTILITIES ; 10/9/14 10:20am
...
STRIP(X,STR) ;  strip leading/trailing punctuation characters from X
 ...
 Q X
INPLOC(REC,DFN) ; Return a patient's current location RPC:  DSIV PAT LOC
 N X
 ...
 S $P(REC,U,3)=X
 Q
LIMITEIV(DSIVRET) ; RPC: DSIV LIMIT EIV
 S DSIVRET=$$GET1^DIQ(350.9,"1,","62.01","I","DSIVERR")
 I DSIVRET=0 S DSIVRET=DSIVRET_U_"The EIV field is not limited"
 I DSIVRET=1 S DSIVRET=DSIVRET_U_"The EIV field is limited"
 I DSIVRET="" S DSIVRET="1^The EIV field is limited"
 Q
