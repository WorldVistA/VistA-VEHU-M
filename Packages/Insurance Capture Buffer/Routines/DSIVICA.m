DSIVICA ;DSS/LM - Insurance card RPC's ;12/14/2004
 ;;2.2;INSURANCE CAPTURE BUFFER;**1,2,7,11,12**;May 19, 2009;Build 13
 ;Copyright 1995-2012, Document Storage Systems, Inc., All Rights Reserved
 ;
 ; Integration Agreements
 ;   2056   $$GET1^DIQ
 ;   5292   read/write/delete access to file 36
...
ACCEPT(RESULT,IBBUFDA,DFN,IBDATA) ;RPC: DSIV ACCEPT BUFFER ENTRY
 ...
 I '$$PATCH^DSICXPDU(,"IB*2.0*528",1),$G(IBMVPOL)=3,DSIVPC="" S DSIVPC="@" ;force replace of field 1.08 DSIV*2.2*1T6
 ...
 I $D(DSIVDS) D  ; Kill existing synonym multiple and replace if necessary
 .S DA="B",DA(1)=+DSIVIENS,DIK="^DIC(36,"_DA(1)_",10,"
 .F  S DA=$O(^DIC(36,DA(1),10,DA),-1) Q:DA=""  D ^DIK
 .K DIK
 .I CNTS>0 D UPDATE^DIE(,"DSIVDS",,"DSIVERRS")
 I $D(DSIVERRS) S K=K+1,RESULTXT(K)="-1^INS CO SYN-"_$G(DSIVERRS("DIERR",1,"TEXT",1)),ERR(2)=1
 I $D(DSIVDR) D  ; Kill existing remarks multiple and raplace if necessary
 .S DA="B",DA(1)=+DSIVIENS,DIK="^DIC(36,"_DA(1)_",11,"
 .F  S DA=$O(^DIC(36,DA(1),11,DA),-1) Q:DA=""  D ^DIK
 .K DIK
 .I CNTR>0 D WP^DIE(36,DSIVIENS,11,,"DSIVDR","DSIVERRR")
