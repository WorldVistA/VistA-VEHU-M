QAOTE16 ; ;10/05/93
 D DE G BEGIN
DE S DIE="^QA(741,D0,""REVR"",D1,1,",DIC=DIE,DP=741.12,DL=3,DIEL=2,DU="" K DG,DE,DB Q:$O(^QA(741,D0,"REVR",D1,1,DA,""))=""
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="QAOTE16",DQ=1+D G B
1 S DW="0;1",DV="M*P741.5'",DU="",DLB="REASON FOR EXCEPTION",DIFLD=.01
 S DE(DW)="C1^QAOTE16"
 S DU="QA(741.5,"
 G RE:'D S DQ=2 G 2
C1 G C1S:$D(DE(1))[0 K DB S X=DE(1),DIC=DIE
 K ^QA(741,DA(2),"REVR",DA(1),1,"B",$E(X,1,30),DA)
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 S ^QA(741,DA(2),"REVR",DA(1),1,"B",$E(X,1,30),DA)=""
 Q
X1 S DIC("S")="D EN5^QAOSDDUT" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
