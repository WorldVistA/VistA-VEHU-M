QAOTE12 ; ;10/05/93
 D DE G BEGIN
DE S DIE="^QA(741,D0,""ATRI"",",DIC=DIE,DP=741.024,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^QA(741,D0,"ATRI",DA,""))=""
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="QAOTE12",DQ=1+D G B
1 S DW="0;1",DV="MP200'",DU="",DLB="PEER ATTRIBUTION (INDIVIDUAL)",DIFLD=.01
 S DE(DW)="C1^QAOTE12"
 S DU="VA(200,"
 G RE:'D S DQ=2 G 2
C1 G C1S:$D(DE(1))[0 K DB S X=DE(1),DIC=DIE
 K ^QA(741,DA(1),"ATRI","B",$E(X,1,30),DA)
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 S ^QA(741,DA(1),"ATRI","B",$E(X,1,30),DA)=""
 Q
X1 Q
2 G 1^DIE17
