...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="QAOTE19",DQ=1
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW="0;9",DV="SX",DU="",DLB="FINAL PEER REVIEW PER SERVICE",DIFLD=9
 S DE(DW)="C1^QAOTE19"
 S DU="1:YES;0:NO;"
 S X="NO"
 S Y=X
...
C1 G C1S:$D(DE(1))[0 K DB S X=DE(1),DIC=DIE
 K ^QA(741,DA(1),"REVR","AONLY1",$E(X,1,30),DA)
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 S ^QA(741,DA(1),"REVR","AONLY1",$E(X,1,30),DA)=""
 Q
X1 D EN3^QAOSDDUT
 Q
 ;
...
X3 S QAOSOPEN=$S((QAOSACTN>1)&(QAOSACTN<8):1,1:0)
 Q
4 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=4 D X4 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X4 K QA,QAOSREAS,QAOSQUIT,QAOSFIND,QAOSNEWF,QAOSACTN
 Q
5 G 1^DIE17
