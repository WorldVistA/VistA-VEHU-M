QAOTE15 ; ;10/05/93
 D DE G BEGIN
DE S DIE="^QA(741,D0,""ATRL"",",DIC=DIE,DP=741.026,DL=2,DIEL=1,DU="" K DG,DE,DB Q:$O(^QA(741,D0,"ATRL",DA,""))=""
...
I I DV'["I",DV'["#" G RD
 ...
 Q
BEGIN S DNM="QAOTE15",DQ=1+D G B
1 S DW="0;1",DV="MP44'",DU="",DLB="PEER ATTRIBUTION (HOSP LOC)",DIFLD=.01
 S DE(DW)="C1^QAOTE15"
 S DU="SC("
 G RE:'D S DQ=2 G 2
C1 G C1S:$D(DE(1))[0 K DB S X=DE(1),DIC=DIE
 K ^QA(741,DA(1),"ATRL","B",$E(X,1,30),DA)
C1S S X="" Q:DG(DQ)=X  K DB S X=DG(DQ),DIC=DIE
 S ^QA(741,DA(1),"ATRL","B",$E(X,1,30),DA)=""
 Q
X1 Q
2 G 1^DIE17
