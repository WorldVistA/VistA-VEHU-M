LEX2098 ;ISL/KER - LEX*2.0*98 Env Check ;12/03/2014
 ;;2.0;LEXICON UTILITY;**98**;Sep 23, 1996;Build 2
 ;               
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
 ...
 ; for LEX*2.0*98 as a model for other patches.
 ; >>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<
 ; 
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*97 SEQ #88^3141103^Code Set FY15 1st Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*98"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_98.GBL"
 ;     Fiscal Year
 S LEXFY="FY15"
 ;     Quarter
 S LEXQTR="2nd"
