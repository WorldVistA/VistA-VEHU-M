LEX2038 ; ISL/KER - Environment Check/Pre/Post Install ; 02/02/2006
 ...
 ;                            
ENV ; LEX*2.0*38 Environment Check
 ;
 ;   General
 ;
 N LEXBUILD,LEXIGHF,LEXREQP,LEXLREV,LEXG,LEXE
 W !," Remedy Fixes and Late Released for Code Set Update for FY06 2nd Quarter",!
 D IMP S U="^"
 ;     No user
...
ABRT ;     Abort  Failed Environment Check, KILL the distribution
 D:$D(LEXE) ED S XPDABORT=1,XPDQUIT=1,XPDQUIT("LEX*2.0*38")=1 K LEXE,LEXFULL
 Q
 ;               
 ; Checks
 ;
...
ED ;   Error Display
 ...
 ;
IMP ;   Import names
 S LEXLREV=38,LEXREQP="LEX*2.0*15;LEX*2.0*29;LEX*2.0*36;LEX*2.0*39",LEXBUILD="LEX*2.0*38"
 S LEXIGHF="LEX_2_38.GBL"
 Q
