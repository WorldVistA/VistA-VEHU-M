LEX2126 ;ISL/TJH - LEX*2.0*126 Env Check ;03/24/2020
 ;;2.0;LEXICON UTILITY;**126**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*125 SEQ #116^3200319^CODE SET FY20 3RD QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*126"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_126.GBL"
 ;     Fiscal Year
 S LEXFY="FY20"
 ;     Quarter
 S LEXQTR="3rd"
