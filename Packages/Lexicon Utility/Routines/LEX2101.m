LEX2101 ;ISL/KER - LEX*2.0*101 Env Check ;09/01/2015
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*100 SEQ #92^3150630^Code Set FY15 4th Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*101"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_101.GBL"
 ;     Fiscal Year
 S LEXFY="FY16"
 ;     Quarter
 S LEXQTR="1st"
