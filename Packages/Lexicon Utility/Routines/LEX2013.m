LEX2013 ; ISA/FJF-LEX*2.0*13 Environment Check/Pre/Post Install    ; 02/17/1999
 ;;2.0;Lexicon Utility;**13**;Feb 17, 1999
 ;
ENV ; LEX*2.0*13 Environment Check
 ;           
 ;   General
 ;
...
CPD(X) ;   Check Current Patched Data is installed
 Q:$D(^LEX(757.1,"B",173825,247794))&('$D(^LEX(757.02,"B",296399,308551))) 1 Q 0
 E  Q 0
...
IMP ;   Import names
 ;
 S LEXLREV=7,LEXLAST="LEX*2.0*12",LEXBUILD="LEX*2.0*13"
 S LEXIGHF="LEX_2_P13.GBL"
 Q
