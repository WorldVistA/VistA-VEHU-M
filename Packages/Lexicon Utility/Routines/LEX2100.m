LEX2100 ;ISL/KER - LEX*2.0*100 Env Check ;06/01/2015
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*99 SEQ #91^3150401^Code Set FY15 3rd Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*100"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_100.GBL"
 ;     Fiscal Year
 S LEXFY="FY15"
 ;     Quarter
 S LEXQTR="4th"
