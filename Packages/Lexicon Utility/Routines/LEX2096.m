LEX2096 ;ISL/KER - LEX*2.0*96 Env Check ;12/09/2013
 ;;2.0;LEXICON UTILITY;**96**;Sep 23, 1996;Build 4
 ;               
 ; Global Variables 
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*95 SEQ #84^3140331^Code Set FY14 3rd Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*96"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_96.GBL"
 ;     Fiscal Year
 S LEXFY="FY14"
 ;     Quarter
 S LEXQTR="4th"
