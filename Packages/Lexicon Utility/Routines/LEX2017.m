LEX2017 ;ISA/FJF-Environment Check/Pre/Post Install;10-02-00
 ;;2.0;LEXICON UTILITY;**17**;Sep 23, 1996
 ;
ENV ; LEX*2.0*17 Environment Check
 ;           
 ;   General
 ;
...
IMP ;   Import names
 ;
 S LEXLREV=7,LEXLAST="LEX*2.0*16",LEXBUILD="LEX*2.0*17"
 S LEXIGHF="LEX_2_P17.GBL"
 Q
