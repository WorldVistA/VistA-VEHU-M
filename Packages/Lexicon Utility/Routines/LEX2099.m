LEX2099 ;ISL/KER - LEX*2.0*99 Env Check ;12/03/2014
 ...
 ; for LEX*2.0*99 as a model for other patches.
 ; >>>>>>>>>>>>>>>>>>>>>>>>>>>>>><<<<<<<<<<<<<<<<<<<<<<<<<<<<
 ; 
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*98 SEQ #89^3150103^Code Set FY15 2nd Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*99"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_99.GBL"
 ;     Fiscal Year
 S LEXFY="FY15"
 ;     Quarter
 S LEXQTR="3rd"
