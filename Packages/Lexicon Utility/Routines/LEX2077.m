LEX2077 ;ISL/KER - LEX*2.0*77 Env Check ;07/01/2011
 ;;2.0;LEXICON UTILITY;**77**;Sep 23, 1996;Build 1
 ;               
 ; Global Variables
 ;    ^LEXM
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP="LEX*2.0*76^3110406"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*77"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_77.GBL"
 ;     Fiscal Year
 S LEXFY="FY11"
 ;     Quarter
 S LEXQTR="4th"
