LEX2152 ;ISL/TJH - LEX*2.0*152 Env Check ; 12/08/2024
 ;;2.0;LEXICON UTILITY;**152**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*151 SEQ #142^3240919^CODE SET FY24 4TH QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*152"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_152.GBL"
 ;     Fiscal Year
 S LEXFY="FY25"
 ;     Quarter
 S LEXQTR="2nd"
