LEX2095 ;ISL/KER - LEX*2.0*95 Env Check ;12/09/2013
 ;;2.0;LEXICON UTILITY;**95**;Sep 23, 1996;Build 3
 ;               
 ; Global Variables 
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*94 SEQ #83^3140114^Code Set FY14 2nd Qtr"
 ;     This Build Name
 S LEXBUILD="LEX*2.0*95"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_95.GBL"
 ;     Fiscal Year
 S LEXFY="FY14"
 ;     Quarter
 S LEXQTR="3rd"
