LEX2125 ;ISL/TJH - LEX*2.0*125 Env Check ;02/23/2020
 ;;2.0;LEXICON UTILITY;**125**;Sep 23, 1996;Build 6
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*124 SEQ #115^3191217^CODE SET FY20 2ND QTR UPDATE"  ;seq # from FORUM
 ;     This Build Name
 S LEXBUILD="LEX*2.0*125"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_125.GBL"
 ;     Fiscal Year
 S LEXFY="FY20"
 ;     Quarter
 S LEXQTR="3rd"
