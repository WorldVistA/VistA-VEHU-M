LEX2150 ;ISL/TJH - LEX*2.0*150 Env Check ; 05/23/2024
 ;;2.0;LEXICON UTILITY;**150**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*149 SEQ #140^3240328^CODE SET FY24 3RD QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*150"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_150.GBL"
 ;     Fiscal Year
 S LEXFY="FY24"
 ;     Quarter
 S LEXQTR="4th"
