LEX2145 ;ISL/TJH - LEX*2.0*145 Env Check ; 09/07/2023
 ;;2.0;LEXICON UTILITY;**145**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*144 SEQ #135^3230620^CODE SET FY23 4TH QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*145"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_145.GBL"
 ;     Fiscal Year
 S LEXFY="FY24"
 ;     Quarter
 S LEXQTR="1st"
