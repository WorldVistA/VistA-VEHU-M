LEX2148 ;ISL/TJH - LEX*2.0*148 Env Check ; 01/14/2024
 ;;2.0;LEXICON UTILITY;**148**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*147 SEQ #138^3231923^CODE SET FY24 2ND QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*148"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_148.GBL"
 ;     Fiscal Year
 S LEXFY="FY24"
 ;     Quarter
 S LEXQTR="2nd"
