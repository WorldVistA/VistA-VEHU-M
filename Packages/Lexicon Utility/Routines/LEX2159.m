LEX2159 ;ISL/TJH - LEX*2.0*159 Env Check ; 04/16/2026
 ;;2.0;LEXICON UTILITY;**159**;Sep 23, 1996;Build 2
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*158 SEQ #149^3260128^CODE SET FY26 3RD QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
  ;     This Build Name
 S LEXBUILD="LEX*2.0*159"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_159.GBL"
 ;     Fiscal Year
 S LEXFY="FY26"
 ;     Quarter
 S LEXQTR="3rd"
