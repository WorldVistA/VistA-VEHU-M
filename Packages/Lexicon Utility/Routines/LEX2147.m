LEX2147 ;ISL/TJH - LEX*2.0*147 Env Check ; 12/02/2023
 ;;2.0;LEXICON UTILITY;**147**;Sep 23, 1996;Build 2
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*146 SEQ #137^3231023^CODE SET FY24 1ST QTR INTERIM UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*147"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_147.GBL"
 ;     Fiscal Year
 S LEXFY="FY24"
 ;     Quarter
 S LEXQTR="2nd"
