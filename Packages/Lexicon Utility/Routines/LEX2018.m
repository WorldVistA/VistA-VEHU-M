LEX2018 ;ISA/FJF-Environment Check/Pre/Post Install;11-17-00
 ;;2.0;LEXICON UTILITY;**18**;Sep 23, 1996
 ;
ENV ; LEX*2.0*18 Environment Check
 ;           
 ;   General
 ;
...
CPD(X) ;   Check Current Patched Data is installed
 Q:$D(^LEX(757.1,"B",175533,249661))&('$D(^LEX(757.02,"B",305008,318144))) 1
 Q 0
LPD(X) ;
 ;Q:$D(^LEX(757.1,"B",174388,248489))&('$D(^LEX(757.21,"C","HUMAN PAPILLOMA VIRUS",6815))) 1
 ;Q 0
 ; Error messages
 ;
CM ;   Missing ^LEXM
...
IMP ;   Import names
 ;
 S LEXLREV=7,LEXLAST="LEX*2.0*17",LEXBUILD="LEX*2.0*18"
 S LEXIGHF="LEX_2_P18.GBL"
 Q
