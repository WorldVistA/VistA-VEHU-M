LEX2146 ;ISL/TJH - LEX*2.0*146 Env Check ; 10/08/2023
 ;;2.0;LEXICON UTILITY;**146**;Sep 23, 1996;Build 1
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*145 SEQ #136^3230925^CODE SET FY24 1ST QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*146"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_146.GBL"
 ;     Fiscal Year
 S LEXFY="FY24"
 ;     Quarter
 S LEXQTR="1st"
