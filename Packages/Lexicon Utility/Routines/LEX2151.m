LEX2151 ;ISL/TJH - LEX*2.0*151 Env Check ; 09/04/2024
 ;;2.0;LEXICON UTILITY;**151**;Sep 23, 1996;Build 3
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*150 SEQ #141^3240627^CODE SET FY24 3RD QTR UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*151"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_151.GBL"
 ;     Fiscal Year
 S LEXFY="FY25"
 ;     Quarter
 S LEXQTR="1st"
