LEX2149 ;ISL/TJH - LEX*2.0*149 Env Check ; 03/08/2024
 ;;2.0;LEXICON UTILITY;**149**;Sep 23, 1996;Build 2
 ;
 ; Global Variables
 ;    ^LEXM               N/A
 ;               
...
IMP ;   Import names
 ...
 S LEXREQP(1)="LEX*2.0*148 SEQ #139^3240129^CODE SET FY24 2ND QTR INTERIM UPDATE"  ;seq # from FORUM ; date is release date ; patch subject
 ;     This Build Name
 S LEXBUILD="LEX*2.0*149"
 ;     This Build's Export Global Host Filename
 S LEXIGHF="LEX_2_149.GBL"
 ;     Fiscal Year
 S LEXFY="FY24"
 ;     Quarter
 S LEXQTR="3rd"
