...
SEARCH ;SET UP UTILITY GLOBAL
 ...
 I ZZSM="E" S ZZKD=0 I '$D(^UTILITY($J,"ID")) D NOID
 I ZZSM="E" D NWPG F N1=0:0 S N1=$O(^UTILITY($J,"ID",N1)) Q:N1=""  D FLHD F N2=0:0 S N2=$O(^UTILITY($J,"ID",N1,N2)) Q:N2=""  D @$S(ZZMODE["E":"PRINTE",1:"PRINTC")
EXIT ;EXIT POINT
 I IO(0)'=IO X ^%ZIS("C")
