A4AADMC1 ;HINES-CIOFO/JJM - DELETE DEBTOR FROM DMC 1/12/98 18:15
...
V ;;4.5;Accounts Receivable;**45,108**;Mar 20, 1995
...
COMPILE(MAX,CNTR,LINES,TLINE) ;COMPILES CODESHEETS INTO MAILMAN MESSAGES
 ...
 S X="" F I=3:1:RCNT S X=$O(^XTMP("RCDMC90",$J,"REC",X)),^XTMP("RCDMC90",$J,"REC1",I)=^(X)
