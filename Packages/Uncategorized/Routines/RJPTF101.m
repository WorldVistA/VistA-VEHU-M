RJPTF101 ;RJ WILM DE -MAKE N101 PTF CARD; 12-12-85
 ;;4.0
 ...
 S RJN101=RJN101_$P(^DIC(45.1,Z,0),"^",1),X=5,Y="" S:D'="" Y=D_$P(RJ101,"^",6) D LJ S RJN101=RJN101_Y_$S($P(RJ101,"^",3)'="":$P(RJ101,"^",3),1:" ")
 ...
 S Z=$P(^DGPT(I,0),"^",10) 
ENDR S RJN101="N101"_RJCON_RJN101_Z,Y=RJN101,X=80 D LJ S RJN101=Y K RJ101,D,J,L,X,Y,Z,Z1 Q
