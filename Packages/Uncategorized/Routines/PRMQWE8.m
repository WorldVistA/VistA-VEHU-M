PRMQWE8 ;Chicago ISC/DDA- PRMQ EDIT 8 ;5/29/90  10:38
 ;;1.2;Utilization Review;;
EN1 ; ENTRY POINT FOR OPTION PRMQ EDIT 8, OUTCOME OF BILLING
 ...
 S DR="13;S:X="""" Y="""";S PRMQ(""ROB"")=X;S:X=2 Y=""@2"";13.2///@;S Y=""@3"";@2;13.1///@;@3;13.01;S PRMQ(""AB"")=X;S:PRMQ(""ROB"")'=3 Y=""@4"";13.02///@;@5;13.02"
 S DR(1,513.801,1)="I X>PRMQ(""AB"") W !,""Amount Paid can not be greater than Amount Billed."",*7 S Y=""@5"";@4;S:PRMQ(""ROB"")=1 Y=""@7"";S:PRMQ(""ROB"")=3 Y=""@6"";13.1;S Y=""@7"";@6;13.2;@7;13.3"
