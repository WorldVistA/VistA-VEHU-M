EVETENC ;iscSF/RWF - More Request Broker ; 11/27/02 10:33am
...
DECRYP(S) ;decrypt passed string
 ...
 ;
ENCRYP(S) ;RWF 2/5/96
 ;temp code for tracing - lel
 ;I EVDEBUG=1 S ^TMP("EVET_DEBUG_TR",$O(^TMP("EVET_DEBUG_TR",""),-1)+1)=$H_"*ENCR"_"|"_S
 ;end temp code
 N %,ASSOCIX,IDIX,ASSOCSTR,IDSTR
...
Z ;;
 ...
 ;;sFz0Bo@_HfnK>LR}qWXV+D6`Y28=4Cm~G/7-5A\b9!a#rP.l&M$hc3ijQk;),TvUd<[:I"'NZSOw]*gxtE{eJp|y (?%1u
