A4AA430 ;ISC4/JJM - PROGRAM TO CHECK FILE 430 ; 7/15/99 13:35
...
START ;
 ...
 W !,"JOB STARTED: ",%
 W !,^PRCA(430,0)
 F  S BN=$O(^PRCA(430,BN)) Q:'BN  S CNT=CNT+1 W:(CNT#1000)=0 "." D GETDATA Q:PROMPT=1
EOJ ;
 D NOW^%DTC
 W !,"EOJ- ",CNT,"  ",%
...
EN2 ;
 D HSK
 S STATUS=""
 F  S STATUS=$O(^PRCA(430,"AC",STATUS)) Q:'STATUS  D
 . S BN=0
 . F  S BN=$O(^PRCA(430,"AC",STATUS,BN)) Q:'BN  S CNT=CNT+1 W:(CNT#1000)=0 "." D GETDATA Q:PROMPT=1
 D EOJ
 QUIT
EXIT ;;
 QUIT
