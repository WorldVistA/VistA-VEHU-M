A1CHOSM1 ;ALB/ - OUTPATIENT WORKLOAD SUMMARY, TOTALS ; 3/1/89 1500
 ;;V 1.3
...
TOT W ! F I=30:10:100 W ?I,"======"
 ...
 W ?100,^UTILITY("A1CH","T","C") Q:^UTILITY("A1CH","T","C")=0
 W !,?1,"TOTAL %",?30,$J(^UTILITY("A1CH","T","C",1)/^UTILITY("A1CH","T","C")*100,2,2)
 W ?40,$J(^UTILITY("A1CH","T","C",2)/^UTILITY("A1CH","T","C")*100,2,2)
