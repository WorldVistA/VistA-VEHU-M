...
EXC ;get exception data
 ...
 .S DATA=@SEED,LOC=$P(DATA,U),CIU="",COU="" I LOC="" Q
...
DATA ;get data and set report xtmp
 ...
 S LOC=DSIVD(19625,IEN_",",1.11,"E"),USER=DSIVD(19625,IEN_",",1,"E")
 S INS=DSIVD(19625,IEN_",",.03,"E"),NOINS=$S(INS="NO INSURANCE":1,1:0)
