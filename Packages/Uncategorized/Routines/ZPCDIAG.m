...
ENLP S:$D(C)=0 C=1 S C=C+1 S ^ZSQLINT($J,"CMDLOG",C)=X_"TIME:"_$H
 ...
 I INSTR="SENDFILES" D SENDFILE^ZDDUTIL1 G LEAP ;SEND FILES
 ...
 I INSTR="FILEENT" D ENTRIES^ZDDUTIL1 W "**ENDTX**",1 G LP
CLIN I INSTR="LABRESULT" D LABRES^ZPCUTL1 W "**ENDTX**",! G LP
 ...
 I INSTR="LOGOFF"!(INSTR="QUIT")!(INSTR="EXIT")!(INSTR="exit") G DONE
