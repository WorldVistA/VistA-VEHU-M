...
US13708 ; Reindex allergies and orders for TWOHUNDREDELEVEN & TWOHUNDREDTWELVE
 ...
 Q
 ;
US16440 ; Reindex notes and provider info for TWOHUNDREDONE
 S DIK="^TIU(8925," F DA=12495:1:12498 D IX^DIK
 S DIK="^AUPNVSIT(",DA=12873 D IX^DIK
 S DIK="^SCPT(404.41," F DA=100147,100148 D IX^DIK
 S DIK="^SCPT(404.42," F DA=33,34 D IX^DIK
 S DIK="^SCPT(404.43," F DA=13,14,15 D IX^DIK
 Q
 ;
