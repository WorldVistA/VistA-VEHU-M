A1AXCTS2 ;SLL/ALB ISC; FACILITY RECOMMEND CATEGORY STATISTICS; 3/23/88
 ;;VERSION 1.0
 ;
 S $P(A1AXL,"=",IOM+1)=""
 S A1AXG=1,A1AXU=21 Q:$D(A1AXEND)  D HD,TITLE,PRINT S A1AXG=22,A1AXU=$P(^DIZ(11834,0),"^",4) Q:$D(A1AXEND)  D HD,TITLE,PRINT G:$D(A1AXEND) EXIT
 G EXIT
HD ;
 S X="FACILITY STATISTICS REPORT " S:A1AXOPT="F" X=X_"BY FACILITY" S:A1AXOPT="O" X=X_"BY ORGANIZATION" W #,!!,?(IOM-$L(X)\2),X
...
EXIT1 K AU,AA,AP,AS,AR,II,A1AXF,A1AXO,A1AXL,%DT("A"),%DT("B")
 K I,J,L,A1AXI,A1AXU,A1AXCAT,A1AXG,A1AXSTOP,A1AXOPT,A1AXDT,A1AXWDT,A1AXCT,A1AX1,A1AX2,A1AXST,A1AXCATOP,A1AXEND,A1AXM,A1AXD,^UTILITY($J,"CAT")
 K %DAT,%DAT1,%DT,AN,C,D,POP,X
 K ^UTILITY($J,"LAST")
 Q
