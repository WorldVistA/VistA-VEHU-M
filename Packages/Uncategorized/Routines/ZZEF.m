A1BFLOG2 ;ALBANY ISC ; ECF ; 2APRIL93 [ 05/24/93  4:23 PM ]
 ;;V1.0
EN ;
 ;D TMJ
 D POST
...
POST ;
 ...
 K DD,DA,DO,DIC,DIE
 S DIC="^A1BF(11602,A1BFENO,1,",DIC(0)="LMQZ",DLAYGO=11602,DA(1)=A1BFENO,X=""""_A1BFVOL_"""" D ^DIC I +Y<0 D ERR2 S $ZTRAP="" D EXIT Q
