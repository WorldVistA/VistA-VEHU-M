PRMQWE72 ;Chicago ISC/DDA- PRMQ EDIT 7.2 ;5/10/90  16:49
 ;;1.2;Utilization Review;;
EN1 ; ENTRY POINT FOR OPTION PRMQ EDIT 7.2
 ...
 S DR="10;9.5"
 S DR(2,513.804)="1///^S X=DUZ;10.1;10.3;10.2;S:X=1 PRMQ(""RFCS"")=""CONTINUED STAY CRITERIA MET^NO ACTION REQUIRED"";10.8//^S X="""" S:$D(PRMQ(""RFCS""))#2 X=$P(PRMQ(""RFCS""),""^"");S:X=9 PRMQ(""OTH"")=1"
 S DR(2,513.804,1)="@1;10.9//^S X="""" S:$D(PRMQ(""RFCS""))#2 X=$P(PRMQ(""RFCS""),""^"",2);I X=1&($D(PRMQ(""RFCS""))#2) W !!,""You cannot enter DISCHARGE because CONTINUED STAY CRITERIA has been met."",*7 S Y=""@1"""
 S DR(2,513.804,2)="10.4//^S X="""" S:$D(PRMQ(""RFCS""))#2 X=""NO"";S:X=2!($D(PRMQ(""RFCS""))#2) Y=""@2"";10.5;S:X=""""!(X=""@"") Y=""@2"";10.6;S Y=""@3"";@2;10.5///@;10.6///@;@3"
 S DR(2,513.804,3)="W:$D(PRMQ(""OTH""))#2 !!,""Please explain 'OTHER' reason for continued stay."";2"
