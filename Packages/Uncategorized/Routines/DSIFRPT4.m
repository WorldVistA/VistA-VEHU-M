DSIFRPT4 ;DSS/AMC - OUTPATIENT PAYMENT HISTORY SORT/PRINT ;7/9/2001
 ...
 ;  2056  $$GET1^DIQ
 ;  5080  FBCKT^FBAACCB0
 ;  5081  FBCKO^FBAACCB2,PMTCLN^FBAACCB2
 ;  5085  $$ADJLRA^FBAAFA
 ;  5086  $$RRL^FBAAFR
 ...
 ;  5098  $$ICD9EX^FBCSV1
 ;
EN ;entry point     (Cloned from FBPAY21)
...
WMSG ;write message if no matches found
 S XX="" D LN S XX="There are no outpatient payments on file for specified date range"
 I 'FBPROG D LN S $E(XX,3)=" and selected Fee programs"
 S XX=XX_"." D LN,LN
 Q
LN ;
