A1ATSUM2 ;TRAVEL PACKAGE ; JCK/ALB ; 8 APRIL 88
 ;This routine will run print routines to calculate travel totals per quarter.
 ;
...
A1SEL S ^UTILITY("A1AT","QUARTER")=A1ATMSAV S A1TEMP=$S(A1ATMSAV=1:"[A1ATFQ12]",A1ATMSAV=2:"[A1ATFQ22]",A1ATMSAV=3:"[A1ATFQ32]",A1ATMSAV=4:"[A1ATFQ42]",1:"[A1ATMSAV]")
 ;
A1PRINT W !!,"Please wait a few seconds ... ",!! S L="0",DIC="^DIZ(11003,",FLDS="[A1ATFQPRINT2]",BY=A1TEMP D EN1^DIP
 ;
QUIT Q
 ;
