RJPTF40Z ;RJ WILM DE **NOT USED**-MAKE 40X PTF CARD; 12-12-85
 ;;4.0
...
N40X S RJPTF=^DGPT(I,"S",Z1,0) I $P(RJPTF,"^",2)="P" S @RJN401="N401"_RJCON_"P           " D CODE S Y=@RJN401,X=80 D LJ S @RJN401=Y,RJN401="N403("_K_")",@RJN401="N403" D SSN Q
 E  D S
 D CODE I '$D(Z(Z)) S Z(Z)="",XX="N401"
 E  S XX="N402"
 S @RJN401=XX_RJCON_@RJN401,Y=@RJN401,X=80 D LJ S @RJN401=Y I XX="N401" S RJN401="N403("_K_")",@RJN401="N403" D SSN Q
 I XX="N402" S RJN401="N404("_K_")",@RJN401="N404" D SSN
 Q
...
P S X=6,K=K+1,RJN401="N401("_K_")",@RJN401="N401"_RJCON_"P           "
...
SSN S X=$P(^DIC(16,$P(^DGPT(I,"S",Z1,460000),"^",1),0),"^",9),@RJN401=@RJN401_RJCON_$E(Z,4,7)_$E(Z,2,3)_X
 S Y=@RJN401,X=80 D LJ S @RJN401=Y Q
