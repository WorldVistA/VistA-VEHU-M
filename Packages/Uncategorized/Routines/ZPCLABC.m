ZPCLABC ;PROGRAM TO GET ALL INR VALUES FOR PATIENT IN THE INR CLINIC
 ;CORRELATE A CLINIC WITH A LAB VALUE - CHANGE THE CODE TO TEST AND CLINIC
 ;COPYRIGHT 1997 Pittsburgh Veterans Research Corporation
 ;AMT 1/6/97
 ;BCP VARIABLE NEEDS TO BE 1 FOR BCP OUTPUT
START ;
...
LABRES ;GET LAB RESULTS
 ;% IS A WILD CARD
 S TEST="INR%",NOOUTP=1 D LAB^ZPCMBCP1
 F I=1:1:CNTTEST D  ;
