PRMQWE2 ;Chicago ISC/DDA- PRMQ EDIT 2 ;5/25/90  11:54
 ;;1.2;Utilization Review;;
EN1 ; ENTRY POINT FOR OPTION PRMQ EDIT 2, SEVERITY/INTENSITY/DISCHARGE
 ...
 S DR="1.2;10;9.5"
 S DR(2,513.804)="1///^S X=DUZ;3;S:X=2 Y=""@1"";@2;3.11;S PRMQ(""SEV"")=X;3.12;S PRMQ(""INT"")=X;3.13"
 S DR(2,513.804,1)="I (X=1)&((PRMQ(""SEV"")=1)!(PRMQ(""INT"")=1)) W !!,""You cannot enter YES for 'Discharge Screen Met' if either 'Severity Criteria'"",!,""or 'Intensity Criteria' are MET."",*7 S Y=""@2"";@1;2"
