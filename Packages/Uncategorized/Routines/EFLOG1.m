A1BFLOG1 ;ALBANY ISC;ECF;17MAR92;13:10pm [ 04/02/93  9:52 AM ]
 ;;V1.0
EN ;Logon routine
 D EN^A1BFCHK1
 K A1BFOUCH
 ...
 D PARR I A1BFOUCH G EXIT
 D READ
 D EXIT
 D POST^A1BFLOG2
 U IO(0) W !!!,"STARTING OVER" G EN
SETUP ;
 S A1BFOUCH=0
...
OPEN ;
 ...
 Q
PARR ;
 F I=1:1:10 S A1BFTXT=$T(TEXT+I) Q:A1BFTXT=""  S A1BFPRMT($E($P(A1BFTXT,";",3),$L($P(A1BFTXT,";",3))-11,$L($P(A1BFTXT,";",3))))=$P(A1BFTXT,";",4)_"^"_$P(A1BFTXT,";",5)
 Q
READ ;
