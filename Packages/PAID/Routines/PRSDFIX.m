PRSDFIX ;HISC/GWB-CHANGE IEN OF INDIVIDUAL FILE 450 ENTRY ;05/05/94  10:00
...
D1 D 450,455,458,4581,4582,4583,4585,459
...
455 ;Convert 455 file entries
 ...
 .S TLU=$P(^PRST(455,PP,1,NEWIEN,0),"^",7)
 .S NAME=$P(^PRSPC(NEWIEN,0),"^",1)
 .S ^PRST(455,"ATL",TLU,NAME,NEWIEN)=""
 .K ^PRST(455,"ATL",TLU,NAME,OLDIEN)
 Q
...
459 ;Convert 459 file
 ...
 Q
CHECK S IEN1=0 F I=1:1 S IEN1=$O(^PRSPC(IEN1)) Q:IEN1'>0  W:I#100=0 "." D
 .S SSN450=$P(^PRSPC(IEN1,0),"^",9)
 .S SSN200="" S:$D(^VA(200,IEN1,1)) SSN200=$P(^VA(200,IEN1,1),"^",9)
 .S IEN2=0,IEN2=$O(^VA(200,"SSN",SSN450,IEN2))
 .I SSN450'=SSN200 D
 ..W !!,"450 IEN = ",IEN1,?18,"450 SSN = ",SSN450,?39,"200 IEN = ",IEN2
 ..W !,?18,"200 SSN = ",SSN200
 D KILL^XUSCLEAN Q
FIX S IEN1=0 F I=1:1 S IEN1=$O(^PRSPC(IEN1)) Q:IEN1'>0  W:I#100=0 "." D
 .S SSN450=$P(^PRSPC(IEN1,0),"^",9)
 .S SSN200="" S:$D(^VA(200,IEN1,1)) SSN200=$P(^VA(200,IEN1,1),"^",9)
 .S NEWIEN=0,NEWIEN=$O(^VA(200,"SSN",SSN450,NEWIEN))
 .I SSN450'=SSN200,NEWIEN'="" D
 ..I $D(^PRSPC(NEWIEN)) W "   This IEN already being used" Q
 ..W !!,"Converting PAID EMPLOYEE entry ",IEN1
 ..S OLDIEN=IEN1 N I,IEN1 D D1
 D KILL^XUSCLEAN Q
