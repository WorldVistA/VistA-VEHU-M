WEBG017P ; SLC/JAS - WEBG*3*17 Post Init Routine; Nov 2, 2023@12:30 PM
 ;;3.0;WEB VISTA REMOTE ACCESS MANAGEMENT;**17**;Apr 06, 2021;Build 3
...
POST ; Post-Installation Process 
 ...
 ;
 S UPERR=0
 F RPCNAME="WEBG VERIFY CODE EXP DATE" D ADDRPC(.ADDERR,OPTIEN,RPCNAME) I ADDERR S UPERR=1
 ;
 I UPERR D  Q
 . D MES^XPDUTL("")
 . D MES^XPDUTL("")
