LR150 ;DALISC/CKA - LR*5.2*150 PATCH ENVIRNMENT CHECK ROUTINE
 ;;5.2;LAB SERVICE;**150**;Jan 15, 1997
...
CHECK I $S('$G(IOM):1,'$G(IOSL):1,$G(U)'="^":1,1:0) W !,$$CJ^XLFSTR("Terminal Device is not defined",80),!! S XPDQUIT=2 Q
 ...
 S RN="LRARU"
 X "ZL @RN S LN2=$T(+2)" I LN2'["**59" W !,$$CJ^XLFSTR("It appears that Patch 'LR*5.2*59' has not been installed",80),! S XPDQUIT=2 Q
 Q
