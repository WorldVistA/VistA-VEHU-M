LR171 ;DALISC/SED - LR*5.2*171 PATCH ENVIRNMENT CHECK ROUTINE
 ;;5.2;LAB SERVICE;**171**;Sep 27, 1994
...
CHECK I $S('$G(IOM):1,'$G(IOSL):1,$G(U)'="^":1,1:0) W !,$$CJ^XLFSTR("Terminal Device is not defined",80),!! S XPDQUIT=2 Q
 ...
 S RN="LRVER3"
 X "ZL @RN S LN2=$T(+2)" I LN2'["140" W !,$$CJ^XLFSTR("It appears that Patch 'LR*5.2*140' has not been installed",80),! S XPDQUIT=2 Q
 S RN="LRVER4"
 X "ZL @RN S LN2=$T(+2)" I LN2'["140" W !,$$CJ^XLFSTR("It appears that Patch 'LR*5.2*140' has not been installed",80),! S XPDQUIT=2 Q
 Q
