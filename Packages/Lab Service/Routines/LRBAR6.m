LRBAR6 ;SLC/RAF ;INTERMEC 4100 2 LABEL FORMAT 8/29/94  12:36
 ;;5.2;LAB SERVICE;;Sep 27, 1994
 ;This routine will program the Intermec 4100 for two label formats
 ;which can be used with LRLABEL6 routine to print one normal label
...
ZIS K %ZIS S %ZIS="QN" D ^%ZIS I POP W !?7,*7,"NO DEVICE SELECTED ",! D ^%ZISC Q
 S ZTIO=ION,ZTDTH=$H,ZTDESC="BAR CODE FORMAT DOWN LOAD",ZTRTN="BAR^LRBAR6" D ^%ZTLOAD
