LRVR4 ;DALOI/CJS/DALOI/FHS - LAB ROUTINE DATA VERIFICATION; Jul 30, 2024@13:42
 ;;5.2;LAB SERVICE;**14,42,121,153,221,263,279,283,287,286,330,350,574**;Sep 27, 1994;Build 1
 ;
 I $D(LRSBCOM) D
 . N LRX
 . S LRX=0
...
NR I $D(LRSB(LRSB))#2 D
 ...
 . ;LR*5.2*574 ADDED LEDI CHECK IN LINE BELOW
 . I $P(LRSB(LRSB),U,9)=""!($P($G(LRLK),U,12)=10) S $P(LRSB(LRSB),U,9)=$S($G(LRDUZ(2)):LRDUZ(2),$G(DUZ(2)):DUZ(2),1:"")
