LR170 ;DAL/HOAK-LAB PATCH ENVIRNMENT CHECK ROUTINE  ;7/8/97  07:30 ;
 ;;5.2;LAB SERVICE;**170**;Sep 27, 1994
...
CHECK I $S('$G(IOM):1,'$G(IOSL):1,$G(U)'="^":1,1:0) W !,$$CJ^XLFSTR("Terminal Device is not defined",80),!! S XPDQUIT=2 QUIT
 ...
 I VER'>5.1 W !,$$CJ^XLFSTR("You must have LAB V5.2 Installed",80),! S XPDQUIT=2 QUIT
 Q
