LRSORA2 ;SLC/KCM/DALISC/DRH - SEARCH LAB DATA AND PRINT REPORT ;8/28/89  12:07 ; [ 04/18/95  4:42 PM ]
 ;;5.2;LAB SERVICE;**2**;Sep 27, 1994
START ;
 D BUILD^LRSORA3
...
PRTEST ;
 ...
 W ?35,LRMRK,?42,$E(LRCDT,1,6)_" '"_$E($P(LRCDT,",",2),4,5)
 W " at ",$P(LRCDT,"@",2)
 W ?64,LRLOC,!
 Q:$G(LREND)!(LRTOP)
 Q
