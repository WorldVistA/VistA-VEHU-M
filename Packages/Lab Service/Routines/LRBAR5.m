LRBAR5 ;SLC/JL/RAF ; INTERMEC 4100 10 PART LABEL FORMAT 8/29/94 12:36 [ 06/25/96  8:27 AM ]
...
ZIS S %ZIS="QN" D ^%ZIS I POP W ?20,*7,"NO DEVICE SELECTED " Q
 S ZTIO=ION,ZTDTH=$H,ZTDESC="BAR CODE FORMAT DOWN LOAD",ZTRTN="BAR^LRBAR5" D ^%ZTLOAD Q
