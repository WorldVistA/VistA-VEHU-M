LRZRP5 ;DALISC/JBM - COLLECTION REPORT ;10/20/92 [ 02/06/96  10:30 AM ]
...
DATE ;
 ...
 S LRODT=Y,LRODAT=$E(LRODT,4,5)_"/"_$E(LRODT,6,7)_"/"_$E(LRODT,2,3)
REPTYP ;
 W !,"REPORT selection: "
...
PROCESS ;For ea. specimen on date selected
 ...
 .;name/ssn
 .S DIC=63,DIC(0)="NXZ",X=LRDFN D ^DIC Q:Y=-1
 ...
 .S DIC=62,DIC(0)="NXZ",X=LRCS D ^DIC Q:Y=-1
 .S LRCS1=$P(Y(0),U)
 .;location
 .S DIC=44,DIC(0)="NXZ",X=LRLOC D ^DIC Q:Y=-1
 ...
 ..S LRREC=$G(^LRO(69,LRODT,1,LRSN,2,LRTN,0)) Q:LRREC=""
 ..S:LRREC=27
 ..S DIC=60,DIC(0)="NXZ",X=$P(LRREC,U) D ^DIC Q:Y=-1
 ..S LRTST=$P(Y,U,2),LRIFN=+Y,LRPNAM=$P($G(^LAB(60,LRIFN,.1)),U)
 ..S:LRPNAM'="" LRTST=LRPNAM
 ..S LRTST=$E(LRTST,1,7)
 ..S DIC=62.05,DIC(0)="NXZ",X=$P(LRREC,U,2) D ^DIC Q:Y=-1
...
WRAPUP ;
 ...
 K LRLCNT,LRBUF,LRBLANK,LRCS3,LRRPT
 Q
QUE ;
