MPIFVER ;ALB/CKN - VISTA ENTERPRISE REGISTRATION ; 7/26/17 2:18pm
 ;;1.0;MASTER PATIENT INDEX VISTA;**61,62,65,66,67,79,81**;30 Apr 99;Build 1
 Q
...
EXDISP(XCNT) ;Extended display for selected patient **79 (cmc) VAMPI-16603 INCLUDE CORRESPONDENCE AND WORK ADDRESS, CELL AND WORK PHONE
 ...
 N FNAME,LNAME,MNAME,PNAME,CITY,COUNTRY,DOB,GENDER,ICN,L1,L2,L3,MMN,PCODE,DOD
 ...
 S PNAME=$G(RESULTS(XCNT,"PreferName"))  ;81 VAMPI-34893 (jfw) - Add Preferred Name to Display
 ...
 W !,?5,"Preferred",?17,": "_PNAME  ;81 VAMPI-34893 (jfw) - Add Preferred Name to Display
 W !,?5,"SSN",?17,": "_SSN
