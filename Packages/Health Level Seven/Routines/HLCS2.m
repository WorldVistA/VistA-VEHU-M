HLCS2 ;SF/JC - More Communication Server utilities ; 08/05/2011  11:22
 ;;1.6;HEALTH LEVEL SEVEN;**14,40,43,49,57,58,82,84,109,122,157,179**;Oct 13, 1995;Build 5
...
PARAM() ;Return HL7 site parameters
 ...
 ; patch HL*1.6*179: check for valid entry in file 3.8
 ; S HLMAILP=$P(HLX,U,5) I HLMAILP S HLMAILN=$P(^XMB(3.8,HLMAILP,0),U)
 S HLMAILP=$P(HLX,U,5) I HLMAILP,$D(^XMB(3.8,HLMAILP)) S HLMAILN=$P(^XMB(3.8,HLMAILP,0),U)
