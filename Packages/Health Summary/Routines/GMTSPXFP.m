GMTSPXFP ; SLC/SBW,KER,PKR - PCE Health Factors Component ; 02/08/2019
 ;;2.7;Health Summary;**8,10,28,56,58,62,69,82,110,122**;Oct 20, 1995;Build 71
 ;
 ; External References
...
HFDSP(WDATE,GMIFN) ; Display Data
 ...
 E  D LONGTEXT(TEXT)
 I $D(^TMP("PXF",$J,GMHFC,GMDT,GMHF,GMIFN,"MEASUREMENT")) D
 . N MEAS
