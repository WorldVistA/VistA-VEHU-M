GMRCIMSG ;SLC/JFR - IFC MESSAGE HANDLING ROUTINE; 09/26/02 00:23
 ;;3.0;CONSULT/REQUEST TRACKING;**22,28,51,44,154**;DEC 27, 1997;Build 135
 ;
 ; Reference to EN^RMPRFC3 supported by ICR #4661
 ;
...
IN ;process incoming message and save segments to ^TMP(
 ...
 N GMRCI,TCH,TEXTIN,TEXTOUT,TEXTRM ;MKN GMRC*3*154
