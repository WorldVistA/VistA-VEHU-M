GMRCICMT ;SLC/JFR - IFC Possible Erroneous Comments Report; Mar 15,2023@09:01:03
 ;;3.0;CONSULT/REQUEST TRACKING;**193,199**;DEC 27, 1997;Build 52
 ;
 ;
 Q
EN ; Main
 ...
 N ACTCNT,TOTCNT,ACTTYPE,PTNM,PTSSN,REMSIT,ZTQUEUED,ZTREQ,GIDX,GMRCODT,GMRCNM
...
MAKERPT(GMBEG) ;
 ...
 ; ^TMP("GMRCICMT",$J,SITE,CSLT,GMRCACT,0)="" <-- Selected IFCs
 ...
 K ^TMP("GMRCICMT",$J),^TMP("GMRCICMT",$J)
 Q
GETIFCS ; Get IFCs
