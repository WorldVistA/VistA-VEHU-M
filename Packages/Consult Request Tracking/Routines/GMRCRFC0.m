GMRCRFC0 ;EHRM/JCH - Process IFC HL7 Messages; 03/02/20 09:23
 ;;3.0;CONSULT/REQUEST TRACKING;**154**;DEC 27, 1997;Build 135
 ;
 ; Reference to ^RMPR(668 supported by ICR #7131
 ;
 Q
...
TST ;
 ...
 I RMPRST="NW" I $D(^RMPR(668,"D",RMPR123A)) D EXIT Q
...
CANCEL(DA) ;cancel suspense (EHRM)
 ...
 I '$G(^RMPR(668,+$G(DA),0)) Q
 I $P(^RMPR(668,DA,0),U,5)'="" Q
 S RMPRDA=DA_","
