DVBUTIL ;ALB/CP/JD/BG - CAPRI UTILITIES RPCS; June 23, 2023@10:20 ; 9/22/25 1:02pm
 ;;2.7;AMIE;**252,254,255,256**;Apr 10, 1995;Build 19
...
SIGFLDNUM(DVBRTN) ;
 ...
 Q
IEPDCHECK(DVBRTN) ;
 ;RPC: DVBA CAPRI CMT IEPD FLDR CHCK
 ;CAPRI-28119 PLE 6/22/2026
 N DVBPAR
 S DVBPAR=$$GET^XPAR("PKG","DVBAB CAPRI CMT IEPD FLDR CHCK",1,"I")
 I ($G(DVBPAR)="") S DVBPAR="-1^DVBAB CAPRI CMT IEPD FLDR CHCK's value is null."
 S DVBRTN=$TR(DVBPAR,"!","^")
 Q
XMLRAP(DVBRTN) ;
 ;RPC: DVBA CAPRI XML RAP COMP
 ;CAPRI-28721 CP 7/20/26
 N DVBLIST,DVBCNT,DVBI
 D GETLST^XPAR(.DVBLIST,"PKG.AUTOMATED MED INFO EXCHANGE","DVBAB CAPRI XML RAP COMP","I",)
 S DVBCNT=$G(DVBLIST)
 I DVBCNT=0 S DVBRTN(0)="-1^Parameter Empty" Q
 F DVBI=1:1:DVBCNT S DVBRTN(DVBI)=$TR($G(DVBLIST(DVBI)),"!","^")
 Q
