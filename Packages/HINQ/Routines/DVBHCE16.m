...
37 D:$D(DG)>9 F^DIE17,DE S DQ=37,DW=".35;1",DV="DXa",DU="",DIFLD=.351,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C37^DVBHCE16",DE(DW,"INDEX")=1
 S X=Z1
 S Y=X
 S X=Y,DB(DQ)=1 G:X="" N^DIE17:DV,A I $D(DE(DQ)),DV["I"!(DV["#") D E^DIE0 G A:'$D(X)
 G RD
...
C37F1 N X,X1,X2 S DIXR=156 D C37X1(U) K X2 M X2=X D C37X1("O") K X1 M X1=X
 D
...
C37X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C37F2 S DIXR=729 D C37X2(U) K X2 M X2=X D C37X2("O") K X1 M X1=X
 D
 . D FC^DGFCPROT(.DA,2,.351,"KILL",$H,$G(DUZ),.X,.X1,.X2,$G(XQY0)) Q
 K X M X=X2 D
 . D FC^DGFCPROT(.DA,2,.351,"SET",$H,$G(DUZ),.X,.X1,.X2,$G(XQY0)) Q
...
C37X2(DION) K X
 ...
 S X=$G(X(1))
 Q
C37F3 S DIXR=1412 D C37X3(U) K X2 M X2=X D C37X3("O") K X1 M X1=X
 K X M X=X2 D
...
X54 D POW^DVBHUTIL
 Q
55 D:$D(DG)>9 F^DIE17 G ^DVBHCE19
