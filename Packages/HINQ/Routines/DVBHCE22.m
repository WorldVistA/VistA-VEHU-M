...
C20S S X="" G:DG(DQ)=X C20F1 K DB
 D ^DVBHCE24
C20F1 N X,X1,X2 S DIXR=156 D C20X1(U) K X2 M X2=X D C20X1("O") K X1 M X1=X
 D
...
C20X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C20F2 S DIXR=729 D C20X2(U) K X2 M X2=X D C20X2("O") K X1 M X1=X
 D
 . D FC^DGFCPROT(.DA,2,.351,"KILL",$H,$G(DUZ),.X,.X1,.X2,$G(XQY0)) Q
 K X M X=X2 D
 . D FC^DGFCPROT(.DA,2,.351,"SET",$H,$G(DUZ),.X,.X1,.X2,$G(XQY0)) Q
...
C20X2(DION) K X
 ...
 Q
C20F3 Q
X20 S %DT="PX" D ^%DT S X=Y K:Y<1 X I $D(X) D H^DGUTL K:X>DGTIME X K DGTIME,DGDATE I $D(X) S DFN=DA D DEATH^DGLOCK
 Q
 ;
...
X26 I '$D(DVBSICK) S Y="@25",JP=JP+1
 Q
27 D:$D(DG)>9 F^DIE17 G ^DVBHCE25
