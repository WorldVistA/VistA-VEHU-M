...
DE S DIE="^DPT(",DIC=DIE,DP=2,DL=1,DIEL=0,DU="" K DG,DE,DB Q:$O(^DPT(DA,""))=""
 I $D(^(.32)) S %Z=^(.32) S %=$P(%Z,U,9) S:%]"" DE(6)=% S %=$P(%Z,U,10) S:%]"" DE(5)=% S %=$P(%Z,U,11) S:%]"" DE(3)=% S %=$P(%Z,U,12) S:%]"" DE(4)=% S %=$P(%Z,U,13) S:%]"" DE(7)=% S %=$P(%Z,U,19) S:%]"" DE(1)=% S %=$P(%Z,U,20) S:%]"" DE(14)=%
 K %Z Q
 ;
W W !?DL+DL-2,DLB_": "
 Q
...
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW=".32;11",DV="RDX",DU="",DLB="NTL-EOD",DIFLD=.3292
 S DE(DW)="C3^DVBHCE4",DE(DW,"INDEX")=1
 G RE
...
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW=".32;12",DV="RDX",DU="",DLB="NTL-RAD",DIFLD=.3293
 S DE(DW)="C4^DVBHCE4",DE(DW,"INDEX")=1
 G RE
...
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,DW=".32;10",DV="P23'X",DU="",DLB="NTL-Bran. Ser.",DIFLD=.3291
 S DE(DW)="C5^DVBHCE4",DE(DW,"INDEX")=1
 S DU="DIC(23,"
 G RE
...
C5S S X="" G:DG(DQ)=X C5F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 ;
C5F1 N X,X1,X2 S DIXR=400 D C5X1(U) K X2 M X2=X D C5X1("O") K X1 M X1=X
 D
...
X10 I $O(^DPT(D0,.3216,"B",0)) W !!,*7,?17,DVBON,"Authoritative data, can't edit   <RET>",DVBOFF X DVBLIT1 R DVBZ:DTIME K DVBZ S Y="@33"
 Q
11 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=11 D X11 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X11 I '$D(^DPT(D0,.32)) W !!,*7,?17,DVBON,"No NTLast episode can't edit NNTLast   <RET>",DVBOFF X DVBLIT1 R DVBZ:DTIME K DVBZ S Y="@33"
 Q
12 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=12 D X12 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X12 I $P(^DPT(D0,.32),U,19)'="Y" W !!,*7,?17,DVBON,"No NTLast episode can't edit NNTLast   <RET>.",DVBOFF X DVBLIT1 R DVBZ:DTIME K DVBZ S Y="@33"
 Q
13 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=13 D X13 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X13 S DVBSCR=1 D ^DVBHS4 W !,?34,DVBON,"[NNTLAST]",DVBOFF X DVBLIT1
 Q
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW=".32;20",DV="RSX",DU="",DLB="Service NNTL Episode",DIFLD=.32945
 S DE(DW)="C14^DVBHCE4"
 S DU="Y:YES;N:NO;"
 G RE
...
C14S S X="" G:DG(DQ)=X C14F1 K DB
 D ^DVBHCE6
C14F1 Q
X14 S DFN=DA D SV^DGLOCK I "N"'[$G(X),$D(^DPT(DFN,.32)),$P(^(.32),U,19)'="Y" W !?4,*7,"Other Periods of service are not indicated...NO EDITING!" K X
 Q
 ;
15 D:$D(DG)>9 F^DIE17,DE S Y=U,DQ=15 D X15 D:$D(DIEFIRE)#2 FIREREC^DIE17 G A:$D(Y)[0,A:Y=U S X=Y,DIC(0)="F",DW=DQ G OUT^DIE17
X15 I $P(^DPT(D0,.32),U,20)'="Y" S Y="@33"
 Q
16 D:$D(DG)>9 F^DIE17 G ^DVBHCE7
