...
1 D:$D(DG)>9 F^DIE17,DE S DQ=1,DW=".362;12",DV="SX",DU="",DIFLD=.36205,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C1^DVBHCE8"
...
X1 S DFN=DA D MV^DGLOCK I $D(X) S DFN=DA D EV^DGLOCK
 Q
 ;
2 D:$D(DG)>9 F^DIE17,DE S DQ=2,DW=".362;13",DV="SX",DU="",DIFLD=.36215,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C2^DVBHCE8"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
X2 S DFN=DA D MV^DGLOCK I $D(X) S DFN=DA D EV^DGLOCK
 Q
 ;
3 D:$D(DG)>9 F^DIE17,DE S DQ=3,DW=".362;14",DV="SX",DU="",DIFLD=.36235,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C3^DVBHCE8"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
X3 S DFN=DA D MV^DGLOCK
 Q
 ;
4 D:$D(DG)>9 F^DIE17,DE S DQ=4,DW=".3;11",DV="SX",DU="",DIFLD=.3025,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C4^DVBHCE8"
 S DU="Y:YES;N:NO;U:UNKNOWN;"
 G RE
...
X4 S DFN=DA D MV^DGLOCK I $D(X),X="Y" D EC^DGLOCK1
 Q
 ;
5 D:$D(DG)>9 F^DIE17,DE S DQ=5,DW=".362;20",DV="NJ8,2X",DU="",DIFLD=.36295,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
 S DE(DW)="C5^DVBHCE8"
 G RE
...
C5S S X="" G:DG(DQ)=X C5F1 K DB
 ...
 D AUTOUPD^DGENA2(DA)
C5F1 Q
X5 D DOL^DGLOCK2 K:+X'=X&(X'?.N1"."2N)!(X>999999.99)!(X<0) X I $D(X) S DFN=DA D MV^DGLOCK I $D(X),('$$TOTCHK^DGLOCK2(DFN)) D TOTCKMSG^DGLOCK2 K X
 Q
 ;
6 S DQ=7 ;@2062
...
X9 S DVBJ2=1
 Q
10 D:$D(DG)>9 F^DIE17,DE S DQ=10,DW=".11;1",DV="FaXJ35",DU="",DIFLD=.111,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C10F1 N X,X1,X2 S DIXR=251 D C10X1(U) K X2 M X2=X D C10X1("O") K X1 M X1=X
 D
...
C10X1(DION) K X
 ...
 Q
C10F2 Q
X10 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>35!($L(X)<3) X D:$D(X) UP^DGHELP
 I $D(X),X'?.ANP K X
 Q
 ;
11 D:$D(DG)>9 F^DIE17,DE S DQ=11,DW=".11;2",DV="Fa",DU="",DIFLD=.112,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C11F1 N X,X1,X2 S DIXR=253 D C11X1(U) K X2 M X2=X D C11X1("O") K X1 M X1=X
 D
...
X11 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>30!($L(X)<3) X D:$D(X) UP^DGHELP
 ...
 Q
 ;
12 D:$D(DG)>9 F^DIE17,DE S DQ=12,DW=".11;3",DV="FaXJ30",DU="",DIFLD=.113,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C12S S X="" G:DG(DQ)=X C12F1 K DB
 D ^DVBHCE9
C12F1 N X,X1,X2 S DIXR=254 D C12X1(U) K X2 M X2=X D C12X1("O") K X1 M X1=X
 D
...
C12X1(DION) K X
 ...
 Q
C12F2 Q
X12 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>30!($L(X)<3) X D:$D(X) UP^DGHELP
 I $D(X),X'?.ANP K X
 Q
 ;
13 D:$D(DG)>9 F^DIE17,DE S DQ=13,DW=".11;4",DV="FaXJ15",DU="",DIFLD=.114,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C13S S X="" G:DG(DQ)=X C13F1 K DB
 D ^DVBHCE11
C13F1 N X,X1,X2 S DIXR=255 D C13X1(U) K X2 M X2=X D C13X1("O") K X1 M X1=X
 D
...
C13X1(DION) K X
 ...
 Q
C13F2 Q
X13 K:$L(X)>15!($L(X)<2) X D:$D(X) UP^DGHELP
 I $D(X),X'?.ANP K X
 Q
 ;
14 D:$D(DG)>9 F^DIE17,DE S DQ=14,DW=".11;5",DV="*P5'a",DU="",DIFLD=.115,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C14S S X="" G:DG(DQ)=X C14F1 K DB
 D ^DVBHCE13
C14F1 N X,X1,X2 S DIXR=256 D C14X1(U) K X2 M X2=X D C14X1("O") K X1 M X1=X
 D
...
X14 S DIC("S")="I $P(^DIC(5,Y,0),U,6)=1" D ^DIC K DIC S DIC=DIE,X=+Y K:Y<0 X
 Q
 ;
15 D:$D(DG)>9 F^DIE17,DE S DQ=15,DW=".11;12",DV="FXOa",DU="",DIFLD=.1112,DLB=$$LABEL^DIALOGZ(DP,DIFLD)
...
C15S S X="" G:DG(DQ)=X C15F1 K DB
 D ^DVBHCE15
C15F1 N X,X1,X2 S DIXR=157 D C15X1(U) K X2 M X2=X D C15X1("O") K X1 M X1=X
 D
...
C15X1(DION) K X
 ...
 S X=$G(X(1))
 Q
C15F2 S DIXR=252 D C15X2(U) K X2 M X2=X D C15X2("O") K X1 M X1=X
 D
...
X15 K:X[""""!($A(X)=45) X I $D(X) K:$L(X)>20!($L(X)<5) X I $D(X) D ZIPIN^VAFADDR
 ...
 Q
 ;
16 D:$D(DG)>9 F^DIE17 G ^DVBHCE16
