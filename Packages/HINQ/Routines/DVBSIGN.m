DVBSIGN ;ALB/CP - CAPRI Signature RPCS; July, 2 2024@08:34 ; 7/2/24 8:35am
 ;;2.7;AMIE;**252,254,256**;Apr 10, 1995;Build 19
 ...
 ; Reference to File#200 in ICR #713,#10060
 ;
 Q
 ;
...
DOCMAN(DVBRTN,DVBIEN) ;
 ...
 N DVBTRAINEE,DVBEXAMIEN,DVBTRAINEEX,DVBFDA,DVBERR
 S DVBRTN="1"
 I $G(DVBIEN)="" S DVBRTN="-1^No Worksheet IEN sent" Q
 I $D(^DVB(396.17,DVBIEN))<10 S DVBRTN="-1^Invalid Worksheet IEN" Q
 S DVBTRAINEE=$P($G(^DVB(396.17,DVBIEN,16)),U,1),DVBTRAINEEX=$$GET1^DIQ(200,DVBTRAINEE,.01)
 ;CAPRI-19448:NGC - Start
 S DVBFDA(396.17,DVBIEN_",",2)=DVBTRAINEE
 S DVBEXAMIEN=""
 F  S DVBEXAMIEN=$O(^DVB(396.17,DVBIEN,10,"B",DVBEXAMIEN)) Q:(DVBEXAMIEN="")  D
 . S DVBFDA(396.4,DVBEXAMIEN_",",.07)=DVBTRAINEEX
 K DVBERR D FILE^DIE("","DVBFDA","DVBERR")
 I $D(DVBERR) S DVBRTN="-1^"_$G(DVBERR("DIERR",1,"TEXT",1),"Unspecifed Error")
 Q
 ;
