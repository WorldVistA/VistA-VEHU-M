...
12 D:$D(DG)>9 F^DIE17,DE S DQ=12,DW=".52;5",DV="RSX",DU="",DLB="POW STATUS INDICATED?",DIFLD=.525
 S DE(DW)="C12^DVBHCE25",DE(DW,"INDEX")=1
...
C12S S X="" G:DG(DQ)=X C12F1 K DB
 ...
 S X=DG(DQ),DIC=DIE
 D EVENT^IVMPLOG(DA)
C12F1 N X,X1,X2 S DIXR=556 D C12X1(U) K X2 M X2=X D C12X1("O") K X1 M X1=X
 D
...
X23 I '$D(DVBEI) S Y="@50",JP=JP+1
 Q
24 D:$D(DG)>9 F^DIE17 G ^DVBHCE28
