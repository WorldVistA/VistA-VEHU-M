FBCTV ; GENERATED FROM 'FB VENDOR UPDATE' INPUT TEMPLATE(#1512), FILE 161.2;05/01/07
 D DE G BEGIN
...
BEGIN S DNM="FBCTV",DQ=1
 ...
 M DIEZAR=^DIE(1512,"AR") S DICRREC="TRIG^DIE17"
 S:$D(DTIME)[0 DTIME=300 S D0=DA,DIIENS=DA_",",DIEZ=1512,U="^"
