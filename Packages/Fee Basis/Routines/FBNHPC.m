FBNHPC ;AISC/GRR-POST COMMITMENTS TO 1358 ;1DEC00
 ;;3.5;FEE BASIS;**25,153,162,194,195**;JAN 30, 1995;Build 4
 ...
 ;
 N %,DIC,FBIN7078
 I $D(^XUSEC("FBAASUPERVISOR",DUZ)) D   ;IF SUPERVISOR THEY CAN DO A POST COMMITMENT FOR ONE INDIVIDUAL
 .S %=2
 .W !,"Are you posting for an individual" D YN^DICN
 .I %=1 D
 ..S DIC=162.4,DIC(0)="AEQ",DIC("A")="What is the 7078 Reference Number?: " D ^DIC
 ..S FBIN7078=$P(Y,U)
 ..I FBIN7078=-1 K FBIN7078
...
START K ^TMP($J,"FBNHPC") S (FBPAYEDT,FBENDDT)=$E(FBPAYDT,1,5)_FBDAYS,Q="",$P(Q,"=",80)="=",(FBTOT,FBTOTAL,FBOUT)=0 U IO W:$E(IOST,1,2)["C-" @IOF D HED^FBNHPC1
 ...
 ..I $G(FBIN7078),(FBIFN'=FBIN7078) Q   ;IF DOING POST COMMITMENT FOR ONE INDIVIDUAL FILTER OTHERS OUT
