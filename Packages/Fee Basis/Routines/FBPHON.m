FBPHON ;AISC/CMR-LIST PAYMENTS ; 4/14/10 6:02pm
 ;;3.5;FEE BASIS;**4,69,196**;JAN 30, 1995;Build 7
...
HDR S VALMHDR(1)="VENDOR: "_$$VNAME^FBNHEXP(FBV),VALMHDR(1)=$$SETSTR^VALM1("Patient Name: "_$$NAME^FBCHREQ2(DFN),VALMHDR(1),40,40)
 I $G(FBSSNRF)="" S VALMHDR(2)="    ID: "_$$VID^FBNHEXP(FBV),VALMHDR(2)=$$SETSTR^VALM1("SSN: "_$$SSN^FBAAUTL(DFN),VALMHDR(2),49,31)
 I $G(FBSSNRF)=1 S VALMHDR(2)="    ID: "_$$VID^FBNHEXP(FBV),VALMHDR(2)=$$SETSTR^VALM1("SSN: "_$$SSNL4^FBAAUTL($$SSN^FBAAUTL(DFN)),VALMHDR(2),49,31)
