FBAAPCC ;AISC/GRR-PRINT CURRENTLY ISSUED CARDS ; 8/28/09 12:02pm
 ;;3.5;FEE BASIS;**111,196**;JAN 30, 1995;Build 7
...
Q W ! K A,J,DFN,UL,I,JJ,X,Y,FBAAOUT,FBDT,FBNM,FBSSN D CLOSE^FBAAUTL
 Q
GOT ;
 S:$G(FBSSNRF)="" FBDT=$P(Y(0),"^",2),FBNM=$P($G(^DPT(+DFN,0)),"^"),FBSSN=$$SSN^FBAAUTL(DFN)
 S:$G(FBSSNRF)=1 FBDT=$P(Y(0),"^",2),FBNM=$P($G(^DPT(+DFN,0)),"^"),FBSSN=$$SSNL4^FBAAUTL($$SSN^FBAAUTL(DFN))
