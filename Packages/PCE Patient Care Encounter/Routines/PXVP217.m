PXVP217 ;ISP/LMT - PX*1*217 KIDS Routine ;Aug 16, 2022@13:48:51
 ;;1.0;PCE PATIENT CARE ENCOUNTER;**217**;Aug 12, 1996;Build 135
 ;
 Q
 ;
...
CONDEF ; Populate the IMM DEFAULT RESPONSES (920.05) file, Contra/Refusals
 ...
 . K ^TMP("DIERR",$J)
 . D UPDATE^DIE("","PXFDA")
 . I $D(^TMP("DIERR",$J)) ZWRITE ^TMP("DIERR",$J,*) D MES("ERROR: Error filing default for Contra/Refusal #"_PXIEN_";PXV("_PXFILE_",")
 Q
 ;
BMES(STR) ;
 ; Write string
